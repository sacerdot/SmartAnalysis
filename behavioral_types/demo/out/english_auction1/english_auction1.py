...
if __name__=='__main__':
   ...
   contract_source_path = 'english_auction1.sol'
   ...
   tx_hash = Better1_contract.functions._init_(Auctioneer_address).transact()
   tx_receipt = w3.eth.waitForTransactionReceipt(tx_hash)
   tx_hash = Auctioneer_contract.functions._init_(Auctioneer_address,Better1_address).transact()
   tx_receipt = w3.eth.waitForTransactionReceipt(tx_hash)
