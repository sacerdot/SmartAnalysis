...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _is_=[0,1],
     _iA_=[0,caml_new_string("typeInference.ml"),391,9],
     _iz_=[0,0],
     _iy_=[0,caml_new_string("typeInference.ml"),249,20],
     _ix_=[0,caml_new_string("typeInference.ml"),229,1],
     ...
     _ir_=[0,caml_new_string("typeInference.ml"),122,3],
     _im_=[0,caml_new_string("typeInference.ml"),81,1],
     _il_=[0,caml_new_string("typeInference.ml"),85,9],
     _ik_=[0,caml_new_string("typeInference.ml"),72,3],
     _ii_=[0,1],
     _ih_=[0,0],
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_yf_ = caml_wrap_exception(_yf_);
              if(_yf_[1] !== Sys_error)throw _yf_;
              var _ye_=_yf_}
            var param$0=l;
            continue}
          return 0}}
       ...
       if(0 <= len)
        if((caml_ml_bytes_length(b) - len | 0) < ofs)
         ...
         {var r=caml_create_bytes(len);
          ...
          var _yd_=r,switch$0=1}
       else
        var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _yd_=invalid_arg(_n_);
    ...
    function concat(sep,l)
     {if(l)
       {var seplen=caml_ml_string_length(sep),acc=0,param=l,pos$1=0;
        for(;;)
         {if(param)
           {var _x__=param[2],_x$_=param[1];
            if(_x__)
             {var
               x=(caml_ml_string_length(_x$_) + seplen | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_q_),
               acc=acc$0,
               param=_x__;
              continue}
            var _yc_=caml_ml_string_length(_x$_) + acc | 0}
          else
           var _yc_=acc;
          var dst=caml_create_bytes(_yc_),pos=pos$1,param$0=l;
          for(;;)
           {if(param$0)
             {var _ya_=param$0[2],_yb_=param$0[1];
              if(_ya_)
               {caml_blit_string(_yb_,0,dst,pos,caml_ml_string_length(_yb_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_yb_) | 0,seplen);
                var
                 pos$0=(pos + caml_ml_string_length(_yb_) | 0) + seplen | 0,
                 pos=pos$0,
                 param$0=_ya_;
                continue}
              caml_blit_string(_yb_,0,dst,pos,caml_ml_string_length(_yb_))}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(! (l < i))
        try
         {index_rec(s,l,i,c);var _x8_=1;return _x8_}
        catch(_x9_)
         {_x9_ = caml_wrap_exception(_x9_);
          if(_x9_ === Not_found)return 0;
          throw _x9_}
    ...
    function _C_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_x7_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_x2_=height(lr);
            if(_x2_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _x3_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_x3_)}
            return invalid_arg(_u_)}
          return invalid_arg(_v_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_x4_=height(rl);
            if(_x4_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _x5_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_x5_)}
            return invalid_arg(_w_)}
          return invalid_arg(_x_)}
        var _x6_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_x6_]}
      var empty=0;
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _xZ_=param$0[1];
            if(_xZ_){var param$0=_xZ_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _xW_=param$0[4],_xX_=param$0[3],_xY_=param$0[2];
            if(_xW_){var param$0=_xW_;continue}
            return [0,_xY_,_xX_]}
          throw Not_found}}
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _xT_=param$0[4],_xU_=param$0[3],_xV_=param$0[2];
            if(_xT_){var param$0=_xT_;continue}
            return [0,[0,_xV_,_xU_]]}
          return 0}}
         ...
         {var _xS_=param[1];
          if(_xS_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_xS_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_y_)}
      function _xv_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _xP_=caml_call2(p,v,d);
            if(_xP_)
             {var _xQ_=for_all(p,l);
              if(_xQ_){var param$0=r;continue}
              var _xR_=_xQ_}
            else
             var _xR_=_xP_;
            return _xR_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _xM_=caml_call2(p,v,d);
            if(_xM_)
             var _xN_=_xM_;
            else
             {var _xO_=exists(p,l);
              if(! _xO_){var param$0=r;continue}
              var _xN_=_xO_}
            return _xN_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _xI_=merge(f,r1,r2),
             _xJ_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_xJ_,_xI_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _xK_=merge(f,r1$0,r2$0),
           _xL_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_xL_,_xK_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _xG_=concat(lf,rf);return [0,join(lt,v,d,rt),_xG_]}
          var _xH_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_xH_]}
        return _B_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _xD_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_xD_)
               {var _xE_=caml_call2(cmp,d1,d2);
                if(_xE_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_xC_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _xC_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_xA_=cons_enum(t,rest);
          return [0,[0,k,v],function(_xB_){return seq_of_enum(_xA_,_xB_)}]}
        return 0}
      function to_seq(m)
       {var _xy_=cons_enum(m,0);
        return function(_xz_){return seq_of_enum(_xy_,_xz_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _xw_=c;
          return function(_xx_){return seq_of_enum(_xw_,_xx_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function fill_buff(b)
     {var len=caml_ml_bytes_length(b[2]),_xs_=b[2],_xt_=b[1];
      if(0 <= len)
       if((caml_ml_bytes_length(_xs_) - len | 0) < 0)
        var switch$0=0;
       else
        var _xu_=caml_ml_input(_xt_,_xs_,0,len),switch$0=1;
      else
       var switch$0=0;
      if(! switch$0)var _xu_=invalid_arg(_e_);
      b[3] = _xu_;
      b[4] = 0;
      return 0}
          ...
          {case 1:
           ...
           case 2:
            var
             f=d$0[1],
             _xo_=caml_obj_tag(f),
             d$1=250 === _xo_?f[1]:246 === _xo_?force_lazy_block(f):f,
             d$0=d$1;
            continue;
           case 3:
            var _xp_=d$0[1],_xq_=_xp_[1];
            if(_xq_)
             {var _xr_=_xq_[1];
              if(_xr_){var a$0=_xr_[1];_xp_[1] = 0;return [0,a$0,d$0]}
              return 0}
            var match$0=caml_call1(_xp_[2],count);
     ...
     {for(;;)
       {var _xj_=s[2];
        if(typeof _xj_ === "number")
         ...
         switch(_xj_[0])
          {case 0:var a=_xj_[1];return [0,a];
           case 1:
           ...
           case 2:
            var
             f=_xj_[1],
             _xk_=caml_obj_tag(f),
             _xl_=250 === _xk_?f[1]:246 === _xk_?force_lazy_block(f):f;
            s[2] = _xl_;
            continue;
           case 3:
            var _xm_=_xj_[1],_xn_=_xm_[1];
            if(_xn_){var a$1=_xn_[1];return a$1}
            var x=caml_call1(_xm_[2],s[1]);
            _xm_[1] = [0,x];
            return x;
           default:
            var b=_xj_[1];
        ...
        for(;;)
         {var _xh_=data[2];
          if(typeof _xh_ !== "number")
           switch(_xh_[0])
            {case 0:
              var d=_xh_[2];data[1] = data[1] + 1 | 0;data[2] = d;return 0;
             case 3:
              var _xi_=_xh_[1];
              if(_xi_[1]){data[1] = data[1] + 1 | 0;_xi_[1] = 0;return 0}
              break;
             case 4:
              var b=_xh_[1];
              if(b[3] <= b[4])fill_buff(b);
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
        ...
        return [0,function(param){return 0},_wV_,_wU_,_wT_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _wW_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_wW_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _wX_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _wY_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _wZ_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _w0_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _w1_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _w2_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _w3_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _w4_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _w5_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _w6_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _w7_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _w8_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _w9_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _w__=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _w$_=function(param){caml_call1(de$12,0);return 0},
           _xa_=function(param){caml_call1(ed$12,0);return 0},
           _xb_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _xc_=function(param){caml_call1(de$13,0);return 0},
           _xd_=function(param){caml_call1(ed$13,0);return 0},
           _xe_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_wA_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_wB_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_wC_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_wD_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_wE_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_wF_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_wG_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_wH_,rest2$6)];
          ...
          break;
         case 8:
          var _wI_=ty1[2],_wJ_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_wK_=trans(_wI_,rest2$7);
              return [8,trans(_wJ_,ty2),_wK_];
          ...
          break;
         case 9:
          var _wL_=ty1[3],_wM_=ty1[2],_wN_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_wM_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_wN_,ty22,trans(_wL_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_wO_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_wP_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_wQ_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_wR_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_wS_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _wz_=match[2];
        if(typeof _wz_ !== "number" && 2 === _wz_[0])
         {var rest$0=_wz_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _v7_ !== "number" && 1 === _v7_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_v8_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _v9_=type_padding(pad$0,fmtty),
           _v__=_v9_[2],
           _v$_=_v9_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _wa_=type_padprec(pad$1,prec,fmtty),
           _wb_=_wa_[3],
           _wc_=_wa_[2],
           _wd_=_wa_[1];
          if(typeof _wb_ !== "number" && 2 === _wb_[0])
           {var
             fmtty_rest$3=_wb_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_wd_,_wc_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _we_=type_padprec(pad$2,prec$0,fmtty),
           _wf_=_we_[3],
           _wg_=_we_[2],
           _wh_=_we_[1];
          if(typeof _wf_ !== "number" && 3 === _wf_[0])
           {var
             fmtty_rest$4=_wf_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_wh_,_wg_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _wi_=type_padprec(pad$3,prec$1,fmtty),
           _wj_=_wi_[3],
           _wk_=_wi_[2],
           _wl_=_wi_[1];
          if(typeof _wj_ !== "number" && 4 === _wj_[0])
           {var
             fmtty_rest$5=_wj_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_wl_,_wk_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _wm_=type_padprec(pad$4,prec$2,fmtty),
           _wn_=_wm_[3],
           _wo_=_wm_[2],
           _wp_=_wm_[1];
          if(typeof _wn_ !== "number" && 5 === _wn_[0])
           {var
             fmtty_rest$6=_wn_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_wp_,_wo_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _wq_=type_padprec(pad$5,prec$3,fmtty),
           _wr_=_wq_[3],
           _ws_=_wq_[2],
           _wt_=_wq_[1];
          if(typeof _wr_ !== "number" && 6 === _wr_[0])
           {var
             fmtty_rest$7=_wr_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_wt_,_ws_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _wu_=type_padding(pad$6,fmtty),
           _wv_=_wu_[2],
           _ww_=_wu_[1];
          if(typeof _wv_ !== "number" && 7 === _wv_[0])
           {var
             fmtty_rest$8=_wv_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_ww_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _wx_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_wx_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _wy_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_wy_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_wy_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _v4_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_v4_))
             throw Type_mismatch;
            var _v5_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_v5_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _v3_=2 === padty$0?48:32,res=make(width$0,_v3_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _v1_=match$0 - 32 | 0,
           switch$0=
            59 < _v1_ >>> 0?33 < (_v1_ - 61 | 0) >>> 0?1:0:2 === _v1_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _vU_=caml_ml_bytes_length(s$0) - 1 | 0,
           _vT_=0;
          if(! (_vU_ < 0))
           {var i$0=_vT_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _vY_=match - 34 | 0;
                if(58 < _vY_ >>> 0)
                 if(93 <= _vY_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_vY_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _vZ_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _vZ_=4;break;case 1:var _vZ_=2;break}
              n[1] = n[1] + _vZ_ | 0;
              var _v0_=i$0 + 1 | 0;
              if(_vU_ !== i$0){var i$0=_v0_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _vW_=caml_ml_bytes_length(s$0) - 1 | 0,_vV_=0;
            if(! (_vW_ < 0))
             {var i=_vV_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                n[1]++;
                var _vX_=i + 1 | 0;
                if(_vW_ !== i){var i=_vX_;continue}
                break}}
            var _v2_=s}
          var str$0=caml_string_of_bytes(_v2_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_vO_=caml_ml_string_length(s) - 1 | 0,_vN_=0;
        if(! (_vO_ < 0))
         {var i$0=_vN_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _vS_=i$0 + 1 | 0;
            if(_vO_ !== i$0){var i$0=_vS_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _vQ_=caml_ml_string_length(s) - 1 | 0,
         _vP_=0;
        if(! (_vQ_ < 0))
         {var i=_vP_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _vM_=_az_;break;
        case 2:var _vM_=_aA_;break;
        case 4:var _vM_=_aC_;break;
        case 5:var _vM_=_aD_;break;
        case 6:var _vM_=_aE_;break;
        case 7:var _vM_=_aF_;break;
        case 8:var _vM_=_aG_;break;
        case 9:var _vM_=_aH_;break;
        case 10:var _vM_=_aI_;break;
        case 11:var _vM_=_aJ_;break;
        case 0:
        case 13:var _vM_=_ay_;break;
        case 3:
        case 14:var _vM_=_aB_;break;
        default:var _vM_=_aK_}
      return transform_int_alt(iconv,caml_format_int(_vM_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _vL_=_aZ_;break;
        case 2:var _vL_=_a0_;break;
        case 4:var _vL_=_a2_;break;
        case 5:var _vL_=_a3_;break;
        case 6:var _vL_=_a4_;break;
        case 7:var _vL_=_a5_;break;
        case 8:var _vL_=_a6_;break;
        case 9:var _vL_=_a7_;break;
        case 10:var _vL_=_a8_;break;
        case 11:var _vL_=_a9_;break;
        case 0:
        case 13:var _vL_=_aY_;break;
        case 3:
        case 14:var _vL_=_a1_;break;
        default:var _vL_=_a__}
      return transform_int_alt(iconv,caml_format_int(_vL_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _vK_=_ba_;break;
        case 2:var _vK_=_bb_;break;
        case 4:var _vK_=_bd_;break;
        case 5:var _vK_=_be_;break;
        case 6:var _vK_=_bf_;break;
        case 7:var _vK_=_bg_;break;
        case 8:var _vK_=_bh_;break;
        case 9:var _vK_=_bi_;break;
        case 10:var _vK_=_bj_;break;
        case 11:var _vK_=_bk_;break;
        case 0:
        case 13:var _vK_=_a$_;break;
        case 3:
        case 14:var _vK_=_bc_;break;
        default:var _vK_=_bl_}
      return transform_int_alt(iconv,caml_format_int(_vK_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _vJ_=_aM_;break;
        case 2:var _vJ_=_aN_;break;
        case 4:var _vJ_=_aP_;break;
        case 5:var _vJ_=_aQ_;break;
        case 6:var _vJ_=_aR_;break;
        case 7:var _vJ_=_aS_;break;
        case 8:var _vJ_=_aT_;break;
        case 9:var _vJ_=_aU_;break;
        case 10:var _vJ_=_aV_;break;
        case 11:var _vJ_=_aW_;break;
        case 0:
        case 13:var _vJ_=_aL_;break;
        case 3:
        case 14:var _vJ_=_aO_;break;
        default:var _vJ_=_aX_}
      return transform_int_alt(iconv,caml_int64_format(_vJ_,n))}
     ...
     {if(16 <= fconv)
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_vD_=l - 1 | 0,_vC_=0;
            if(! (_vD_ < 0))
             {var i=_vC_;
              for(;;)
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _vG_=buffer_contents(buf)}
      var str=caml_format_float(_vG_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _vH_=match - 46 | 0,
             switch$1=
              23 < _vH_ >>> 0?55 === _vH_?1:0:21 < (_vH_ - 1 | 0) >>> 0?1:0;
            if(! switch$1){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _vI_=1}
          return _vI_?str:symbol(str,_bq_)}}
      return str}
    function make_int_padding_precision(k,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _vz_=pad[2],_vA_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_vA_,_vz_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_vA_,_vz_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_vA_,_vz_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _vB_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_vB_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_vB_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_vB_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _vv_=pad$5[2],_vw_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_vw_,_vv_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_vw_,_vv_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_vw_,_vv_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _vx_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_vx_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_vx_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_vx_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _vy_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _vy_[2] === "number")
              {var fmt=_vy_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_vu_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_vu_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _vr_=[8,acc,_bx_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_vr_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_vr_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_vq_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_vq_,rest])}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bD_;
      var _vm_=other_fields(x,i + 1 | 0),_vn_=field(x,i);
      return caml_call2(sprintf(_bE_),_vn_,_vm_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _vj_=other_fields(x,2),_vk_=field(x,1);
        return caml_call2(sprintf(_bF_),_vk_,_vj_)}
      switch(match)
       {case 0:return _bG_;
        case 1:return _bH_;
        default:var _vl_=field(x,1);return caml_call1(sprintf(_bI_),_vl_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _vh_=caml_call1(hd,x),_vg_=_vh_}catch(_vi_){var _vg_=0}
            if(_vg_){var s=_vg_[1];return s}
            var param$0=tl;
            continue}
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _vc_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_vc_;continue}
           var accu=[0,_bO_],_u__=54 + max(55,l) | 0,_u9_=0;
           if(! (_u__ < 0))
            {var i=_u9_;
             for(;;)
              {var
               ...
               var
                _u$_=accu[1],
                _u5_=caml_string_get(_u$_,3) << 24,
                _u6_=caml_string_get(_u$_,2) << 16,
                _u7_=caml_string_get(_u$_,1) << 8,
                _u8_=
                 ((caml_string_get(_u$_,0) + _u7_ | 0) + _u6_ | 0)
                 +
                 _u5_
                 |
                 0,
                _va_=
                 (caml_check_bound(result[1],j)[1 + j] ^ _u8_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[1 + j] = _va_;
               var _vb_=i + 1 | 0;
               if(_u__ !== i){var i=_vb_;continue}
               break}}
           result[2] = 0;
           return result}}];
    ...
    function find$0(h,key)
     {var _u4_=indexfun(h,key),match=caml_check_bound(h[2],_u4_)[1 + _u4_];
      if(match)
    ...
    function f$0(s)
     {var accu=[0,0],_u1_=caml_ml_string_length(s) - 1 | 0,_u0_=0;
      if(! (_u1_ < 0))
       {var i=_u0_;
        for(;;)
         {var _u2_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _u2_ | 0;
          var _u3_=i + 1 | 0;
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _uU_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _uU_;
      ...
      if(! (_uW_ < 0))
       {var i=_uV_;
        for(;;)
         {var
           _uY_=(i * 2 | 0) + 3 | 0,
           _uX_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_uY_)[1 + _uY_] = _uX_;
          var _uZ_=i + 1 | 0;
          if(_uW_ !== i){var i=_uZ_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_uR_=len < new_size?1:0;
      if(_uR_)
       {var
         ...
         switch$0=
          0 <= len
           ?(_uS_.length - 1 - len | 0) < 0
             ?0
             :(a2.length - 1 - len | 0) < 0
               ?0
               :(caml_array_blit(_uS_,0,a2,0,len),1)
           :0;
    ...
    function get_method_label(table,name)
     {try
       {var _uP_=caml_call2(Meths[27],name,table[3]);return _uP_}
      catch(_uQ_)
    ...
    function new_variable(table,name)
     {try
       {var _uN_=caml_call2(Vars[27],name,table[7]);return _uN_}
      catch(_uO_)
     ...
     {var x=16;
      for(;;)
       {if(! (17 <= x))
        ...
        if(random)
         {var
           _ud_=caml_obj_tag(prng),
           _ue_=250 === _ud_?prng[1]:246 === _ud_?force_lazy_block(prng):prng;
          _ue_[2] = (_ue_[2] + 1 | 0) % 55 | 0;
          var
           _t__=_ue_[2],
           curval=caml_check_bound(_ue_[1],_t__)[1 + _t__],
           _t$_=(_ue_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_ue_[1],_t$_)[1 + _t$_]
            +
           ...
           _ua_=_ue_[2];
          caml_check_bound(_ue_[1],_ua_)[1 + _ua_] = newval30;
          var seed=newval30}
        else
         var seed=0;
         ...
         {if(param)
             ...
             {var
              ...
              if(nsize < max_array_length)
               {var
                 ...
                 _ub_=kwd_table.length - 1 < 4?1:0,
                 _uc_=_ub_ || (kwd_table[4] < 0?1:0),
                 inplace=1 - _uc_;
                kwd_table[2] = ndata;
                var _ug_=osize - 1 | 0,_uf_=0;
                if(! (_ug_ < 0))
                 {var i$0=_uf_;
                  a:
                  for(;;)
                    ...
                    for(;;)
                     {if(cell)
                       {var
                        ...
                        continue}
                      var _uk_=i$0 + 1 | 0;
                      if(_ug_ !== i$0){var i$0=_uk_;continue a}
                      break}
                    break}}
                if(inplace)
                 {var _ui_=nsize - 1 | 0,_uh_=0;
                  if(! (_ui_ < 0))
                   {var i=_uh_;
                    for(;;)
          ...
          var
           ident_or_keyword=
            function(id)
             {try
               {var _uL_=find$0(kwd_table,id);return _uL_}
              catch(_uM_)
               {_uM_ = caml_wrap_exception(_uM_);
                if(_uM_ === Not_found)return [1,id];
                throw _uM_}},
           keyword_or_error=
            function(c)
             {var s=make$0(1,c);
              try
               {var _uJ_=find$0(kwd_table,s);return _uJ_}
              catch(_uK_)
               {_uK_ = caml_wrap_exception(_uK_);
                if(_uK_ === Not_found)throw [0,Error,symbol(_bS_,s)];
                throw _uK_}},
           end_exponent_part=
            function(strm)
             {for(;;)
               {var match=peek(strm);
                if(match)
                 {var _uI_=match[1],switcher=_uI_ - 48 | 0;
                  if(! (9 < switcher >>> 0)){junk(strm);store(_uI_);continue}}
                return [0,[3,caml_float_of_string(get_string(0))]]}},
           exponent_part=
            function(strm)
             {var match=peek(strm);
              if(match)
               {var _uH_=match[1],switch$0=43 === _uH_?0:45 === _uH_?0:1;
                if(! switch$0)
                 {junk(strm);store(_uH_);return end_exponent_part(strm)}}
             ...
             {for(;;)
               {var match=peek(s);
                if(match)
                 {var _uE_=match[1];
                  if(58 <= _uE_)
                   {var switch$0=69 === _uE_?0:101 === _uE_?0:1;
                   ...
                   {if(46 === _uE_)
                     {junk(s);
                      ...
                      for(;;)
                       {var match$0=peek(s);
                        if(match$0)
                         {var _uF_=match$0[1],_uG_=_uF_ - 69 | 0;
                          if(32 < _uG_ >>> 0)
                           {var switcher=_uG_ + 21 | 0;
                            if(! (9 < switcher >>> 0)){junk(s);store(_uF_);continue}}
                          else
                           {var switcher$0=_uG_ - 1 | 0;
                            if(30 < switcher$0 >>> 0)
                             {junk(s);store(69);return exponent_part(s)}}}
                        return [0,[3,caml_float_of_string(get_string(0))]]}}
                    if(48 <= _uE_){junk(s);store(_uE_);continue}}}
                ...
                if(match)
                 {var _uC_=match[1];
                  if(94 <= _uC_)
                   var
                    _uD_=_uC_ - 95 | 0,
                    switch$0=30 < _uD_ >>> 0?32 <= _uD_?1:0:29 === _uD_?0:1;
                  else
                   if(65 <= _uC_)
                    var switch$0=92 === _uC_?0:1;
                   else
                    if(33 <= _uC_)
                     switch(_uC_ - 33 | 0)
                      {case 0:
                     ...
                     var switch$0=1;
                  if(! switch$0){junk(strm);store(_uC_);continue}}
                return [0,ident_or_keyword(get_string(0))]}},
           neg_number=
            function(s)
             {var match=peek(s);
              if(match)
               {var _uB_=match[1],switcher=_uB_ - 48 | 0;
                if(! (9 < switcher >>> 0))
                 {junk(s);
                  reset_buffer(0);
                  store(45);
                ...
                if(match)
                 {var _uz_=match[1];
                  if(91 <= _uz_)
                   var
                    _uA_=_uz_ - 95 | 0,
                    switch$0=27 < _uA_ >>> 0?97 <= _uA_?0:1:1 === _uA_?1:0;
                  else
                   var
                    switch$0=
                     48 <= _uz_?6 < (_uz_ - 58 | 0) >>> 0?0:1:39 === _uz_?0:1;
                  if(! switch$0){junk(strm);store(_uz_);continue}}
                return [0,ident_or_keyword(get_string(0))]}},
           next_token$0=
             ...
             {for(;;)
               {var match=peek(strm);
                if(match)
                 {var _up_=match[1];
                  if(124 <= _up_)
                   var switch$0=127 <= _up_?192 <= _up_?1:0:125 === _up_?0:2;
                  else
                   {var _uq_=_up_ - 65 | 0;
                    if(57 < _uq_ >>> 0)
                     if(58 <= _uq_)
                        ...
                        {case 34:
                          ...
                          for(;;)
                           {var match$1=peek(strm);
                            if(match$1)
                             {var _us_=match$1[1];
                              if(34 === _us_){junk(strm);return [0,[4,get_string(0)]]}
                              if(92 === _us_)
                               {junk(strm);
                                try
                                 {var c$0=escape(strm)}
                                 ...
                                 {_uy_ = caml_wrap_exception(_uy_);
                                  if(_uy_ === Failure$0)throw [0,Error,_bV_];
                                  throw _uy_;
                                  var _uv_=_uy_}
                                store(c$0);
                                continue}
                          ...
                          try
                           {var match$2=peek(strm);
                            ...
                            if(92 === _ut_)
                             {junk(strm);
                              try
                               {var _uu_=escape(strm)}
                              catch(_ux_)
                               {_ux_ = caml_wrap_exception(_ux_);
                                if(_ux_ === Failure$0)throw [0,Error,_bW_];
                                throw _ux_}
                              var c=_uu_}
                            else
                             {junk(strm);var c=_ut_}}
                          catch(_uw_)
                           {_uw_ = caml_wrap_exception(_uw_);
                            if(_uw_ === Failure$0)throw [0,Error,_bT_];
                            throw _uw_}
                         ...
                         case 56:
                         case 57:
                          junk(strm);reset_buffer(0);store(_up_);return number(strm);
                         case 33:
                         case 35:
                         case 36:
                         case 37:
                      ...
                      if(5 < _ur_ >>> 0)
                       ...
                       switch(_ur_)
                        {case 4:var switch$0=1;break;
                         ...
                         default:var switch$0=0}}}
                  switch(switch$0)
                   {case 0:junk(strm);return [0,keyword_or_error(_up_)];
                    case 1:
                     junk(strm);reset_buffer(0);store(_up_);return ident(strm);
                    default:
                     junk(strm);reset_buffer(0);store(_up_);return ident2(strm)}}
                return 0}},
           maybe_comment=
            function(counter,strm)
             {var match=peek(strm);
                ...
                if(58 <= _um_)
                 ...
                 if(48 <= _um_)
                  {junk(strm);
                   var match$0=peek(strm);
                   if(match$0)
                    {var _un_=match$0[1],switcher$0=_un_ - 48 | 0;
                     if(! (9 < switcher$0 >>> 0))
                      {junk(strm);
                       var match$1=peek(strm);
                       if(match$1)
                        {var _uo_=match$1[1],switcher$1=_uo_ - 48 | 0;
                         if(! (9 < switcher$1 >>> 0))
                          {junk(strm);
                           var
                            n=
                     ...
                     default:
                      ...
                      for(;;)
                       {var match$1=peek(strm);
                        if(match$1)
                         {var _ul_=match$1[1];
                          if(41 === _ul_){junk(strm);return 0}
                          if(42 === _ul_){junk(strm);continue}
                          junk(strm);
                          continue b}
                        throw Failure$0}}
                  junk(strm);
    ...
    function pp_expr(param)
     {switch(param[0])
       {case 0:var v=param[1];return pp_var(v);
        ...
        case 2:
         var e2=param[2],e1=param[1],_t7_=symbol(_b$_,pp_expr(e2));
         return parens(symbol(pp_expr(e1),_t7_));
        case 3:
         var e2$0=param[2],e1$0=param[1],_t8_=symbol(_ca_,pp_expr(e2$0));
         return parens(symbol(pp_expr(e1$0),_t8_));
        case 4:
        ...
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _t9_=symbol(_cc_,caml_new_string("" + e2$2));
         return parens(symbol(pp_expr(e1$2),_t9_));
    ...
    function pp_acall(param)
     {var el=param[2],f=param[1];
      ...
      var _t6_=symbol(_cg_,symbol(concat(_cf_,map(pp_expr,el)),_ce_));
      return symbol(pp_func(f),_t6_)}
    function pp_pred(param)
     {var e2=param[3],o=param[2],e1=param[1],_t3_=symbol(_ch_,pp_expr(e2));
      switch(o)
       {case 0:var _t4_=_b4_;break;
        case 1:var _t4_=_b5_;break;
        case 2:var _t4_=_b6_;break;
        case 3:var _t4_=_b7_;break;
        default:var _t4_=_b8_}
      var _t5_=symbol(_ci_,symbol(_t4_,_t3_));
      return symbol(pp_expr(e1),_t5_)}
    function pp_eqn(param)
     {var
       ...
       _tY_=
        symbol(_cp_,symbol(_co_,symbol(concat(_cn_,map(pp_acall,cl)),_tX_))),
       _tZ_=pp_expr(e),
       _t0_=
        to_nat
         ?function(x){return symbol(_cq_,parens(x))}
         :function(x){return x},
       _t1_=symbol(_cr_,symbol(_t0_(_tZ_),_tY_)),
       vl=call[2],
       f=call[1];
      if(0 === vl)
       var _t2_=pp_func(f);
       ...
       var
        _tW_=symbol(_b3_,symbol(concat(_b2_,map(pp_var,vl)),_b1_)),
        _t2_=symbol(pp_func(f),_tW_);
      return symbol(_cs_,symbol(_t2_,_t1_))}
       ...
       {case 0:var n=param[1];return caml_new_string("" + n);
        ...
        case 2:
         var
          e2=param[2],
          e1=param[1],
          _tS_=symbol(_cv_,symbol(pp_expr$0(e2),_cu_));
         return symbol(_cw_,symbol(pp_expr$0(e1),_tS_));
        case 3:
         var
          e2$0=param[2],
          e1$0=param[1],
          _tT_=symbol(_cy_,symbol(pp_expr$0(e2$0),_cx_));
         return symbol(_cz_,symbol(pp_expr$0(e1$0),_tT_));
        case 4:
         var
          e2$1=param[2],
          e1$1=param[1],
          _tU_=symbol(_cB_,symbol(pp_expr$0(e2$1),_cA_));
         return symbol(_cC_,symbol(pp_expr$0(e1$1),_tU_));
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _tV_=symbol(_cE_,symbol(pp_expr$0(e2$2),_cD_));
         return symbol(_cF_,symbol(pp_expr$0(e1$2),_tV_));
       ...
       {case 0:var b=param[1];return string_of_bool(b);
        case 1:
         var
          e2=param[2],
          e1=param[1],
          _tN_=symbol(_cI_,symbol(pp_expr$0(e2),_cH_));
         return symbol(_cJ_,symbol(pp_expr$0(e1),_tN_));
        case 2:
         var
          e2$0=param[2],
          e1$0=param[1],
          _tO_=symbol(_cL_,symbol(pp_expr$0(e2$0),_cK_));
         return symbol(_cM_,symbol(pp_expr$0(e1$0),_tO_));
        case 3:
         var
          e2$1=param[2],
          e1$1=param[1],
          _tP_=symbol(_cO_,symbol(pp_expr$0(e2$1),_cN_));
         return symbol(_cP_,symbol(pp_expr$0(e1$1),_tP_));
        case 4:
         var
          e2$2=param[2],
          e1$2=param[1],
          _tQ_=symbol(_cR_,symbol(pp_pred$0(e2$2),_cQ_));
         return symbol(_cS_,symbol(pp_pred$0(e1$2),_tQ_));
        case 5:
         var
          e2$3=param[2],
          e1$3=param[1],
          _tR_=symbol(_cU_,symbol(pp_pred$0(e2$3),_cT_));
         return symbol(_cV_,symbol(pp_pred$0(e1$3),_tR_));
        default:var p=param[1];return symbol(_cW_,pp_pred$0(p))}}
    function mk_indent(n){return make$0(3 * n | 0,32)}
    function pp_stm(indent,s)
     {switch(s[0])
       {case 0:var l=s[1],_tH_=concat(_cX_,map(pp_expr$0,l));break;
        case 1:
         var
          l$0=s[2],
          f=s[1],
        ...
        default:
         var _tI_=s[1];
         if(! _tI_)throw [0,Assert_failure,_c7_];
         var
          tl=_tI_[2],
          match=_tI_[1],
          s$0=match[2],
             ...
             map
              (function(param)
                {var
                  s=param[2],
                  p=param[1],
                  _tL_=symbol(_c1_,pp_stm(indent + 2 | 0,s)),
                  _tM_=symbol(_c2_,symbol(pp_pred$0(p),_tL_));
                 return symbol(_c3_,symbol(mk_indent(indent),_tM_))},
               tl)),
          _tK_=symbol(_c5_,symbol(pp_stm(indent + 2 | 0,s$0),_tJ_)),
          _tH_=symbol(_c6_,symbol(pp_pred$0(p),_tK_))}
      return symbol(mk_indent(indent),_tH_)}
    function pp_function(param)
     {var
       stm=param[3],
       params=param[2],
       f=param[1],
       _tG_=symbol(_c8_,pp_stm(1,stm));
      return symbol(f,symbol(_c__,symbol(concat(_c9_,params),_tG_)))}
    ...
    function compute_expr(param)
     {switch(param[0])
       {case 0:var n=param[1];return [1,n];
        ...
        case 2:
         var e2=param[2],e1=param[1],_tB_=compute_expr(e2);
         return [2,compute_expr(e1),_tB_];
        case 3:
         var e2$0=param[2],e1$0=param[1],_tC_=compute_expr(e2$0);
         return [3,compute_expr(e1$0),_tC_];
        case 4:
         var _tD_=param[1];
         if(0 === _tD_[0])
          {var e2$1=param[2],n$0=_tD_[1];return [4,n$0,compute_expr(e2$1)]}
         throw NotLinear;
        case 5:
         var _tE_=param[2],_tF_=param[1];
         if(0 === _tE_[0]){var n$1=_tE_[1];return [5,compute_expr(_tF_),n$1]}
         throw NotLinear;
    ...
    function atomic_neg(param)
     {var e2=param[3],p=param[2],e1=param[1];
      switch(p)
       {case 0:var _tA_=_db_;break;
        case 1:var _tA_=_dc_;break;
        case 2:var _tA_=_dd_;break;
        case 3:var _tA_=_de_;break;
        default:var _tA_=_df_}
      return map(function(op){return [0,e1,op,e2]},_tA_)}
    ...
    function expr_list_map(o,tl,match)
     {if(tl)
       {var
         ...
         tl$0=tl[2],
         t=tl[1],
         _tz_=expr_list_map(o,tl$0,el);
        return [0,caml_call3(caml_get_public_method(o,102,160),o,t,e),_tz_]}
      return 0}
    ...
    function pp_tag_list(param)
     {if(param)
       {var tl=param[2],x=param[1],_ty_=pp_tag_list(tl);
        return [0,pp_tag(x),_ty_]}
      return 0}
    function pp_decl(param)
     {var s=param[2],t=param[1],_tx_=symbol(_dt_,s);
      return symbol(pp_tag(t),_tx_)}
    function pp_var_list(param)
     {if(param)
       {var tl=param[2],v=param[1],_tw_=pp_var_list(tl);
        return [0,pp_decl(v),_tw_]}
      return 0}
        ...
        {case 0:var v=param[1];return v[2];
         ...
         case 2:
          var
           e2=param[2],
           e1=param[1],
           _tn_=symbol(_dB_,symbol(pp_expr$1(tag,e2),_dA_));
          return symbol(_dC_,symbol(pp_expr$1(tag,e1),_tn_));
         case 3:
          var
           e2$0=param[2],
           e1$0=param[1],
           _to_=symbol(_dE_,symbol(pp_expr$1(tag,e2$0),_dD_));
          return symbol(_dF_,symbol(pp_expr$1(tag,e1$0),_to_));
         case 4:
          var
           e=param[2],
           c=param[1],
           _tp_=symbol(_dH_,symbol(pp_expr$1(tag,e),_dG_));
          return symbol(_dI_,symbol(pp_expr$1(tag,c),_tp_));
         case 5:
          var
           e$0=param[2],
           c$0=param[1],
           _tq_=symbol(_dK_,symbol(pp_expr$1(tag,e$0),_dJ_));
          return symbol(_dL_,symbol(pp_expr$1(tag,c$0),_tq_));
         case 6:var e$1=param[1];return symbol(_dM_,pp_expr$1(tag,e$1));
         case 7:
          var
           e2$1=param[2],
           e1$1=param[1],
           _tr_=symbol(_dO_,symbol(pp_expr$1(1,e2$1),_dN_));
          return symbol(_dP_,symbol(pp_expr$1(1,e1$1),_tr_));
         case 8:
          var
           e2$2=param[2],
           e1$2=param[1],
           _ts_=symbol(_dR_,symbol(pp_expr$1(1,e2$2),_dQ_));
          return symbol(_dS_,symbol(pp_expr$1(1,e1$2),_ts_));
         case 9:
          var
           e2$3=param[3],
           e1$3=param[2],
           tag$0=param[1],
           _tt_=symbol(_dU_,symbol(pp_expr$1(tag$0,e2$3),_dT_));
          return symbol(_dV_,symbol(pp_expr$1(tag$0,e1$3),_tt_));
         case 10:
          var
           g2=param[2],
           g1=param[1],
           _tu_=symbol(_dX_,symbol(pp_expr$1(tag,g2),_dW_));
          return symbol(_dY_,symbol(pp_expr$1(tag,g1),_tu_));
         case 11:
          var
           g2$0=param[2],
           g1$0=param[1],
           _tv_=symbol(_d0_,symbol(pp_expr$1(tag,g2$0),_dZ_));
          return symbol(_d1_,symbol(pp_expr$1(tag,g1$0),_tv_));
    ...
    function pp_expr_list(tg,match)
     {if(tg)
       {var
         ...
         tagl=tg[2],
         tag=tg[1],
         _tm_=pp_expr_list(tagl,tl);
        return [0,pp_expr$1(tag,v),_tm_]}
      return 0}
    function pp_meth(opt,param)
     {var id=param[3],tags=param[2],rtag=param[1];
      if(opt)var sth=opt[1],verbose=sth;else var verbose=0;
      if(verbose)
       {var _tl_=symbol(_d5_,symbol(pp_tag(rtag),_d4_));
        return symbol
                (id,symbol(_d7_,symbol(concat(_d6_,pp_tag_list(tags)),_tl_)))}
      return id}
    function pp_rhs(tag,param)
     {if(0 === param[0]){var e=param[1];return pp_expr$1(tag,e)}
      var
       ...
       meth=param[2],
       addr=param[1],
       _th_=symbol(_eb_,symbol(concat(_ea_,pp_expr_list(meth[2],exprl)),_d$_));
      if(value)
       var v=value[1],_ti_=symbol(_ed_,symbol(pp_expr$1(1,v),_ec_));
      else
       var _ti_=_ef_;
      var
       _tj_=symbol(_ti_,_th_),
       _tk_=symbol(_ee_,symbol(pp_meth(0,meth),_tj_));
      return symbol(pp_expr$1(3,addr),_tk_)}
    function pp_stm$0(indent,opt,tag,stm)
     {if(opt)var sth=opt[1],breakline=sth;else var breakline=1;
      if(typeof stm === "number")
       if(0 === stm)var _s5_=_eg_,switch$0=1;else var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _s5_=breakline?_ew_:_ex_;
      if(typeof stm === "number")
       switch(stm)
        {case 0:var _s6_=_eh_;break;
         case 1:var _s6_=_ej_;break;
         default:var _s6_=_ek_}
      else
       switch(stm[0])
        {case 0:
          var e=stm[1],_s6_=symbol(_em_,symbol(pp_rhs(tag,e),_el_));break;
         case 1:
          var
           stm$0=stm[3],
           rhs=stm[2],
           lhs=stm[1],
           _s9_=pp_stm$0(indent,_en_,tag,stm$0);
          if(typeof stm$0 === "number")
           if(0 === stm$0)var _s__=_eo_,switch$1=1;else var switch$1=0;
          else
           var switch$1=0;
          if(! switch$1)var _s__=_eq_;
          var
           _s$_=symbol(_ep_,symbol(_s__,_s9_)),
           _ta_=symbol(pp_rhs(tag_of_lhs(lhs),rhs),_s$_);
          if(typeof lhs === "number")
           var _tb_=_d8_;
          else
           if(0 === lhs[0])
            var f=lhs[1],_tb_=symbol(f[2],_d9_);
           else
            var v=lhs[1],_tb_=symbol(v[2],_d__);
          var _s6_=symbol(_tb_,_ta_);
          break;
         default:
          var
           stm3=stm[4],
           ...
           stm1=stm[2],
           c=stm[1],
           _tc_=symbol(_es_,pp_stm$0(indent,_er_,tag,stm3)),
           _td_=symbol(mk_indent$0(indent),_tc_),
           _te_=symbol(_et_,symbol(pp_stm$0(indent + 1 | 0,0,tag,stm2),_td_)),
           _tf_=symbol(mk_indent$0(indent),_te_),
           _tg_=symbol(_eu_,symbol(pp_stm$0(indent + 1 | 0,0,tag,stm1),_tf_)),
           _s6_=symbol(_ev_,symbol(pp_expr$1(2,c),_tg_))}
      var _s7_=symbol(_s6_,_s5_);
      if(typeof stm === "number")
       if(0 === stm)var _s8_=_ei_,switch$2=1;else var switch$2=0;
      else
       var switch$2=0;
      if(! switch$2)var _s8_=mk_indent$0(indent);
      return symbol(_s8_,_s7_)}
    function pp_block(indent,payable,tag,param)
     {var
       stm=param[3],
       lvl=param[2],
       vl=param[1],
       _sW_=symbol(mk_indent$0(indent),_ey_),
       _sX_=symbol(pp_stm$0(indent + 1 | 0,0,tag,stm),_sW_),
          ...
          symbol
           (concat
             (_eA_,
              map
               (function(s)
                 {var _s4_=symbol(s,_ez_);
                  return symbol(mk_indent$0(indent + 1 | 0),_s4_)},
                _sY_)),
            _sX_)),
       _s0_=payable?_eC_:_eJ_,
       _s1_=symbol(_s0_,_sZ_),
       _s2_=0 === tag?_eD_:symbol(_eI_,symbol(pp_tag(tag),_eH_)),
       _s3_=symbol(_eE_,symbol(_s2_,_s1_));
      return symbol(_eG_,symbol(concat(_eF_,pp_var_list(vl)),_s3_))}
    function pp_a_contract(param)
     {var
      ...
      if(fallback)
       var
        b=fallback[1],
        _sP_=symbol(_eN_,pp_block(indent,1,0,b)),
        _sQ_=symbol(mk_indent$0(indent),_sP_);
      else
       var _sQ_=_eO_;
      var
       _sR_=symbol(_sQ_,_eP_),
       indent$0=1,
       _sS_=
        symbol
         (_eQ_,
              ...
              map
               (function(param)
                 {var
                   ...
                   b=param[2],
                   m=param[1],
                   _sU_=symbol(_eK_,pp_block(indent$0,payable,m[1],b)),
                   _sV_=symbol(_eL_,symbol(pp_meth(0,m),_sU_));
                  return symbol(mk_indent$0(indent$0),_sV_)},
                methods)),
            _sR_)),
       indent$1=1;
      return symbol
                   ...
                   symbol
                    (concat
                      (_dw_,
                       map
                        (function(f$0)
                          {var f=f$0[1],_sT_=symbol(pp_decl(f),_dv_);
                           return symbol(mk_indent$0(indent$1),_sT_)},
                         fields)),
                     _sS_))))}
    ...
    function best(err1,err2)
     {if(caml_string_equal(err1[1],_eX_))return err2;
      ...
      if(length(err1[2]) === _sM_)
       {var _sN_=err1[2],_sO_=symbol(_eZ_,err2[1]);
    ...
    function remove_minspace(param)
     {if(param)
       {var _sK_=param[1];
        ...
        var tl=param[2];
        return op([0,_sK_,0],remove_minspace(tl))}
      return 0}
     ...
     {try
       ...
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         {var error1=exn[2];
          try
           {var _sz_=caml_call2(p2,s,tbl);return _sz_}
          catch(exn)
           {exn = caml_wrap_exception(exn);
            if(exn[1] === Fail)
    ...
    function choice_list(param)
     {if(param)
       {var _su_=param[2],_sv_=param[1];
        if(_su_)
         {var _sw_=choice_list(_su_);
          return function(_sx_,_sy_){return choice(_sv_,_sw_,_sx_,_sy_)}}
        return _sv_}
       ...
       {var
        ...
        try
         ...
         {exn = caml_wrap_exception(exn);
          ...
          throw exn}
        var _st_=[0,rest2,x,best(error1,error2$0),tbl2];
        return _st_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         ...
         {var
          ...
          try
           ...
           {exn = caml_wrap_exception(exn);
            ...
            throw exn}
          var _ss_=aux(rest1,x,best(error1$0,error),ntbl);
          return _ss_}
        catch(exn)
         {exn = caml_wrap_exception(exn);
          if(exn[1] === Fail)
    ...
    function x_cont(x_expr,x_binop,s)
     {function _sg_(f1,f2,x){return caml_call1(f2,caml_call1(f1,x))}
      function _sh_(_sr_){return x_cont(x_expr,x_binop,_sr_)}
      function _si_(f,x,y){return caml_call2(f,y,x)}
      function _sj_(_sp_,_sq_){return concat$0(x_binop,x_expr,_si_,_sp_,_sq_)}
      function _sk_(_sn_,_so_){return concat$0(_sj_,_sh_,_sg_,_sn_,_so_)}
      function _sl_(x){return x}
      return function(_sm_){return option2(_sl_,_sk_,s,_sm_)}}
    function nelist(x_expr,x_binop)
     {function _sb_(x,f){return caml_call1(f,x)}
      function _sc_(_sf_){return x_cont(x_expr,x_binop,_sf_)}
      return function(_sd_,_se_){return concat$0(x_expr,_sc_,_sb_,_sd_,_se_)}}
    ...
    function check_type(tag,param)
     {var e=param[2],t=param[1],match=eq_tag(tag,t);
      if(match)return e;
      var _sa_=symbol(_fe_,pp_tag(tag));
      throw [0,Reject,symbol(pp_expr$1(t,e),_sa_)]}
     ...
     {var tbl$0=tbl;
      for(;;)
       {if(tbl$0)
         {var _r$_=tbl$0[1];
          if(1 === _r$_[0])
           {var islocal=_r$_[2],match=_r$_[1],name=match[2],tag=match[1];
     ...
     {var match$0=param[1],funname=match$0[3],l=match$0[2],t=match$0[1];
      ...
      for(;;)
       {if(tbl)
         {var _r__=tbl[1];
          if(2 === _r__[0])
           {var match=_r__[1],name=match[3],tagl=match[2],rettag=match[1];
    ...
    function plus(e1,e2)
     {if(1 === e1[1])
      ...
      var _r8_=symbol(_fm_,pp_any_expr(e2));
    ...
    function eq(e1,e2)
     {var v2=e2[2],t2=e2[1],v1=e1[2],t1=e1[1],match=eq_tag(t1,t2);
      ...
      var _r2_=symbol(_ft_,pp_any_expr(e2));
    ...
    function andb(e1,e2)
     {if(2 === e1[1])
      ...
      var _r1_=symbol(_fu_,pp_any_expr(e2));
      throw [0,Reject,symbol(pp_any_expr(e1),_r1_)]}
    function orb(e1,e2)
     {if(2 === e1[1])
       if(2 === e2[1]){var v2=e2[2],v1=e1[2];return [0,2,[11,v1,v2]]}
      var _r0_=symbol(_fv_,pp_any_expr(e2));
      throw [0,Reject,symbol(pp_any_expr(e1),_r0_)]}
    function notb(e)
    ...
    function varname(s,t)
     {if(s)
       {var _rZ_=s[1];
        if(1 === _rZ_[0]){var tl=s[2],x=_rZ_[1];return [0,tl,x,[0,_fy_,tl],t]}}
    ...
    function var_pars(tag,s,tbl)
     {try
       ...
       {_rY_ = caml_wrap_exception(_rY_);
        if(_rY_[1] === Failure)throw [0,Fail,[0,_fz_,s]];
        throw _rY_}
      return const$0
              (x,
               function(param)
                      ...
                      {var
                       ...
                       if(eq_tag(tagfield,tag))
                        {var
                         ...
                         return _rW_}
                       var _rX_=symbol(_fB_,pp_tag(tag));
    ...
    function value_pars(tag,s,tbl)
     {try
       ...
       {_rT_ = caml_wrap_exception(_rT_);
        if(_rT_[1] === Failure)throw [0,Fail,[0,_fL_,s]];
        throw _rT_}
      return const$0
              (t,
               function(match$0)
                {switch(tag)
                  {case 1:
                   ...
                   case 2:
                    if(0 === match$0[0])
                     {var _rS_=match$0[1];
                      if(! caml_string_notequal(_rS_,_fF_))return _fI_;
                      if(! caml_string_notequal(_rS_,_fG_))return _fH_}
                    break;
                   case 3:
                    if(1 === match$0[0])
    ...
    function this_pars(_rQ_,_rR_){return const$0(_fN_,_fM_,_rQ_,_rR_)}
    function brackets_pars(pars)
     {var _rJ_=kwd(_fO_),_rK_=kwd(_fP_);
    ...
    function _fX_(_rH_,_rI_){return concat$0(_fW_,_fU_,csnd,_rH_,_rI_)}
    function _fY_(_rF_,_rG_){return concat$0(_fX_,_fS_,csnd,_rF_,_rG_)}
    function msg_sender_pars(_rD_,_rE_)
     {return comb_parser(_fY_,_fQ_,_rD_,_rE_)}
    function _fZ_(param){return _f0_}
    var _f2_=kwd(_f1_),_f4_=kwd(_f3_),_f6_=kwd(_f5_);
    function _f7_(_rB_,_rC_){return concat$0(_f6_,_f4_,csnd,_rB_,_rC_)}
    function _f8_(_rz_,_rA_){return concat$0(_f7_,_f2_,csnd,_rz_,_rA_)}
    function msg_value_pars(_rx_,_ry_)
     {return comb_parser(_f8_,_fZ_,_rx_,_ry_)}
    function base(tag,s,tbl)
     {var
       _rr_=0,
       _rs_=[0,function(_rv_,_rw_){return value_pars(tag,_rv_,_rw_)},_rr_];
      return caml_call2
              (choice_list
                ([0,function(_rt_,_ru_){return var_pars(tag,_rt_,_ru_)},_rs_]),
               s,
               tbl)}
    function atomic_int_expr(s)
     {var _re_=[0,brackets_pars(int_expr),0];
      function _rf_(param){return uminus}
      var
       _rg_=kwd(_f9_),
       _rh_=
        [0,
         function(_rp_,_rq_)
          {return concat$0(_rg_,atomic_int_expr,_rf_,_rp_,_rq_)},
         _re_];
      function _ri_(expr){return [0,1,expr]}
      var _rj_=1;
    ...
    function add_binop(s)
     {var _q8_=0;
      function _q9_(param){return minus}
      var
       _q__=
        [0,function(_rc_,_rd_){return const$0(_f__,_q9_,_rc_,_rd_)},_q8_];
      function _q$_(param){return plus}
      return caml_call1
              (choice_list
                ([0,
                  function(_ra_,_rb_){return const$0(_f$_,_q$_,_ra_,_rb_)},
                  _q__]),
               s)}
    function mul_binop(s)
     {var _q0_=0;
      function _q1_(param){return div}
      var
       _q2_=
        [0,function(_q6_,_q7_){return const$0(_ga_,_q1_,_q6_,_q7_)},_q0_];
      function _q3_(param){return mult}
      return caml_call1
              (choice_list
                ([0,
                  function(_q4_,_q5_){return const$0(_gb_,_q3_,_q4_,_q5_)},
                  _q2_]),
               s)}
    function atomic_bool_expr(s)
     {var _qx_=0;
      function _qy_(x,f){return caml_call1(f,x)}
      function _qz_(f,y,x){return caml_call2(f,x,y)}
      function _qA_(_qY_,_qZ_){return concat$0(cmpop,int_expr,_qz_,_qY_,_qZ_)}
      var
       _qB_=
        [0,
         function(_qW_,_qX_){return concat$0(int_expr,_qA_,_qy_,_qW_,_qX_)},
         _qx_];
    ...
    function cmpop(s)
     {var _qh_=0;
      function _qi_(param){return le}
      var
       _qj_=
        [0,function(_qv_,_qw_){return const$0(_gf_,_qi_,_qv_,_qw_)},_qh_];
      function _qk_(param){return lt}
      var
       _ql_=
        [0,function(_qt_,_qu_){return const$0(_gg_,_qk_,_qt_,_qu_)},_qj_];
      function _qm_(param){return ge}
      var
       _qn_=
        [0,function(_qr_,_qs_){return const$0(_gh_,_qm_,_qr_,_qs_)},_ql_];
      function _qo_(param){return gt}
      return caml_call1
              (choice_list
                ([0,
                  function(_qp_,_qq_){return const$0(_gi_,_qo_,_qp_,_qq_)},
                  _qn_]),
               s)}
    function eqop(s)
     {var _p$_=0;
      function _qa_(param){return neq}
      var
       _qb_=
        [0,function(_qf_,_qg_){return const$0(_gj_,_qa_,_qf_,_qg_)},_p$_];
      function _qc_(param){return eq}
      return caml_call1
              (choice_list
                ([0,
                  function(_qd_,_qe_){return const$0(_gk_,_qc_,_qd_,_qe_)},
                  _qb_]),
               s)}
    ...
    function and_binop(s)
     {var _p7_=0;
      function _p8_(param){return andb}
      return caml_call1
              (choice_list
                ([0,
                  function(_p9_,_p__){return const$0(_gl_,_p8_,_p9_,_p__)},
                  _p7_]),
               s)}
    function or_binop(s)
     {var _p3_=0;
      function _p4_(param){return orb}
      return caml_call1
              (choice_list
                ([0,
                  function(_p5_,_p6_){return const$0(_gm_,_p4_,_p5_,_p6_)},
                  _p3_]),
               s)}
    function balance_pars(s)
     {function _pW_(a$0,param)
      ...
      var _pX_=kwd(_gn_),_pY_=kwd(_go_);
      function _pZ_(_p1_,_p2_)
       {return concat$0(contract_expr,_pY_,cfst,_p1_,_p2_)}
      return function(_p0_){return concat$0(_pZ_,_pX_,_pW_,s,_p0_)}}
    ...
    function _gy_(_pz_){return map(_gx_,_pz_)}
    var _gz_=0,_gA_=0;
    function _gB_(_px_,_py_){return field_pars(_gA_,_px_,_py_)}
    function _gC_(_pv_,_pw_){return kleenestar(_gB_,_gz_,addel,_pv_,_pw_)}
    function fields_pars(_pt_,_pu_){return comb_parser(_gC_,_gy_,_pt_,_pu_)}
    ...
    function _gH_(_pr_,_ps_){return concat$0(_gG_,expr_pars,csnd,_pr_,_ps_)}
    function _gI_(_pp_,_pq_){return kleenestar(_gH_,_gE_,addel,_pp_,_pq_)}
    function _gJ_(_pn_,_po_){return concat$0(expr_pars,_gI_,cons,_pn_,_po_)}
    var
     _gK_=0,
     _gL_=
      brackets_pars(function(_pl_,_pm_){return option2(_gK_,_gJ_,_pl_,_pm_)});
    function parse_any_expr_list(_pj_,_pk_)
     {return comb_parser(_gL_,expr_list_of_any_expr_list,_pj_,_pk_)}
    function ident_pars(s,t)
     {if(s)
       {var _pi_=s[1];
        if(1 === _pi_[0]){var tl=s[2],i=_pi_[1];return [0,tl,i,[0,_gN_,tl],t]}}
       ...
       {var t=1;
        if(x)
         {var v=x[1],e=v[2],texp=v[1],match=eq_tag(texp,t);
          return match?[0,e]:0}
        return 0}
      var _o9_=brackets_pars(int_expr),_o__=kwd(_gO_),_o$_=kwd(_gP_);
      function _pa_(_pg_,_ph_){return concat$0(_o$_,_o__,csnd,_pg_,_ph_)}
      function _pb_(_pe_,_pf_){return concat$0(_pa_,_o9_,csnd,_pe_,_pf_)}
      return comb_parser
              (function(_pc_,_pd_){return option(_pb_,_pc_,_pd_)},_o8_,s,t)}
    function rhs_pars(tag)
     {var _oQ_=0;
      ...
      var _oK_=kwd(_gQ_);
      function _oL_(_o5_,_o6_)
       {return concat$0(contract_expr,_oK_,cfst,_o5_,_o6_)}
      function _oM_(_o3_,_o4_){return option2(_gR_,_oL_,_o3_,_o4_)}
      function _oN_(_o1_,_o2_)
       {return concat$0(_oM_,ident_pars,couple,_o1_,_o2_)}
      function _oO_(_oZ_,_o0_)
       {return concat$0(_oN_,dot_value_pars,couple,_oZ_,_o0_)}
     ...
     {var
       ...
       _nq_=
        [0,
         ...
         _np_],
       _nr_=kwd(_g2_);
      function _ns_(_oH_,_oI_){return stm_pars(tag,rettag,_oH_,_oI_)}
      function _nt_(_oF_,_oG_){return concat$0(_ns_,_nr_,cfst,_oF_,_oG_)}
      var
       _nu_=kwd(_g3_),
       _nv_=
        [0,
         function(_oD_,_oE_){return concat$0(_nu_,_nt_,csnd,_oD_,_oE_)},
         _nq_];
      function _nw_(param)
       {var
         stm3=param[2],
      ...
      function _nx_(_oA_,_oB_){return stm_pars(tag,rettag,_oA_,_oB_)}
      var _ny_=0;
      function _nz_(_oy_,_oz_){return stm_pars(tag,_ny_,_oy_,_oz_)}
      var _nA_=kwd(_g4_);
      function _nB_(_ow_,_ox_){return concat$0(_nA_,_nz_,csnd,_ow_,_ox_)}
      function _nC_(_ou_,_ov_){return option(_nB_,_ou_,_ov_)}
      var _nD_=0;
      function _nE_(_os_,_ot_){return stm_pars(tag,_nD_,_os_,_ot_)}
      var _nF_=kwd(_g5_);
      function _nG_(_oq_,_or_){return concat$0(_nF_,bool_expr,csnd,_oq_,_or_)}
      function _nH_(_oo_,_op_){return concat$0(_nG_,_nE_,couple,_oo_,_op_)}
      function _nI_(_om_,_on_){return concat$0(_nH_,_nC_,couple,_om_,_on_)}
      function _nJ_(_ok_,_ol_){return concat$0(_nI_,_nx_,couple,_ok_,_ol_)}
      var
       _nK_=
        [0,function(_oi_,_oj_){return comb_parser(_nJ_,_nw_,_oi_,_oj_)},_nv_],
       _nL_=
        [0,
         function(s,t)
          {var
            ...
            match=
             option
              (function(_og_,_oh_)
                {return concat$0(varname,_n4_,cfst,_og_,_oh_)},
               s,
               t),
            t1=match[4],
            error1=match[3],
           ...
           function aux(lhstag,lhs,s1,t1)
            {function _n__(_oe_,_of_){return stm_pars(tag,rettag,_oe_,_of_)}
             var
              _n$_=kwd(_g7_),
              _oa_=rhs_pars(lhstag),
              _ob_=
               concat$0
                (function(_oc_,_od_)
                  {return concat$0(_oa_,_n$_,cfst,_oc_,_od_)},
                 _n__,
                 couple,
                 s1,
                 t1),
           ...
           if(match$0)
            {var _n5_=match$0[1];
             if(_n5_)
              {var _n6_=_n5_[1],_n7_=_n6_[1][1],_n8_=_n7_[2],_n9_=_n7_[1];
               return 0 === _n6_[2]
                       ?aux(_n9_,[0,[0,_n9_,_n8_]],s1,t1)
                       :aux(_n9_,[1,[0,_n9_,_n8_]],s1,t1)}
             throw [0,Fail,best([0,_g9_,s],error1)]}
           return aux(0,0,s1,t1)},
         _nK_];
      function _nj_(rhs,param)
       {if(rhs){var rhs$0=rhs[1];return [0,rhs$0]}
        if(0 === tag)return 1;
        throw [0,Reject,symbol(_gZ_,pp_tag(tag))]}
      var _nk_=kwd(_g0_),_nl_=rhs_pars(tag);
      function _nm_(_n2_,_n3_){return option(_nl_,_n2_,_n3_)}
      var _nn_=kwd(_g1_);
      function _no_(_n0_,_n1_){return concat$0(_nn_,_nm_,csnd,_n0_,_n1_)}
      var
       _nM_=
        [0,
         function(_nY_,_nZ_){return concat$0(_no_,_nk_,_nj_,_nY_,_nZ_)},
         _nL_];
      return caml_call2
              (choice_list
                ([0,
    ...
    function varlist_append(l1,l2)
     {var _nh_=l1[1];
      if(_nh_)
       {var tl=_nh_[2],hd=_nh_[1],match=varlist_append([0,tl],l2),l=match[1];
        return [0,[0,hd,l]]}
      return l2}
    ...
    function pars_varlist_singleton(_ne_,_nf_)
     {return concat$0(type_pars,varname,_g$_,_ne_,_nf_)}
    function parameter_pars(s,t)
     {var _m4_=kwd(_hb_);
      function _m5_(_nc_,_nd_)
       {return concat$0(_m4_,pars_varlist_singleton,csnd,_nc_,_nd_)}
      function _m6_(_na_,_nb_)
       {return kleenestar(_m5_,_ha_,varlist_append,_na_,_nb_)}
      function _m7_(_m__,_m$_)
       {return concat$0(pars_varlist_singleton,_m6_,varlist_append,_m__,_m$_)}
      var
       match=
        caml_call2
         (brackets_pars
           (function(_m8_,_m9_){return option2(_hc_,_m7_,_m8_,_m9_)}),
          s,
          t),
       nt=match[4],
       error=match[3],
    ...
    function vars_pars(s,t)
     {var
       ...
       match=
        kleenestar
         (function(_m2_,_m3_)
           {return concat$0(pars_varlist_singleton,_m1_,cfst,_m2_,_m3_)},
          _hd_,
          varlist_append,
          s,
          t),
    ...
    function block_pars(opt,tag,vl,s,t)
     {if(opt)var sth=opt[1],check_payable=sth;else var check_payable=0;
      var _mC_=kwd(_hf_),_mD_=1;
      function _mE_(_mZ_,_m0_){return stm_pars(tag,_mD_,_mZ_,_m0_)}
      var _mF_=kwd(_hg_);
      function _mG_(param)
    ...
    function any_meth_pars(s,t)
     {var _mi_=brackets_pars(type_pars),_mj_=kwd(_hj_);
      function _mk_(_mA_,_mB_){return concat$0(_mj_,_mi_,csnd,_mA_,_mB_)}
      function _ml_(_my_,_mz_){return option2(_hk_,_mk_,_my_,_mz_)}
      var _mm_=kwd(_hl_);
      function _mn_(_mw_,_mx_){return concat$0(_mm_,varname,csnd,_mw_,_mx_)}
      var
       _mo_=
        concat$0
         (function(_mu_,_mv_)
           {return concat$0(_mn_,parameter_pars,couple,_mu_,_mv_)},
          _ml_,
          couple,
          s,
          t),
      ...
      try
       ...
       {exn = caml_wrap_exception(exn);
        ...
        throw exn}
      var
       _mr_=block_pars(0,t1,vl,ns1,nt1$0),
       nt2=_mr_[4],
       error2=_mr_[3],
       match$0=_mr_[2],
       payable=match$0[2],
       block=match$0[1],
       ns2=_mr_[1],
       _ms_=remove_local_vars(nt2),
       _mt_=best(error1,error2);
      return [0,ns2,[0,[0,t1,get_taglist(vl),name],block,payable],_mt_,_ms_]}
    function methods_pars(s)
     {var _mg_=0;
      return function(_mh_)
       {return kleenestar(any_meth_pars,_mg_,addel,s,_mh_)}}
    function _hm_(param)
     {var _mf_=param[1];
      if(0 === param[2])throw [0,Assert_failure,_hn_];
      return _mf_}
    var _ho_=0,_hp_=0;
    function _hr_(_md_,_me_){return block_pars(_hq_,_hp_,_ho_,_md_,_me_)}
    var _ht_=kwd(_hs_),_hv_=kwd(_hu_),_hx_=kwd(_hw_);
    function _hy_(_mb_,_mc_){return concat$0(_hx_,_hv_,cfst,_mb_,_mc_)}
    function _hz_(_l$_,_ma_){return concat$0(_hy_,_ht_,cfst,_l$_,_ma_)}
    function _hA_(_l9_,_l__){return concat$0(_hz_,_hr_,csnd,_l9_,_l__)}
    function fallback_pars(_l7_,_l8_){return comb_parser(_hA_,_hm_,_l7_,_l8_)}
    function actor_pars(s,t)
     {function _lI_(param)
      ...
      var _lJ_=kwd(_hB_);
      function _lK_(_l4_,_l5_){return option(fallback_pars,_l4_,_l5_)}
      var _lL_=kwd(_hC_),_lM_=kwd(_hD_);
      function _lN_(_l2_,_l3_){return concat$0(_lM_,varname,csnd,_l2_,_l3_)}
      function _lO_(_l0_,_l1_){return concat$0(_lN_,_lL_,cfst,_l0_,_l1_)}
    ...
    var _hE_=0;
    function _hF_(_lG_,_lH_)
     {return kleenestar(actor_pars,_hE_,addel,_lG_,_lH_)}
    function configuration_pars(_lE_,_lF_)
     {return concat$0(_hF_,eof,cfst,_lE_,_lF_)}
        ...
        for(;;)
         {if(param$0)
           {var _lC_=param$0[1];
            if(0 === _lC_[0])
             {var _lD_=_lC_[1];
              if(! caml_string_notequal(_lD_,_hH_))
               {var
                 param$2=param$0[2],
                 n$2=n$0 + 1 | 0,
                 n$0=n$2,
                 param$0=param$2;
                continue}
              if(! caml_string_notequal(_lD_,_hI_))
               {var tl=param$0[2];
                if(0 === n$0)return tl;
       ...
       {var acc$0=acc,l$0=l;
        for(;;)
         {if(l$0)
           {var _lw_=l$0[1];
            if(0 === _lw_[0])
             if(! caml_string_notequal(_lw_[1],_hK_))
              {var _lx_=l$0[2];
               if(_lx_)
                {var _ly_=_lx_[1];
                 if(1 === _ly_[0])
                  {var _lz_=_lx_[2];
                   if(_lz_)
                    {var _lA_=_lz_[1];
                     if(0 === _lA_[0])
                      {var _lB_=_ly_[1];
                       if(! caml_string_notequal(_lA_[1],_hM_))
                        {var tl=_lz_[2];
                         try
        ...
        {case 0:return stm1;
         ...
         default:
          var
           ...
           _lu_=retype_stm(stm_concat(stmb,cont$1));
          return [2,g,retype_stm(stm_concat(stma,cont$1)),_lu_,2]}}
            ...
            function(param)
             {var
              ...
              if(typeof lhs === "number")
               ...
               if(0 === lhs[0])
                var v=lhs[1],_ls_=[0,[0,lhs],[0,v[1],[0,v]]];
               else
                var v$0=lhs[1],_ls_=[0,[0,lhs],[0,v$0[1],[0,v$0]]];
              var
               match$0=_ls_[2],
               ret_param=match$0[2],
               lhs_tag=match$0[1],
          ...
          if(typeof lhs === "number")
           ...
           if(1 === lhs[0])
            if(typeof cont$0 !== "number" && 0 === cont$0[0])
             {var _ln_=cont$0[1],_lo_=lhs[1];
              if(0 === _ln_[0])
               {var _lp_=_ln_[1];
                if(typeof _lp_ !== "number" && 0 === _lp_[0])
                 {var v=_lp_[1],match$0=eq_tag(_lo_[1],v[1]);
                  if(match$0)
                   if(caml_string_equal(_lo_[2],v[2]))return [0,meths,[0,rhs]];
                  return make_cont(0)}}}
          return make_cont(0);
         case 2:
          var
           ...
           stm2$0=match$2[2],
           meths2=match$2[1],
           _lq_=retype_stm(stm2$0),
           _lr_=[2,g,retype_stm(stm1$0),_lq_,2];
          return [0,op(meths1,meths2),_lr_]
         }
      return [0,0,stm]}
    ...
    function normalize(_lm_){return map(norm_a_contract,_lm_)}
     ...
     {var
      ...
      for(;;)
       {if(param$0)
        ...
        var _ll_=match$0[2];
        if(0 === _ll_[1]){var cycle=_ll_[2];throw [0,Cycle,cycle]}
        return [0,tbl,0]}}
           ...
           (function(param)
             {var fb=param[3],ms=param[2],a$0=param[1];
              if(typeof aexpr === "number")
               if(0 === aexpr)
                var _ld_=caml_string_equal(a$0,this$0),switch$0=1;
               else
                var switch$0=0;
              else
               if(13 === aexpr[0])
                var a=aexpr[1],_ld_=caml_string_equal(a$0,a),switch$0=1;
               else
                var switch$0=0;
              if(! switch$0)var _ld_=1;
              if(_ld_)
               {var
                 _le_=
                  caml_call1
                   (find_all
                     (function(param)
                       {var
                         m=param[1],
                         _lj_=caml_string_equal(meth[3],m[3]),
                         _lk_=_lj_?0 !== eq_tag_list(meth[2],m[2])?1:0:_lj_;
                        return _lk_}),
                    ms);
                if(_le_)
                 {if(_le_[2])throw [0,Assert_failure,_eU_];
                  var m=_le_[1],matched=[0,[0,a$0,m],0]}
                else
                 if(fb)
                  var
                   fb$0=fb[1],
                        ...
                        (find_all
                          (function(param)
                            {var
                             ...
                             if(_lg_)
                              var
                               _lh_=0 !== eq_tag(meth[1],0)?1:0,
                               _li_=_lh_ || (0 !== eq_tag(meth[1],m[1])?1:0);
                             else
                              var _li_=_lg_;
                             return _li_}),
                         matched)}
        ...
        if(typeof stm$0 === "number")
         ...
         switch(stm$0[0])
          {case 0:
           ...
           case 1:
            var _k$_=stm$0[2];
            if(0 === _k$_[0]){var stm$1=stm$0[3],stm$0=stm$1;continue}
            var _la_=stm$0[3];
            if(typeof _la_ !== "number" && 0 === _la_[0])
             {var
               rhs2=_la_[1],
               match=get_bounds_rhs(f,cfg,0,addr,_k$_,tbls),
               b1=match[2],
               tbl$0=match[1],
            ...
            (function(tbl,param)
              {var fallback=param[3],methods=param[2],addr=param[1];
               if(fallback)
                var
                 fb=fallback[1],
                 _k__=[0,any_method_decl_of_fallback(fb),methods];
               else
                var _k__=methods;
               return fold_left
                       (function(tbl,m)
    ...
    function _ie_(m,param)
     {var
       fallback=param[3],
       methods=param[2],
       _k7_=fold(0,maxargs_block,fallback);
      return max(m,max(fold_left(_ic_,_ib_,methods),_k7_))}
     ...
     {var match$0=get_bounds(cfg);
      if(0 === match$0[0])
       {var
         ...
         max_stack=
          fold_left
           (function(m,param){var n=param[2];return max(m,n)},_k3_,l$0);
      ...
      if(l$1)
       {var
         ...
         m=match[1],
         a=_k0_[1],
         _k1_=symbol(_hZ_,symbol(a,symbol(_hY_,symbol(pp_meth(0,m),_hX_)))),
         _k2_=rev(l);
        return symbol
                (_h7_,
                 symbol
                  (fold_left
                    (function(acc,param)
                      {var
                        ...
                        m=match[1],
                        a=_k4_[1],
                        _k5_=is_tail?_h2_:_h6_,
                        _k6_=symbol(_h3_,symbol(_k5_,_h1_));
                       return symbol
                               (acc,
                                symbol
                                 (_h5_,symbol(a,symbol(_h4_,symbol(pp_meth(0,m),_k6_)))))},
                     _h0_,
                     _k2_),
                   _k1_))}
    ...
    function string_of_meth(addr,m)
     {var _kZ_=concat(_ig_,pp_tag_list(m[2]));
      return symbol$0(addr,symbol$0(m[3],_kZ_))}
    ...
    function assign(k,v,init)
     {var
       ...
       _kW_=init[5],
       _kX_=init[4],
       _kY_=assign_gamma(k,v,init[3]);
      return [0,init[1],init[2],_kY_,_kX_,_kW_,_kV_,_kU_]}
    function lookup_gamma(k,gamma)
     {try
       {var _kS_=assoc(k,gamma);return _kS_}
      catch(_kT_)
       {_kT_ = caml_wrap_exception(_kT_);
        if(_kT_ === Not_found){error(k);throw [0,Assert_failure,_ik_]}
        throw _kT_}}
       ...
       {_kQ_ = caml_wrap_exception(_kQ_);
        if(_kQ_ === Not_found)
         {error(symbol(_in_,v));
          ...
          var _kN_=status[7];
          error
           (symbol(_iq_,concat(_ip_,map(function(_kR_){return _kR_[1]},_kN_))));
     ...
     {if(typeof expr !== "number")
       switch(expr[0])
        {case 0:var v=expr[1];return lookup(status,v[2]);
         ...
         case 2:
          var e2=expr[2],e1=expr[1],_kJ_=type_of_iexpr(status,e2);
          return [2,type_of_iexpr(status,e1),_kJ_];
         case 3:
          var e2$0=expr[2],e1$0=expr[1],_kK_=type_of_iexpr(status,e2$0);
          return [3,type_of_iexpr(status,e1$0),_kK_];
         case 4:
          var e2$1=expr[2],e1$1=expr[1],_kL_=type_of_iexpr(status,e2$1);
          return [4,type_of_iexpr(status,e1$1),_kL_];
         case 5:
          var e2$2=expr[2],e1$2=expr[1],_kM_=type_of_iexpr(status,e2$2);
          return [5,type_of_iexpr(status,e1$2),_kM_];
    ...
    function type_of_pred(status,expr)
     {if(typeof expr !== "number")
       switch(expr[0])
        {case 1:
          var v$0=expr[1],_kD_=int_of_bool(1);
          return [3,lookup(status,symbol$0(status[6],v$0[2])),_kD_];
         case 7:
          var e2=expr[2],e1=expr[1],_kE_=type_of_iexpr(status,e2);
          return [1,type_of_iexpr(status,e1),_kE_];
         case 8:
          var e2$0=expr[2],e1$0=expr[1],_kF_=type_of_iexpr(status,e2$0);
          return [2,type_of_iexpr(status,e1$0),_kF_];
         case 9:
          switch(expr[1])
           {case 0:return _is_;
            case 1:
             var e2$1=expr[3],e1$1=expr[2],_kG_=type_of_iexpr(status,e2$1);
             return [3,type_of_iexpr(status,e1$1),_kG_];
            case 2:
             var
              e2$2=expr[3],
              e1$2=expr[2],
            ...
            default:
             ...
             return [3,a1$0,a2$0]}
         case 10:
          var e2$4=expr[2],e1$4=expr[1],_kH_=type_of_pred(status,e2$4);
          return [4,type_of_pred(status,e1$4),_kH_];
         case 11:
          var e2$5=expr[2],e1$5=expr[1],_kI_=type_of_pred(status,e2$5);
          return [5,type_of_pred(status,e1$5),_kI_];
         case 12:var p=expr[1];return [6,type_of_pred(status,p)];
         case 13:var b=expr[1];return [0,b]
         }
      var v=expr[1],_kC_=int_of_bool(1);
      return [3,lookup(status,v[2]),_kC_]}
    ...
    function revert(status)
     {var _kB_=status[1];return [0,map(function(v){return [1,v]},_kB_)]}
     ...
     {if(! _iu_[1])
       {if(public_methods === 0)
         ...
         {var l=public_methods.length - 1;
          ...
          var _ks_=table}
        var
         _kt_=new_variable(_ks_,_iv_),
         label=get_method_label(_ks_,_iw_),
         element=
          function(self_1)
    ...
    function match_method(status,addr,meth,params)
     {try
       ...
       {_ke_ = caml_wrap_exception(_ke_);
        if(_ke_ === Not_found)throw [0,Assert_failure,_iy_];
        throw _ke_}
      ...
      try
       ...
       {_kb_ = caml_wrap_exception(_kb_);
        if(_kb_ === Not_found)
         try
          {var _j$_=[0,aux(fallback,0,meths)];return _j$_}
         catch(_kc_)
     ...
     {var
      ...
      if(match)
       {var
         ...
         payable=match$0[2],
         meth$0=match$0[1],
         _j8_=0 !== eq_tag(tag,0)?1:0,
         output_type_ok=_j8_ || (0 !== eq_tag(tag,meth$0[1])?1:0),
        ...
        if(output_type_ok)
         if(payable_ok)
          {var
            value=
             fold
              (_it_,function(_j__){return type_of_iexpr(status,_j__)},value$0),
            _j9_=meth$0[2],
            params$1=expr_list_map(type_of_expr_poly(status),_j9_,params$0);
       ...
       {if(typeof stm$0 === "number")
         ...
         switch(stm$0[0])
          {case 0:
            var _jO_=stm$0[1];
            if(0 === _jO_[0])
             {var e=_jO_[1],e$0=type_of_expr(status$0,tag,e);
              if(345791162 <= e$0[1])
               {var
                 p=e$0[2],
           ...
           case 1:
            var _jP_=stm$0[2],_jQ_=stm$0[1];
            if(0 === _jP_[0])
             {var stm$1=stm$0[3],e$2=_jP_[1],lhs_tag=tag_of_lhs(_jQ_);
              if(typeof _jQ_ === "number")
               var lhs=0;
              else
               if(0 === _jQ_[0])
                var f=_jQ_[1],lhs=[0,symbol$0(status$0[6],f[2])];
               else
                var v=_jQ_[1],lhs=[0,v[2]];
              if(lhs)
               ...
               if(0 === _jS_[0])
                ...
                {if(! _jS_[3])
                  {var
                    ...
                    _jX_=m2[2],
                    args2$0=
                     expr_list_map(type_of_expr_poly(status$0),_jX_,args2),
                           ...
                           (status$0,
                            ...
                            function(args2)
                             {var
                               ...
                               _jZ_=length(l),
                               l$0=op(l,mk_list(bottom,status$0[5] - _jZ_ | 0)),
                               gamma=[0,status$0[3]],
                               _j0_=status$0[4],
                               _j1_=status$0[5] + 1 | 0;
                              if(! (_j0_ < _j1_))
                               {var i=_j0_;
                                for(;;)
                                 {var
                                  ...
                                  =
                                  assign_gamma
                                   (symbol$0(stack,caml_new_string("" + i)),_j5_,_j3_);
                                  var _j6_=i - 1 | 0;
                                  if(_j1_ !== i){var i=_j6_;continue}
                                  break}}
                              var n=1,param=l$0;
                              for(;;)
                               {if(param)
                                 {var tl=param[2],hd=param[1],_j2_=gamma[1];
                                  gamma[1]
                                  =
                                  assign_gamma
                                   (symbol$0(stack,caml_new_string("" + n)),hd,_j2_);
                                ...
                                var
                                 status=
                                  [0,
                                   ...
                                   status$0[7]];
                                return type_of_call
                                        (status,tag_of_lhs(_jQ_),_jW_,_jV_,_jU_,sender$0,_jT_)}})}
                 var switch$0=1}}
             else
              var switch$0=0;
            break;
    ...
    function args_of_var_list(param)
     {if(param)
       {var tl=param[2],n=param[1],_jM_=args_of_var_list(tl),_jN_=n[2];
        return [0,[0,0 !== eq_tag(3,n[1])?1:0,_jN_],_jM_]}
      return 0}
    function type_of_a_method0
     (k$1,frame_size,fields,contracts,this$0,name,args,locals,typ_of)
     {var
       fields$0=map(function(_jL_){return _jL_[2]},fields),
       args$0=map(function(_jK_){return _jK_[2]},args),
       locals$0=map(function(_jJ_){return _jJ_[2]},locals),
       ...
       {if(opt)var sth=opt[1],acc=sth;else var acc=0;
        if(0 === k)
         {var
           ...
           _jH_=map(function(v){return [0,v,bottom]},locals$0),
           gamma=op(map(function(v){return [0,v,[1,v]]},other_params),_jH_),
           status=
            [0,saved_gamma,fields$0,gamma,k$1,frame_size,this$0,contracts],
           typ=caml_call1(typ_of,status),
           _jI_=op(saved_gamma,other_params);
          return [0,string_of_meth(this$0,name),_jI_,typ]}
        var
         k$0=k - 1 | 0,
         ...
         (fold_left
           (function(acc,contr)
             {var
               ...
               accu=0,
               param=fields,
               _jE_=[0,[0,0,symbol$0(a$0,balance)],0];
              for(;;)
               {if(param)
                 {var
                   l=param[2],
                   a=param[1],
                   f=a[1],
                   _jF_=symbol$0(a$0,f[2]),
                   accu$0=[0,[0,0 !== eq_tag(f[1],3)?1:0,_jF_],accu],
                   accu=accu$0,
                   param=l;
                  continue}
                return op(op(accu,_jE_),acc)}},
            _ja_,
            cfg)),
       _jb_=0,
       program_rev=
         ...
         (function(acc,contr)
           {var fb=contr[3],meths=contr[2],a=contr[1];
            if(fb)
             var
              fb$0=fb[1],
              _jz_=op(meths,[0,any_method_decl_of_fallback(fb$0),0]);
            else
             var _jz_=meths;
            var _jA_=0;
            return op
                                         ...
                                         (status,
                                          ...
                                          function(a,param)
                                           {var
                                             ...
                                             _jD_=aux(assign(v,a$0,status),tl);
                                            return [0,[3,lookup(status,v),a$0],_jD_]})}
                               var stm=block[3];
                           ...
                           return [0,
                                   type_of_a_method0
                                    (k,
                                     ...
                                     args$0,
                                     locals$0,
                                     function(_jC_){return aux(_jC_,to_sum_on)}),
                                   acc]}},
                       _jA_,
                       _jz_),
                     acc)},
            ...
            {var
              ...
              otherwise=
               [0,
                [0,
                 is_empty,
                 [0,map(function(_jy_){return lookup(status$0,_jy_)},_jt_)]],
                _js_],
              gamma=[0,status$0[3]],
              _jj_=status$0[4] - status$0[5] | 0,
              _ji_=1;
             if(! (_jj_ < 1))
              {var i$0=_ji_;
               for(;;)
                {var
                 ...
                 =
                 assign_gamma
                  (symbol$0(stack,caml_new_string("" + i$0)),_jq_,_jo_);
                 var _jr_=i$0 + 1 | 0;
                 if(_jj_ !== i$0){var i$0=_jr_;continue}
                 break}}
             var
              _jk_=(status$0[4] - status$0[5] | 0) + 1 | 0,
              _jl_=status$0[4];
             if(! (_jl_ < _jk_))
              {var i=_jk_;
               for(;;)
                {var _jm_=gamma[1];
                 ...
                 =
                 assign_gamma
                  (symbol$0(stack,caml_new_string("" + i)),bottom,_jm_);
                 var _jn_=i + 1 | 0;
                 if(_jl_ !== i){var i=_jn_;continue}
                 break}}
             function read(i)
              {if(status$0[5] < i)return 0;
               var _jw_=read(i + 1 | 0),_jx_=status$0[3];
               return [0,
                       lookup_gamma(symbol$0(stack,caml_new_string("" + i)),_jx_),
                       _jw_]}
             var
              status=
               [0,
                                ...
                                function(addr$0,meths)
                                 {function f(param)
                                   {var
                                    ...
                                    return [0,[3,meth,int_of_meth(meth$0)],_jv_]}
                                  var _ju_=tchoice(status,map(f,meths));
                                  return [0,[3,addr,int_of_address(addr$0)],_ju_]})}}}}
               throw [0,Assert_failure,_il_]}
             throw [0,Assert_failure,_im_]}),
         _jc_];
      return op(rev(program_rev),_jd_)}
    ...
    function transform(f,param)
     {var
      ...
      doc_out.setValue(y);
      return 0}
    function _iC_(_i$_){return test_string(pp_configuration,_i$_)}
    function parse(_i__){return transform(_iC_,_i__)}
    function _iD_(c){return pp_configuration(normalize(c))}
    function _iE_(_i9_){return test_string(_iD_,_i9_)}
    function normalize$0(_i8_){return transform(_iE_,_i8_)}
    function _iF_(c)
     {var c$0=normalize(c);
                         ...
                         (fold_left
                           (function(acc,param)
                             {var
                               ...
                               m=match[1],
                               a=_i6_[1],
                               _i7_=symbol(_h__,caml_new_string("" + b));
                              return symbol
                                      (acc,
                                       symbol
                                        (_ia_,symbol(a,symbol(_h$_,symbol(pp_meth(0,m),_i7_)))))},
                            _h9_,
                            bounds),
                          _i5_)},
               c$0)}
    function _iK_(_i4_){return test_string(_iF_,_i4_)}
    function get_bounds$0(_i3_){return transform(_iK_,_i3_)}
    function _iL_(c)
     {var c$0=normalize(c);
      return with_maxargs_and_stack_bound
              (function(param,max_args,max_stack)
               ...
               c$0)}
    function _iM_(_i2_){return test_string(_iL_,_i2_)}
    function type_of$0(_i1_){return transform(_iM_,_i1_)}
    function _iN_(c)
     {var c$0=normalize(c);
      return with_maxargs_and_stack_bound
              (function(param,max_args,max_stack)
