...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _B_=[0,0,0,0],
     _C_=[0,caml_string_of_jsbytes("map.ml"),399,10],
     _D_=[0,0,0],
     ...
     _N_=caml_string_of_jsbytes("Buffer.add: cannot grow buffer"),
     _M_=[0,caml_string_of_jsbytes("buffer.ml"),93,2],
     _L_=[0,caml_string_of_jsbytes("buffer.ml"),94,2],
     ...
     _bM_=caml_string_of_jsbytes("Out of memory"),
     _bN_=caml_string_of_jsbytes("Stack overflow"),
     _bO_=caml_string_of_jsbytes("Pattern matching failed"),
     _bP_=caml_string_of_jsbytes("Assertion failed"),
     _bQ_=caml_string_of_jsbytes("Undefined recursive module"),
     _bI_=[0,[12,40,[2,0,[2,0,[12,41,0]]]],caml_string_of_jsbytes("(%s%s)")],
     _bJ_=caml_string_of_jsbytes(""),
     _bK_=caml_string_of_jsbytes(""),
     _bL_=[0,[12,40,[2,0,[12,41,0]]],caml_string_of_jsbytes("(%s)")],
     _bF_=[0,[4,0,0,0,0],caml_string_of_jsbytes("%d")],
     _bD_=[0,[3,0,0],caml_string_of_jsbytes("%S")],
     _bE_=caml_string_of_jsbytes("_"),
     ...
     _dS_=caml_string_of_jsbytes("returns ("),
     _dW_=caml_string_of_jsbytes(""),
     ...
     _f__=caml_string_of_jsbytes("implicit return not allowed here"),
     _f$_=caml_string_of_jsbytes("ok"),
     _ga_=caml_string_of_jsbytes("ok"),
     ...
     _h9_=[0,caml_string_of_jsbytes("typeInference.ml"),473,9],
     _ia_=caml_string_of_jsbytes(" encoded as "),
     _h8_=[2,0],
     _h6_=[0,0],
     _h7_=[0,0],
     _h5_=caml_string_of_jsbytes("TRANSFER ABORTED TO "),
     _h4_=[0,0],
     _h3_=[0,caml_string_of_jsbytes("typeInference.ml"),264,20],
     _h2_=[0,caml_string_of_jsbytes("typeInference.ml"),244,1],
     _h1_=caml_string_of_jsbytes("f"),
     _h0_=[0,0],
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_yt_ = caml_wrap_exception(_yt_);
              if(_yt_[1] !== Sys_error)throw _yt_;
              var _ys_=_yt_}
            var param$0=l;
            continue}
          return 0}}
     ...
     {var switch$0=0;
      if
       ...
       {var r=caml_create_bytes(len);
        ...
        var _yr_=r;
        switch$0 = 1}
      if(! switch$0)var _yr_=invalid_arg(_p_);
      return caml_string_of_bytes(_yr_)}
           ...
           {var _yo_=param[1];
            if(param[2])
             {var
               ...
               param=tl;
              continue}
            var _yq_=caml_ml_string_length(_yo_) + acc | 0}
          else
           var _yq_=acc;
    ...
    function _E_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
         ...
         {var _yc_=param[1];
          if(_yc_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_yc_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_A_)}
      function _xR_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
            ...
            if(_x$_)
             {var _ya_=for_all(p,l);
              if(_ya_){var param$0=r;continue}
              var _yb_=_ya_}
            else
             var _yb_=_x$_;
            return _yb_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _x8_=caml_call2(p,v,d);
            if(_x8_)
             var _x9_=_x8_;
            else
             {var _x__=exists(p,l);
              if(! _x__){var param$0=r;continue}
              var _x9_=_x__}
            return _x9_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _x4_=merge(f,r1,r2),
             _x5_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_x5_,_x4_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _x6_=merge(f,r1$0,r2$0),
           _x7_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_x7_,_x6_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _x2_=concat(lf,rf);return [0,join(lt,v,d,rt),_x2_]}
          var _x3_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_x3_]}
        return _D_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _xZ_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_xZ_)
               {var _x0_=caml_call2(cmp,d1,d2);
                if(_x0_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_xY_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _xY_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_xW_=cons_enum(t,rest);
          return [0,[0,k,v],function(_xX_){return seq_of_enum(_xW_,_xX_)}]}
        return 0}
      function to_seq(m)
       {var _xU_=cons_enum(m,0);
        return function(_xV_){return seq_of_enum(_xU_,_xV_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _xS_=c;
          return function(_xT_){return seq_of_enum(_xS_,_xT_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function fill_buff(b)
     {var len=caml_ml_bytes_length(b[2]),_xO_=b[2],switch$0=0,_xP_=b[1];
      if(0 <= len && ! ((caml_ml_bytes_length(_xO_) - len | 0) < 0))
       {var _xQ_=caml_ml_input(_xP_,_xO_,0,len);switch$0 = 1}
      if(! switch$0)var _xQ_=invalid_arg(_e_);
      b[3] = _xQ_;
      b[4] = 0;
      return 0}
          ...
          {case 1:
           ...
           case 2:
            var
             f=d$0[1],
             _xK_=caml_obj_tag(f),
             d$1=250 === _xK_?f[1]:246 === _xK_?force_lazy_block(f):f,
             d$0=d$1;
            continue;
           case 3:
            var _xL_=d$0[1],_xM_=_xL_[1];
            if(_xM_)
             {var _xN_=_xM_[1];
              if(_xN_){var a$0=_xN_[1];_xL_[1] = 0;return [0,a$0,d$0]}
              return 0}
            var match$0=caml_call1(_xL_[2],count);
     ...
     {for(;;)
       {var _xF_=s[2];
        if(typeof _xF_ === "number")
         ...
         switch(_xF_[0])
          {case 0:var a=_xF_[1];return [0,a];
           case 1:
           ...
           case 2:
            var
             f=_xF_[1],
             _xG_=caml_obj_tag(f),
             _xH_=250 === _xG_?f[1]:246 === _xG_?force_lazy_block(f):f;
            s[2] = _xH_;
            continue;
           case 3:
            var _xI_=_xF_[1],_xJ_=_xI_[1];
            if(_xJ_){var a$1=_xJ_[1];return a$1}
            var x=caml_call1(_xI_[2],s[1]);
            _xI_[1] = [0,x];
            return x;
           default:
            var b=_xF_[1];
        ...
        for(;;)
         {var _xD_=data[2];
          if(typeof _xD_ !== "number")
           switch(_xD_[0])
            {case 0:
              var d=_xD_[2];data[1] = data[1] + 1 | 0;data[2] = d;return 0;
             case 3:
              var _xE_=_xD_[1];
              if(_xE_[1]){data[1] = data[1] + 1 | 0;_xE_[1] = 0;return 0}
              break;
             case 4:
              var b=_xD_[1];
              if(b[3] <= b[4])fill_buff(b);
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_xi_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_xi_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_xj_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_xj_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_xk_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_xk_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_xl_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_xl_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_xm_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_xm_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_xn_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_xn_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_xo_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_xo_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_xp_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_xp_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_xq_=ty1[2],_xr_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_xs_=trans(_xq_,rest2$7);
              return [8,trans(_xr_,ty2),_xs_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_xt_=ty1[3],_xu_=ty1[2],_xv_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_xu_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_xv_,ty22,trans(_xt_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_xw_,rest2$9)]}
          throw [0,Assert_failure,_aw_];
         case 11:
          var switch$11=0,_xx_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_xx_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ax_];
          break;
         case 12:
          var switch$12=0,_xy_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_xy_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ay_];
          break;
         case 13:
          var switch$13=0,_xz_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_xz_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_az_];
          break;
         default:
          var switch$14=0,_xA_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_xA_,rest2$13)];
             default:switch$14 = 1}
    ...
    function type_padprec(pad,prec,fmtty)
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(prec)
         {var _wV_=match[2];
          if(typeof _wV_ !== "number" && 2 === _wV_[0])
           {var rest=_wV_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _wT_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_wT_))
             throw Type_mismatch;
            var _wU_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_wU_))
             throw Type_mismatch;
            var
        ...
        {case 0:
         ...
         case 4:
          var
           ...
           _wG_=match$5[3],
           _wF_=match$5[1];
          if(typeof _wG_ !== "number" && 2 === _wG_[0])
           {var
             fmtty_rest$3=_wG_[1],
             prec$0=match$5[2],
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_wF_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _wI_ !== "number" && 3 === _wI_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_wH_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
          ...
          if(typeof _wK_ !== "number" && 4 === _wK_[0])
           {var
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_wJ_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
          ...
          if(typeof _wM_ !== "number" && 5 === _wM_[0])
           {var
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_wL_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _wO_=match$13[3],
           _wN_=match$13[1];
          if(typeof _wO_ !== "number" && 6 === _wO_[0])
           {var
             fmtty_rest$7=_wO_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_wN_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _wR_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_wR_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _wS_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_wS_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_wS_[1];
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _wj_=_aD_;break;
        case 2:var _wj_=_aE_;break;
        case 4:var _wj_=_aG_;break;
        case 5:var _wj_=_aH_;break;
        case 6:var _wj_=_aI_;break;
        case 7:var _wj_=_aJ_;break;
        case 8:var _wj_=_aK_;break;
        case 9:var _wj_=_aL_;break;
        case 10:var _wj_=_aM_;break;
        case 11:var _wj_=_aN_;break;
        case 0:
        case 13:var _wj_=_aC_;break;
        case 3:
        case 14:var _wj_=_aF_;break;
        default:var _wj_=_aO_}
      return transform_int_alt(iconv,caml_format_int(_wj_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _wi_=_a3_;break;
        case 2:var _wi_=_a4_;break;
        case 4:var _wi_=_a6_;break;
        case 5:var _wi_=_a7_;break;
        case 6:var _wi_=_a8_;break;
        case 7:var _wi_=_a9_;break;
        case 8:var _wi_=_a__;break;
        case 9:var _wi_=_a$_;break;
        case 10:var _wi_=_ba_;break;
        case 11:var _wi_=_bb_;break;
        case 0:
        case 13:var _wi_=_a2_;break;
        case 3:
        case 14:var _wi_=_a5_;break;
        default:var _wi_=_bc_}
      return transform_int_alt(iconv,caml_format_int(_wi_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _wh_=_be_;break;
        case 2:var _wh_=_bf_;break;
        case 4:var _wh_=_bh_;break;
        case 5:var _wh_=_bi_;break;
        case 6:var _wh_=_bj_;break;
        case 7:var _wh_=_bk_;break;
        case 8:var _wh_=_bl_;break;
        case 9:var _wh_=_bm_;break;
        case 10:var _wh_=_bn_;break;
        case 11:var _wh_=_bo_;break;
        case 0:
        case 13:var _wh_=_bd_;break;
        case 3:
        case 14:var _wh_=_bg_;break;
        default:var _wh_=_bp_}
      return transform_int_alt(iconv,caml_format_int(_wh_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _wg_=_aQ_;break;
        case 2:var _wg_=_aR_;break;
        case 4:var _wg_=_aT_;break;
        case 5:var _wg_=_aU_;break;
        case 6:var _wg_=_aV_;break;
        case 7:var _wg_=_aW_;break;
        case 8:var _wg_=_aX_;break;
        case 9:var _wg_=_aY_;break;
        case 10:var _wg_=_aZ_;break;
        case 11:var _wg_=_a0_;break;
        case 0:
        case 13:var _wg_=_aP_;break;
        case 3:
        case 14:var _wg_=_aS_;break;
        default:var _wg_=_a1_}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _wd_ >>> 0)
              {if(55 === _wd_)switch$0 = 1}
             else
              if(21 < (_wd_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _we_=1}
           var _wf_=_we_?str:symbol(str,_bq_);
           return caml_special_val(_wf_)}
        case 6:return hex(0);
        case 7:
            ...
            {if(0 === pad$5[0])
              {var _v7_=pad$5[2],_v8_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_v8_,_v7_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_v8_,_v7_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_v8_,_v7_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _v9_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_v9_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_v9_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_v9_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _v__=type_format_gen(fmt$0,fmtty$0);
             if(typeof _v__[2] === "number")
              {var fmt=_v__[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_v6_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_v6_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _v3_=[8,acc,_bA_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_v3_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_v3_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_v2_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_v2_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_v0_,_vZ_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_v0_,_vZ_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_v0_,_vZ_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _v1_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_v1_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_v1_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_v1_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function field(x,i)
     {var a=x[1 + i];
      return 1 - (typeof a === "number"?1:0)
              ?caml_obj_tag(a) === 252
                ?caml_call1(sprintf(_bD_),a)
                :caml_obj_tag(a) === 253?string_of_float(a):_bE_
              :caml_call1(sprintf(_bF_),a)}
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bG_;
      var _vV_=other_fields(x,i + 1 | 0),_vW_=field(x,i);
      return caml_call2(sprintf(_bH_),_vW_,_vV_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _vQ_=other_fields(e,2),
          _vR_=field(e,1),
          _vT_=caml_call2(sprintf(_bI_),_vR_,_vQ_);
        else
         switch(match)
          {case 0:var _vT_=_bJ_;break;
           case 1:var _vT_=_bK_;break;
           default:var _vS_=field(e,1),_vT_=caml_call1(sprintf(_bL_),_vS_)}
        return symbol(constructor,_vT_)}
      return e[1]}
    ...
    try
     ...
     {_vO_ = caml_wrap_exception(_vO_);
      ...
      try
       {var _i8_=caml_sys_getenv(_i7_),_bT_=_i8_}
      catch(_vP_)
       {_vP_ = caml_wrap_exception(_vP_);
        if(_vP_ !== Not_found)throw _vP_;
        var _bT_=_bS_}
      var params=_bT_}
    var
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _vM_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_vM_;continue}
           var accu=[0,_bR_],_vI_=54 + max(55,l) | 0,_vH_=0;
           if(! (_vI_ < 0))
            {var i=_vH_;
             for(;;)
              {var
               ...
               var
                _vJ_=accu[1],
                _vD_=caml_string_get(_vJ_,3) << 24,
                _vE_=caml_string_get(_vJ_,2) << 16,
                _vF_=caml_string_get(_vJ_,1) << 8,
                _vG_=
                 ((caml_string_get(_vJ_,0) + _vF_ | 0) + _vE_ | 0)
                 +
                 _vD_
                 |
                 0,
                _vK_=
                 (caml_check_bound(result[1],j)[1 + j] ^ _vG_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[1 + j] = _vK_;
               var _vL_=i + 1 | 0;
               if(_vI_ !== i){var i=_vL_;continue}
               break}}
           result[2] = 0;
           return result}}];
    ...
    function find$0(h,key)
     {var _vC_=indexfun(h,key),match=caml_check_bound(h[2],_vC_)[1 + _vC_];
      if(match)
    ...
    function f$0(s)
     {var accu=[0,0],_vz_=caml_ml_string_length(s) - 1 | 0,_vy_=0;
      if(! (_vz_ < 0))
       {var i=_vy_;
        for(;;)
         {var _vA_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _vA_ | 0;
          var _vB_=i + 1 | 0;
          if(_vz_ !== i){var i=_vB_;continue}
          break}}
      accu[1] = accu[1] & 2147483647;
      var tag=1073741823 < accu[1]?accu[1] + 2147483648 | 0:accu[1];
      return tag}
    function compare(x,y){return caml_string_compare(x,y)}
    var Vars=_E_([0,compare]);
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _vs_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _vs_;
      var _vu_=len - 1 | 0,_vt_=0;
      if(! (_vu_ < 0))
       {var i=_vt_;
        for(;;)
         {var
           _vw_=(i * 2 | 0) + 3 | 0,
           _vv_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_vw_)[1 + _vw_] = _vv_;
          var _vx_=i + 1 | 0;
          if(_vu_ !== i){var i=_vx_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_vp_=len < new_size?1:0;
      if(_vp_)
       {var a2=caml_make_vect(new_size,dummy_met),_vq_=array[2],switch$0=0;
        if
         (0
          <=
          len
          &&
          !
          ((_vq_.length - 1 - len | 0) < 0)
          &&
          !
          ((a2.length - 1 - len | 0) < 0))
         {caml_array_blit(_vq_,0,a2,0,len);switch$0 = 1}
    ...
    function get_method_label(table,name)
     {try
       {var _vn_=caml_call2(Meths[28],name,table[3]);return _vn_}
      catch(_vo_)
       {_vo_ = caml_wrap_exception(_vo_);
        if(_vo_ === Not_found)
     ...
     {var x=16;
      for(;;)
       {if(! (17 <= x) && ! (max_array_length < (x * 2 | 0)))
        ...
        if(random)
         {var
           _uP_=caml_obj_tag(prng),
           _uQ_=250 === _uP_?prng[1]:246 === _uP_?force_lazy_block(prng):prng;
          _uQ_[2] = (_uQ_[2] + 1 | 0) % 55 | 0;
          var
           _uK_=_uQ_[2],
           curval=caml_check_bound(_uQ_[1],_uK_)[1 + _uK_],
           _uL_=(_uQ_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_uQ_[1],_uL_)[1 + _uL_]
            +
           ...
           _uM_=_uQ_[2];
          caml_check_bound(_uQ_[1],_uM_)[1 + _uM_] = newval30;
          var seed=newval30}
        else
         var seed=0;
         ...
         {if(param)
             ...
             {var
              ...
              if(nsize < max_array_length)
               {var
                 ...
                 _uN_=kwd_table.length - 1 < 4?1:0,
                 _uO_=_uN_ || (kwd_table[4] < 0?1:0),
                 inplace=1 - _uO_;
                kwd_table[2] = ndata;
                var _uS_=osize - 1 | 0,_uR_=0;
                if(! (_uS_ < 0))
                 {var i$0=_uR_;
                  a:
                  for(;;)
                    ...
                    for(;;)
                     {if(cell)
                       {var
                        ...
                        continue}
                      var _uW_=i$0 + 1 | 0;
                      if(_uS_ !== i$0){var i$0=_uW_;continue a}
                      break}
                    break}}
                if(inplace)
                 {var _uU_=nsize - 1 | 0,_uT_=0;
                  if(! (_uU_ < 0))
                   {var i=_uT_;
                    for(;;)
          ...
          var
           ident_or_keyword=
            function(id)
             {try
               {var _vl_=find$0(kwd_table,id);return _vl_}
              catch(_vm_)
               {_vm_ = caml_wrap_exception(_vm_);
                if(_vm_ === Not_found)return [1,id];
                throw _vm_}},
           keyword_or_error=
            function(c)
             {var s=make$0(1,c);
              try
               {var _vj_=find$0(kwd_table,s);return _vj_}
              catch(_vk_)
               {_vk_ = caml_wrap_exception(_vk_);
                if(_vk_ === Not_found)throw [0,Error,symbol(_bU_,s)];
                throw _vk_}},
           comment=
            function(strm)
             {b:
                     ...
                     default:
                      ...
                      for(;;)
                       {var match$1=peek(strm);
                        if(match$1)
                         {var _vi_=match$1[1];
                          if(41 === _vi_){junk(strm);return 0}
                          if(42 === _vi_){junk(strm);continue}
                          junk(strm);
                          continue b}
                        throw Failure$0}}
                  junk(strm);
                ...
                if(58 <= _vf_)
                 ...
                 if(48 <= _vf_)
                  {junk(strm);
                   var match$0=peek(strm);
                   if(match$0)
                    {var _vg_=match$0[1],switcher$0=_vg_ - 48 | 0;
                     if(! (9 < switcher$0 >>> 0))
                      {junk(strm);
                       var match$1=peek(strm);
                       if(match$1)
                        {var _vh_=match$1[1],switcher$1=_vh_ - 48 | 0;
                         if(! (9 < switcher$1 >>> 0))
                          {junk(strm);
                           var
                            n=
                                ...
                                {junk(strm);
                                 try
                                  ...
                                  {_u6_ = caml_wrap_exception(_u6_);
                                   if(_u6_ === Failure$0)throw [0,Error,_bX_];
                                   throw _u6_;
                                   var _u3_=_u6_}
                                 store(c$0);
                                 continue}
                          ...
                          case 39:
                           ...
                           try
                              ...
                              {junk(strm);
                               try
                                ...
                                {_u5_ = caml_wrap_exception(_u5_);
                                 if(_u5_ === Failure$0)throw [0,Error,_bY_];
                                 throw _u5_}
                               var c=_u2_}
                             else
                            ...
                            {_u4_ = caml_wrap_exception(_u4_);
                             if(_u4_ === Failure$0)throw [0,Error,_bV_];
                             throw _u4_}
                           var match$0=peek(strm);
    ...
    function pp_expr(param)
     {switch(param[0])
       {case 0:var v=param[1];return pp_var(v);
        ...
        case 2:
         var e2=param[2],e1=param[1],_uH_=symbol(_cb_,pp_expr(e2));
         return parens(symbol(pp_expr(e1),_uH_));
        case 3:
         var e2$0=param[2],e1$0=param[1],_uI_=symbol(_cc_,pp_expr(e2$0));
         return parens(symbol(pp_expr(e1$0),_uI_));
        case 4:
        ...
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _uJ_=symbol(_ce_,caml_string_of_jsbytes("" + e2$2));
         return parens(symbol(pp_expr(e1$2),_uJ_));
    ...
    function pp_acall(param)
     {var el=param[2],f=param[1];
      ...
      var _uG_=symbol(_ci_,symbol(concat(_ch_,map(pp_expr,el)),_cg_));
      return symbol(pp_func(f),_uG_)}
    function pp_pred(param)
     {var e2=param[3],o=param[2],e1=param[1],_uD_=symbol(_cj_,pp_expr(e2));
      switch(o)
       {case 0:var _uE_=_b6_;break;
        case 1:var _uE_=_b7_;break;
        case 2:var _uE_=_b8_;break;
        case 3:var _uE_=_b9_;break;
        default:var _uE_=_b__}
      var _uF_=symbol(_ck_,symbol(_uE_,_uD_));
      return symbol(pp_expr(e1),_uF_)}
    function pp_eqn(param)
     {var
       ...
       _uy_=
        symbol(_cr_,symbol(_cq_,symbol(concat(_cp_,map(pp_acall,cl)),_ux_))),
       _uz_=pp_expr(e),
       _uA_=
        to_nat
         ?function(x){return symbol(_cs_,parens(x))}
         :function(x){return x},
       _uB_=symbol(_ct_,symbol(_uA_(_uz_),_uy_)),
       vl=call[2],
       f=call[1];
      if(0 === vl)
       var _uC_=pp_func(f);
       ...
       var
        _uw_=symbol(_b5_,symbol(concat(_b4_,map(pp_var,vl)),_b3_)),
        _uC_=symbol(pp_func(f),_uw_);
      return symbol(_cu_,symbol(_uC_,_uB_))}
    ...
    function eq_tag(t1,t2)
     {switch(t1)
       {case 0:if(! t2)return _cx_;break;
    ...
    function expr_list_map(o,tl,match)
     {if(tl)
       {var
         ...
         tl$0=tl[2],
         t=tl[1],
         _uv_=expr_list_map(o,tl$0,el);
        return [0,caml_call3(caml_get_public_method(o,102,160),o,t,e),_uv_]}
      return 0}
    ...
    function pp_tag_list(param)
     {if(param)
       {var tl=param[2],x=param[1],_uu_=pp_tag_list(tl);
        return [0,pp_tag(x),_uu_]}
      return 0}
    function pp_decl(param)
     {var s=param[2],t=param[1],_ut_=symbol(_cH_,s);
      return symbol(pp_tag(t),_ut_)}
    function pp_var_list(param)
     {if(param)
       {var tl=param[2],v=param[1],_us_=pp_var_list(tl);
        return [0,pp_decl(v),_us_]}
      return 0}
        ...
        {case 0:var v=param[1];return v[2];
         ...
         case 2:
          var
           e2=param[2],
           e1=param[1],
           _uj_=symbol(_cP_,symbol(pp_expr$0(tag,e2),_cO_));
          return symbol(_cQ_,symbol(pp_expr$0(tag,e1),_uj_));
         case 3:
          var
           e2$0=param[2],
           e1$0=param[1],
           _uk_=symbol(_cS_,symbol(pp_expr$0(tag,e2$0),_cR_));
          return symbol(_cT_,symbol(pp_expr$0(tag,e1$0),_uk_));
         case 4:
          var
           e=param[2],
           c=param[1],
           _ul_=symbol(_cV_,symbol(pp_expr$0(tag,e),_cU_));
          return symbol(_cW_,symbol(pp_expr$0(tag,c),_ul_));
         case 5:
          var
           e$0=param[2],
           c$0=param[1],
           _um_=symbol(_cY_,symbol(pp_expr$0(tag,e$0),_cX_));
          return symbol(_cZ_,symbol(pp_expr$0(tag,c$0),_um_));
         case 6:var e$1=param[1];return symbol(_c0_,pp_expr$0(tag,e$1));
         case 7:
          var
           e2$1=param[2],
           e1$1=param[1],
           _un_=symbol(_c2_,symbol(pp_expr$0(1,e2$1),_c1_));
          return symbol(_c3_,symbol(pp_expr$0(1,e1$1),_un_));
         case 8:
          var
           e2$2=param[2],
           e1$2=param[1],
           _uo_=symbol(_c5_,symbol(pp_expr$0(1,e2$2),_c4_));
          return symbol(_c6_,symbol(pp_expr$0(1,e1$2),_uo_));
         case 9:
          var
           e2$3=param[3],
           e1$3=param[2],
           tag$0=param[1],
           _up_=symbol(_c8_,symbol(pp_expr$0(tag$0,e2$3),_c7_));
          return symbol(_c9_,symbol(pp_expr$0(tag$0,e1$3),_up_));
         case 10:
          var
           g2=param[2],
           g1=param[1],
           _uq_=symbol(_c$_,symbol(pp_expr$0(tag,g2),_c__));
          return symbol(_da_,symbol(pp_expr$0(tag,g1),_uq_));
         case 11:
          var
           g2$0=param[2],
           g1$0=param[1],
           _ur_=symbol(_dc_,symbol(pp_expr$0(tag,g2$0),_db_));
          return symbol(_dd_,symbol(pp_expr$0(tag,g1$0),_ur_));
    ...
    function pp_expr_list(tg,match)
     {if(tg)
       {var
         ...
         tagl=tg[2],
         tag=tg[1],
         _ui_=pp_expr_list(tagl,tl);
        return [0,pp_expr$0(tag,v),_ui_]}
      return 0}
    function pp_meth(opt,param)
     {var id=param[3],tags=param[2],rtag=param[1];
      if(opt)var sth=opt[1],verbose=sth;else var verbose=0;
      if(verbose)
       {var _uh_=symbol(_dh_,symbol(pp_tag(rtag),_dg_));
        return symbol
                (id,symbol(_dj_,symbol(concat(_di_,pp_tag_list(tags)),_uh_)))}
      return id}
    function pp_rhs(tag,param)
     {if(0 === param[0]){var e=param[1];return pp_expr$0(tag,e)}
      var
       ...
       meth=param[2],
       addr=param[1],
       _ud_=symbol(_dp_,symbol(concat(_do_,pp_expr_list(meth[2],exprl)),_dn_));
      if(value)
       var v=value[1],_ue_=symbol(_dr_,symbol(pp_expr$0(1,v),_dq_));
      else
       var _ue_=_dt_;
      var
       _uf_=symbol(_ue_,_ud_),
       _ug_=symbol(_ds_,symbol(pp_meth(0,meth),_uf_));
      return symbol(pp_expr$0(3,addr),_ug_)}
    function pp_stm(indent,opt,tag,stm)
     {if(opt)var sth=opt[1],breakline=sth;else var breakline=1;
      var switch$0=0;
      if(typeof stm === "number" && ! stm)var _t1_=_dL_;else switch$0 = 1;
      if(switch$0)var _t1_=breakline?_du_:_dK_;
      if(typeof stm === "number")
       switch(stm)
        {case 0:var _t2_=_dv_;break;
         case 1:var _t2_=_dx_;break;
         default:var _t2_=_dy_}
      else
       switch(stm[0])
        {case 0:
          var e=stm[1],_t2_=symbol(_dA_,symbol(pp_rhs(tag,e),_dz_));break;
         case 1:
          var
           stm$0=stm[3],
           rhs=stm[2],
           lhs=stm[1],
           switch$1=0,
           _t5_=pp_stm(indent,_dB_,tag,stm$0);
          if(typeof stm$0 === "number" && ! stm$0){var _t6_=_dE_;switch$1 = 1}
          if(! switch$1)var _t6_=_dC_;
          var
           _t7_=symbol(_dD_,symbol(_t6_,_t5_)),
           _t8_=symbol(pp_rhs(tag_of_lhs(lhs),rhs),_t7_);
          if(typeof lhs === "number")
           var _t9_=_dk_;
          else
           if(0 === lhs[0])
            var f=lhs[1],_t9_=symbol(f[2],_dl_);
           else
            var v=lhs[1],_t9_=symbol(v[2],_dm_);
          var _t2_=symbol(_t9_,_t8_);
          break;
         default:
          var
           stm3=stm[4],
           ...
           stm1=stm[2],
           c=stm[1],
           _t__=symbol(_dG_,pp_stm(indent,_dF_,tag,stm3)),
           _t$_=symbol(mk_indent(indent),_t__),
           _ua_=symbol(_dH_,symbol(pp_stm(indent + 1 | 0,0,tag,stm2),_t$_)),
           _ub_=symbol(mk_indent(indent),_ua_),
           _uc_=symbol(_dI_,symbol(pp_stm(indent + 1 | 0,0,tag,stm1),_ub_)),
           _t2_=symbol(_dJ_,symbol(pp_expr$0(2,c),_uc_))}
      var switch$2=0,_t3_=symbol(_t2_,_t1_);
      if(typeof stm === "number" && ! stm){var _t4_=_dw_;switch$2 = 1}
      if(! switch$2)var _t4_=mk_indent(indent);
      return symbol(_t4_,_t3_)}
    function pp_block(indent,payable,tag,param)
     {var
       stm=param[3],
       lvl=param[2],
       vl=param[1],
       _tS_=symbol(mk_indent(indent),_dM_),
          ...
          symbol
           (concat
             (_dO_,
              map
               (function(s)
                 {var _t0_=symbol(s,_dN_);
                  return symbol(mk_indent(indent + 1 | 0),_t0_)},
                _tU_)),
            _tT_)),
       _tW_=payable?_dQ_:_dX_,
       _tX_=symbol(_tW_,_tV_),
       _tY_=tag?symbol(_dS_,symbol(pp_tag(tag),_dR_)):_dW_,
       _tZ_=symbol(_dT_,symbol(_tY_,_tX_));
      return symbol(_dV_,symbol(concat(_dU_,pp_var_list(vl)),_tZ_))}
    function pp_a_contract(param)
     {var
      ...
      if(fallback)
       var
        b=fallback[1],
        _tL_=symbol(_d1_,pp_block(indent,1,0,b)),
        _tM_=symbol(mk_indent(indent),_tL_);
      else
       var _tM_=_d2_;
      var
       _tN_=symbol(_tM_,_d3_),
       indent$0=1,
       _tO_=
        symbol
         (_d4_,
              ...
              map
               (function(param)
                 {var
                   ...
                   b=param[2],
                   m=param[1],
                   _tQ_=symbol(_dY_,pp_block(indent$0,payable,m[1],b)),
                   _tR_=symbol(_dZ_,symbol(pp_meth(0,m),_tQ_));
                  return symbol(mk_indent(indent$0),_tR_)},
                methods)),
            _tN_)),
       indent$1=1;
      return symbol
                   ...
                   symbol
                    (concat
                      (_cK_,
                       map
                        (function(f$0)
                          {var f=f$0[1],_tP_=symbol(pp_decl(f),_cJ_);
                           return symbol(mk_indent(indent$1),_tP_)},
                         fields)),
                     _tO_))))}
    ...
    function best(err1,err2)
     {if(caml_string_equal(err1[1],_d$_))return err2;
      ...
      if(length(err1[2]) === _tI_)
       {var _tJ_=err1[2],_tK_=symbol(_eb_,err2[1]);
    ...
    function kwd(str)
     {function _tz_(_tD_){return 0}
      var _tA_=[0,str];
      return function(_tB_,_tC_){return const$0(_tA_,_tz_,_tB_,_tC_)}}
    function option(p,s,tbl)
     {try
       {var
         ...
         res=match[2],
         next=match[1],
         _ty_=[0,next,[0,res],error$0,ntbl];
        return _ty_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
    ...
    function choice(p1,p2,s,tbl)
     {try
       {var _tw_=caml_call2(p1,s,tbl);return _tw_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         {var error1=exn[2];
          try
           {var _tv_=caml_call2(p2,s,tbl);return _tv_}
          catch(exn)
           {exn = caml_wrap_exception(exn);
            if(exn[1] === Fail)
    ...
    function choice_list(param)
     {if(param)
       {var _tr_=param[1];
        if(param[2])
         {var tl=param[2],_ts_=choice_list(tl);
          return function(_tt_,_tu_){return choice(_tr_,_ts_,_tt_,_tu_)}}
        return _tr_}
    ...
    function remove_local_vars(tbl)
     {return caml_call1
              (find_all
                (function(param)
                  {if(1 === param[0] && param[2])return 0;return 1}),
               tbl)}
    function plus(e1,e2)
     {if(1 === e1[1] && 1 === e2[1])
                     ...
                     if(match)
                      {var
                       ...
                       if(eq_tag(tagfield,tag))
                        {var
                          _sT_=
                           islocal?[0,[0,tagfield,name]]:[1,[0,tagfield,name]];
                         return _sT_}
     ...
     {var
       ...
       _on_=
        [0,
         function(s,t)
          {if(rettag)
            {if(tag)throw [0,Fail,[0,_f__,s]];return [0,s,1,[0,_f$_,s],t]}
           return [0,s,0,[0,_ga_,s],t]},
         _om_],
       _oo_=kwd(_ge_);
      ...
      function _og_(rhs,param)
       {if(rhs){var rhs$0=rhs[1];return [0,rhs$0]}
        if(tag)throw [0,Reject,symbol(_gb_,pp_tag(tag))];
        return 1}
    ...
    function _gA_(param)
     {var _nc_=param[1];if(param[2])return _nc_;throw [0,Assert_failure,_gB_]}
    var _gC_=0,_gD_=0;
    ...
    function string_of_meth(addr,m)
     {var _mb_=concat(_hN_,pp_tag_list(m[2]));
    ...
    function int_of_bool(param){return param?_hO_:_hP_}
    function assign_gamma(k,v,param)
     {if(param)
       {var p=param[1],tl=param[2],k$0=p[1];
        if(caml_equal(k,k$0))return [0,[0,k,v],tl];
        var tl$0=param[2];
        return [0,p,assign_gamma(k,v,tl$0)]}
    ...
    function lookup_gamma(k,gamma)
     {try
       ...
       {_l7_ = caml_wrap_exception(_l7_);
        if(_l7_ === Not_found){error(k);throw [0,Assert_failure,_hR_]}
        throw _l7_}}
       ...
       {_l4_ = caml_wrap_exception(_l4_);
        if(_l4_ === Not_found)
         {error(symbol(_hU_,v));
          ...
          var _l1_=status[7];
          error
           (symbol(_hX_,concat(_hW_,map(function(_l5_){return _l5_[1]},_l1_))));
     ...
     {if(0 === public_methods)
       ...
       {var l=public_methods.length - 1;
        ...
        var
         ...
         _lD_=public_methods.length - 1 - 1 | 0,
         _lC_=0;
        if(! (_lD_ < 0))
         {var i$0=_lC_;
          for(;;)
           {var met=public_methods[1 + i$0],lab=(i$0 * 2 | 0) + 2 | 0;
            ...
            var _lE_=i$0 + 1 | 0;
            if(_lD_ !== i$0){var i$0=_lE_;continue}
            break}}
        var _lF_=table}
      var label=get_method_label(_lF_,_h1_);
      function element(self_1)
       {return function(_lG_,_lH_){return type_of_expr(status,_lG_,_lH_)}}
      method_count[1]++;
      if(caml_call2(Labs[28],label,_lF_[4]))
       {resize$0(_lF_,label + 1 | 0);
        caml_check_bound(_lF_[2],label)[1 + label] = element}
      else
       _lF_[6] = [0,[0,label,element],_lF_[6]];
      inst_var_count[1] = (inst_var_count[1] + _lF_[1] | 0) - 1 | 0;
      _lF_[8] = rev(_lF_[8]);
      resize$0
       (_lF_,3 + ((caml_check_bound(_lF_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
      var obj=caml_obj_block(248,_lF_[1]);
      obj[1] = _lF_[2];
      return caml_set_oo_id(obj)}
    function type_of_call0(status,addr,meth,value,sender,params)
     {var _ls_=tag_list_length(meth[2]);
      if(length(params) === _ls_)
       {var
          ...
          function(i)
           {if(status[4] < i)return 0;
            ...
            return [0,
                    ...
                    _ly_]},
         stack$0=aux(1),
         _lt_=op([0,sender,[0,value,params]],stack$0),
         _lu_=status[2],
         _lv_=op(map(function(_lx_){return lookup(status,_lx_)},_lu_),_lt_),
         _lw_=status[1],
         args=op(map(function(v){return [1,v]},_lw_),_lv_);
        return [1,name,args]}
    ...
    function match_method(status,addr,meth,params)
     {try
       ...
       {_lr_ = caml_wrap_exception(_lr_);
        if(_lr_ === Not_found)throw [0,Assert_failure,_h3_];
        throw _lr_}
       ...
       {var meths$0=meths;
        for(;;)
         {if(meths$0)
          ...
          throw Not_found}}
      try
       {var _ln_=[0,aux(meth,params,meths)];return _ln_}
      catch(_lo_)
       {_lo_ = caml_wrap_exception(_lo_);
        if(_lo_ === Not_found)
         try
          {var _lm_=[0,aux(fallback,0,meths)];return _lm_}
         catch(_lp_)
          {_lp_ = caml_wrap_exception(_lp_);
           if(_lp_ === Not_found)return 0;
           throw _lp_}
        throw _lo_}}
    function transfer(status$1,to,amount,k)
     {var
       ...
       _ll_=revert(status$1),
       _lj_=[3,lookup(status$1,symbol$0(from,balance)),amount],
       status=assign(symbol$0(from,balance),_lj_,status$1),
       _lk_=[2,lookup(status,symbol$0(to,balance)),amount],
       status$0=assign(symbol$0(to,balance),_lk_,status);
      return if_then_else
              ([4,[1,amount,_h4_],[1,from_balance,amount]],
    ...
    function msg_transfer(status,a1,val1,args1,k)
     {var to=type_of_address(status,a1);
      ...
      if(0 === val1)error(symbol(_h5_,to));
      return revert(status)}
     ...
     {var
      ...
      if(match)
       {var
         ...
         payable=match$0[2],
         meth$0=match$0[1],
         _lf_=0 !== eq_tag(tag,0)?1:0,
         output_type_ok=_lf_ || (0 !== eq_tag(tag,meth$0[1])?1:0),
         payable_ok=payable || (0 === value?1:0);
        if(output_type_ok && payable_ok)
         {var
           amount=
            fold(_h0_,function(_li_){return type_of_iexpr(status,_li_)},value),
           _lg_=meth$0[2],
           params$1=expr_list_map(type_of_expr_poly(status),_lg_,params$0);
                               ...
                               (status,
                                ...
                                function(_lh_)
                                 {return type_of_call0
                                          (_lh_,addr$0,meth$0,amount,sender,params)})})}
        return revert(status)}
      return revert(status)}
     ...
     {function aux(guard,param)
       {if(param)
         {var
           ...
           typ=match[2],
           g=match[1],
           _le_=caml_equal(guard,_h6_)?g:[5,guard,g];
          return [0,[0,g,typ],aux(_le_,tl)]}
        return 0}
        ...
        for(;;)
         {if(acc)
           {var _lc_=acc[1];
            if(l)
             {var tl=l[2],hd2=l[1];
              if(caml_equal(_lc_[2],hd2[2]))
               {var acc$0=[0,[0,[5,_lc_[1],hd2[1]],_lc_[2]]],acc=acc$0,l=tl;
                continue}
             ...
             {var _kN_=_kM_[2];
              if
               (_kN_
                ...
                &&
                !
                caml_string_notequal(_kM_[3],_h__))
               {var args1$0=_kK_[4],val1$0=_kK_[3];
                return msg_transfer
                        (status$0,
                         ...
                         val1$0,
                         args1$0,
                         function(_lb_){return type_of_cont(_lb_,int_of_unit)})}}
            var
             args1=_kK_[4],
             val1=_kK_[3],
             m1=_kK_[2],
             sender=int_of_address(status$0[6]);
            return type_of_call(status$0,tag,_kL_,m1,val1,sender,args1);
           case 1:
            ...
            if(typeof _kO_ === "number")
             {var _kQ_=stm$0[2],_kR_=_kQ_[2];
              if(! _kR_[1])
               {var _k0_=_kR_[2];
                if(_k0_ && 1 === _k0_[1] && ! _k0_[2])
                 {var _k1_=_kQ_[1];
                  if(! caml_string_notequal(_kR_[3],_h$_))
                   {var stm$2=stm$0[3],args1$1=_kQ_[4],val1$1=_kQ_[3];
                    return msg_transfer
                            (status$0,
                             ...
                             val1$1,
                             args1$1,
                             function(_la_){return type_of_stm(_la_,tag,stm$2)})}}}}
                              ...
                              lookup
                               (status$0,
                                symbol$0
                                 (stack,
                                  caml_string_of_jsbytes
                                   ("" + ((status$0[4] - (2 * status$0[5] | 0) | 0) + 1 | 0)))),
                              bottom],
                             ...
                             var
                              status=
                               [0,
                                ...
                                status$0[6],
                                status$0[7]];
                             if(status[4] === status[5])return revert(status);
                             var _k$_=revert(status);
                             return if_then_else
                                     (stack_not_full,
                                      type_of_call
                                       (status,tag_of_lhs(_kO_),_kY_,_kX_,_kW_,sender$0,_kV_),
                                      _k$_)}})}}
            break;
           default:
            var _k2_=stm$0[4];
    ...
    function type_of(max_args,max_stack,cfg)
     {var
      ...
      if(0 === max_stack)
       var k$0=0,frame_size$0=0;
      else
       var k$0=k,frame_size$0=frame_size;
      var
       _j$_=0,
       fields=
        rev
     ...
     {switch(param[0])
       {case 0:var n=param[1];return [1,n];
        ...
        case 4:
         ...
         throw NotLinear;
        case 5:
         var _j__=param[2],_j9_=param[1];
         if(0 === _j__[0]){var n$1=_j__[1];return [5,compute_expr(_j9_),n$1]}
         throw NotLinear;
    ...
    function atomic_neg(param)
     {var e2=param[3],p=param[2],e1=param[1];
      switch(p)
       {case 0:var _j5_=_ic_;break;
        case 1:var _j5_=_id_;break;
        case 2:var _j5_=_ie_;break;
        case 3:var _j5_=_if_;break;
        default:var _j5_=_ig_}
               ...
               {var _jY_=_jX_[2];
                if
                 (_jY_
                  ...
                  &&
                  !
                  caml_string_notequal(_jX_[3],_ip_))
                 {var
                   stm$0=stm[3],
               ...
               {var _jF_=_jD_[2];
                if
                 (_jF_
                  ...
                  &&
                  !
                  caml_string_notequal(_jD_[3],_it_))
    ...
    function _iN_(m,param)
     {var
      ...
      return max(m,max(fold_left(_iL_,_iK_,methods),_jy_))}
    function maxargs(_jx_){return fold_left(_iN_,_iM_,_jx_)}
     ...
     {var match$0=get_bounds(cfg);
      if(0 === match$0[0])
       var
        ...
        _jt_=0,
        max_stack=
         fold_left(function(m,param){var n=param[2];return max(m,n)},_jt_,l$0),
        res=caml_call3(f,l$0,maxargs(cfg),max_stack);
      else
       {var l$1=match$0[1];
        if(! l$1)throw [0,Assert_failure,_iF_];
        var
         l=l$1[2],
         _jq_=l$1[1][1],
         match=_jq_[2],
         m=match[1],
         a=_jq_[1],
         _jr_=symbol(_iw_,symbol(a,symbol(_iv_,symbol(pp_meth(0,m),_iu_)))),
         _js_=rev(l),
         res=
          symbol
           (_iE_,
             ...
             (fold_left
               (function(acc,param)
                 {var
                   ...
                   m=match[1],
                   a=_ju_[1],
                   _jv_=is_tail?_iz_:_iD_,
                   _jw_=symbol(_iA_,symbol(_jv_,_iy_));
                  return symbol
                          (acc,
                           symbol
                            (_iC_,symbol(a,symbol(_iB_,symbol(pp_meth(0,m),_jw_)))))},
                _ix_,
                _js_),
              _jr_))}
      var match$1=get_bounds(cfg);
      return 0 === match$1[0]
              ?res
              :symbol(res,symbol(_iO_,caml_call3(f,0,maxargs(cfg),1)))}
    var t2=window$0.document;
    set_error
     (function(msg)
       {var errors=t2.getElementById("errors");
        if(errors == no_handler)throw [0,Assert_failure,_iP_];
        var t3=caml_jsstring_of_string(msg);
        appendChild(errors,t2.createTextNode(t3));
        return appendChild(errors,t2.createElement("br"))});
                         ...
                         (fold_left
                           (function(acc,param)
                             {var
                               ...
                               m=match[1],
                               a=_jk_[1],
                               _jl_=symbol(_iH_,caml_string_of_jsbytes("" + b));
                              return symbol
                                      (acc,
                                       symbol
                                        (_iJ_,symbol(a,symbol(_iI_,symbol(pp_meth(0,m),_jl_)))))},
                            _iG_,
                            bounds),
                          _jj_)},
               c$0)}
        ...
        return with_maxargs_and_stack_bound
                (function(param$0,max_args,max_stack)
                  {var
                    ...
                    _jc_=map(function(v){return [0,[0,v],0,_ij_]},non_negatives),
                    _jd_=0,
                    l$0=
                     [0,
                      [0,
