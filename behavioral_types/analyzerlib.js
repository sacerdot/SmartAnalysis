...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _h9_=caml_string_of_jsbytes(" : "),
     _h__=caml_string_of_jsbytes("# "),
     _ia_=caml_string_of_jsbytes("transfer"),
     _h7_=[0,caml_string_of_jsbytes("typeInference.ml"),442,9],
     _h5_=[0,0],
     _h6_=[0,0],
     ...
     _is_=[0,caml_string_of_jsbytes("static.ml"),147,9],
     ...
     _iF_=[0,caml_string_of_jsbytes("static.ml"),171,10],
    ...
    function transfer(status$1,to,amount,k)
     {var
      ...
      return if_then_else([1,from_balance,amount],caml_call1(k,status$0),_li_)}
     ...
     {function aux(guard,param)
       {if(param)
         {var
           ...
           typ=match[2],
           g=match[1],
           _lb_=caml_equal(guard,_h5_)?g:[5,guard,g];
          return [0,[0,g,typ],aux(_lb_,tl)]}
        return 0}
      return [2,aux(_h6_,guards_and_typs)]}
       ...
       {if(typeof stm$0 === "number")
         ...
         switch(stm$0[0])
          {case 0:
             ...
             {var _kL_=_kJ_[2];
              if
               (_kL_
                ...
                &&
                !
                caml_string_notequal(_kJ_[3],_h$_))
            ...
            var args1=_kI_[4],val1=_kI_[3];
            error(symbol(_h8_,pp_stm(0,0,tag,stm$0)));
            var
             sender=int_of_address(status$0[6]),
             res=type_of_call(status$0,tag,_kK_,_kJ_,val1,sender,args1),
             _kM_=symbol(_h9_,pp_typ(0,res));
            error(symbol(_h__,symbol(pp_stm(0,0,tag,stm$0),_kM_)));
            return res;
           case 1:
            ...
            function(param)
             {var
              ...
              if(typeof _jQ_ === "number")
               ...
               if(0 === _jQ_[0])
                var v=_jQ_[1],_jZ_=[0,[0,_jQ_],[0,v[1],[0,v]]];
               else
             ...
             if(0 === _jS_[0])
              {var _jU_=_jS_[1];
               if(typeof _jU_ !== "number" && 0 === _jU_[0])
                {var v=_jU_[1],match$0=eq_tag(_jT_[1],v[1]);
                 if(match$0 && caml_string_equal(_jT_[2],v[2]))
                  return [0,meths,[0,rhs]];
                 return make_cont(0)}}}
          return make_cont(0);
         case 2:
          var
           ...
           _jY_=[2,g,retype_stm(stm1$0),_jX_,2];
          return [0,op(meths1,meths2),_jY_]
         }
      return [0,0,stm]}
