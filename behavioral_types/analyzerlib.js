...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _i7_=caml_string_of_jsbytes("OCAMLRUNPARAM"),
     _i5_=caml_string_of_jsbytes("CAMLRUNPARAM"),
     ...
     _hY_=[0,1],
     _h9_=caml_string_of_jsbytes("transfer"),
     _h__=caml_string_of_jsbytes("transfer"),
     _h8_=[0,caml_string_of_jsbytes("typeInference.ml"),445,9],
     _h$_=caml_string_of_jsbytes(" encoded as "),
     _h6_=[0,0],
     _h7_=[0,0],
     _h5_=[0,0],
     ...
     _ii_=[1,0],
     _ij_=[1,0],
     _ik_=caml_string_of_jsbytes("main__"),
     _ih_=[0,caml_string_of_jsbytes("costEquationsGeneration.ml"),117,11],
     _ib_=[0,3,0],
     _ic_=[0,4,0],
     _id_=[0,3,[0,4,0]],
     _ie_=[0,0,0],
     _if_=[0,1,0],
     _ia_=caml_string_of_jsbytes("CostEquationsGeneration.NotLinear"),
     _il_=[0,0,[0,1,[13,0]]],
     _im_=caml_string_of_jsbytes("_ret_"),
     ...
     _ix_=caml_string_of_jsbytes("by"),
     _iy_=caml_string_of_jsbytes("in tail position "),
     _iC_=caml_string_of_jsbytes(""),
     _iz_=caml_string_of_jsbytes(" possibly called "),
     ...
     _iT_=caml_string_of_jsbytes("\n"),
     _iU_=caml_string_of_jsbytes("Maximum number of locals: "),
     _iV_=caml_string_of_jsbytes("\n\n"),
     _iN_=[0,caml_string_of_jsbytes("analyzer.ml"),7,85],
     _iZ_=caml_string_of_jsbytes("ms_parse"),
     _i0_=caml_string_of_jsbytes("ms_normalize"),
     _i1_=caml_string_of_jsbytes("ms_get_bounds"),
     _i2_=caml_string_of_jsbytes("ms_type_of"),
     _i3_=caml_string_of_jsbytes("ms_cost"),
     _i4_=caml_string_of_jsbytes("ms_copy_output_to_input");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_yS_ = caml_wrap_exception(_yS_);
              if(_yS_[1] !== Sys_error)throw _yS_;
              var _yR_=_yS_}
            var param$0=l;
            continue}
          return 0}}
     ...
     {var switch$0=0;
      if
       ...
       {var r=caml_create_bytes(len);
        ...
        var _yQ_=r;
        switch$0 = 1}
      if(! switch$0)var _yQ_=invalid_arg(_p_);
      return caml_string_of_bytes(_yQ_)}
    ...
    function concat(sep,l)
     {if(l)
       {var seplen=caml_ml_string_length(sep),acc=0,param=l,pos$1=0;
        for(;;)
         {if(param)
           {var _yL_=param[2],_yM_=param[1];
            if(_yL_)
             {var
               x=(caml_ml_string_length(_yM_) + seplen | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_s_),
               acc=acc$0,
               param=_yL_;
              continue}
            var _yP_=caml_ml_string_length(_yM_) + acc | 0}
          else
           var _yP_=acc;
          var dst=caml_create_bytes(_yP_),pos=pos$1,param$0=l;
          for(;;)
           {if(param$0)
             {var _yN_=param$0[2],_yO_=param$0[1];
              if(_yN_)
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _yJ_=1;return _yJ_}
       catch(_yK_)
    ...
    function _E_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_yI_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_yD_=height(lr);
            if(_yD_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _yE_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_yE_)}
            return invalid_arg(_w_)}
          return invalid_arg(_x_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_yF_=height(rl);
            if(_yF_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _yG_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_yG_)}
            return invalid_arg(_y_)}
          return invalid_arg(_z_)}
        var _yH_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_yH_]}
      var empty=0;
      ...
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _yu_=param$0[4],_yv_=param$0[3],_yw_=param$0[2];
            if(_yu_){var param$0=_yu_;continue}
            return [0,[0,_yw_,_yv_]]}
          return 0}}
         ...
         {var _yt_=param[1];
          if(_yt_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_yt_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_A_)}
      function _x8_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _yn_=caml_call2(p,v,d);
            if(_yn_)
             var _yo_=_yn_;
            else
             {var _yp_=exists(p,l);
              if(! _yp_){var param$0=r;continue}
              var _yo_=_yp_}
            return _yo_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _yj_=merge(f,r1,r2),
             _yk_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_yk_,_yj_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _yl_=merge(f,r1$0,r2$0),
           _ym_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_ym_,_yl_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _yh_=concat(lf,rf);return [0,join(lt,v,d,rt),_yh_]}
          var _yi_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_yi_]}
        return _D_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _ye_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_ye_)
               {var _yf_=caml_call2(cmp,d1,d2);
                if(_yf_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_yd_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _yd_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_yb_=cons_enum(t,rest);
          return [0,[0,k,v],function(_yc_){return seq_of_enum(_yb_,_yc_)}]}
        return 0}
      function to_seq(m)
       {var _x$_=cons_enum(m,0);
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _x9_=c;
          return function(_x__){return seq_of_enum(_x9_,_x__)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function fill_buff(b)
     {var len=caml_ml_bytes_length(b[2]),_x5_=b[2],switch$0=0,_x6_=b[1];
      if(0 <= len && ! ((caml_ml_bytes_length(_x5_) - len | 0) < 0))
       {var _x7_=caml_ml_input(_x6_,_x5_,0,len);switch$0 = 1}
      if(! switch$0)var _x7_=invalid_arg(_e_);
      b[3] = _x7_;
      b[4] = 0;
      return 0}
          ...
          {case 1:
           ...
           case 2:
            var
             f=d$0[1],
             _x1_=caml_obj_tag(f),
             d$1=250 === _x1_?f[1]:246 === _x1_?force_lazy_block(f):f,
             d$0=d$1;
            continue;
           case 3:
            var _x2_=d$0[1],_x3_=_x2_[1];
            if(_x3_)
             {var _x4_=_x3_[1];
              if(_x4_){var a$0=_x4_[1];_x2_[1] = 0;return [0,a$0,d$0]}
              return 0}
            var match$0=caml_call1(_x2_[2],count);
     ...
     {for(;;)
       {var _xW_=s[2];
        if(typeof _xW_ === "number")
         ...
         switch(_xW_[0])
          {case 0:var a=_xW_[1];return [0,a];
           case 1:
           ...
           case 2:
            var
             f=_xW_[1],
             _xX_=caml_obj_tag(f),
             _xY_=250 === _xX_?f[1]:246 === _xX_?force_lazy_block(f):f;
            s[2] = _xY_;
            continue;
           case 3:
            var _xZ_=_xW_[1],_x0_=_xZ_[1];
            if(_x0_){var a$1=_x0_[1];return a$1}
            var x=caml_call1(_xZ_[2],s[1]);
            _xZ_[1] = [0,x];
            return x;
           default:
            var b=_xW_[1];
        ...
        for(;;)
         {var _xU_=data[2];
          if(typeof _xU_ !== "number")
           switch(_xU_[0])
            {case 0:
              var d=_xU_[2];data[1] = data[1] + 1 | 0;data[2] = d;return 0;
             case 3:
              var _xV_=_xU_[1];
              if(_xV_[1]){data[1] = data[1] + 1 | 0;_xV_[1] = 0;return 0}
              break;
             case 4:
              var b=_xU_[1];
              if(b[3] <= b[4])fill_buff(b);
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         ...
         _xv_=function(param){return 0},
         _xw_=function(param){return 0};
        return [0,function(param){return 0},_xw_,_xv_,_xu_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _xx_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_xx_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _xy_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _xz_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _xA_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _xB_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _xC_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _xD_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _xE_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _xF_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _xG_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _xH_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _xI_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _xJ_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _xK_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _xL_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _xM_=function(param){caml_call1(de$12,0);return 0},
           _xN_=function(param){caml_call1(ed$12,0);return 0},
           _xO_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _xP_=function(param){caml_call1(de$13,0);return 0},
           _xQ_=function(param){caml_call1(ed$13,0);return 0},
           _xR_=function(param){caml_call1(af$13,0);return 0};
          return [0,
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_xb_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_xb_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_xc_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_xc_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_xd_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_xd_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_xe_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_xe_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_xf_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_xf_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_xg_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_xg_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_xh_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_xh_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_xi_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_xi_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_xj_=ty1[2],_xk_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_xl_=trans(_xj_,rest2$7);
              return [8,trans(_xk_,ty2),_xl_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_xm_=ty1[3],_xn_=ty1[2],_xo_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_xn_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_xo_,ty22,trans(_xm_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_xp_,rest2$9)]}
          throw [0,Assert_failure,_au_];
         case 11:
          var switch$11=0,_xq_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_xq_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_av_];
          break;
         case 12:
          var switch$12=0,_xr_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_xr_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_aw_];
          break;
         case 13:
          var switch$13=0,_xs_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_xs_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ax_];
          break;
         default:
          var switch$14=0,_xt_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_xt_,rest2$13)];
             default:switch$14 = 1}
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _xa_=match[2];
        if(typeof _xa_ !== "number" && 2 === _xa_[0])
         {var rest$0=_xa_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _wI_ !== "number" && 1 === _wI_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_wJ_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _wK_=type_padding(pad$0,fmtty),
           _wL_=_wK_[2],
           _wM_=_wK_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _wN_=type_padprec(pad$1,prec,fmtty),
           _wO_=_wN_[3],
           _wP_=_wN_[2],
           _wQ_=_wN_[1];
          if(typeof _wO_ !== "number" && 2 === _wO_[0])
           {var
             fmtty_rest$3=_wO_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_wQ_,_wP_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _wR_=type_padprec(pad$2,prec$0,fmtty),
           _wS_=_wR_[3],
           _wT_=_wR_[2],
           _wU_=_wR_[1];
          if(typeof _wS_ !== "number" && 3 === _wS_[0])
           {var
             fmtty_rest$4=_wS_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_wU_,_wT_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _wV_=type_padprec(pad$3,prec$1,fmtty),
           _wW_=_wV_[3],
           _wX_=_wV_[2],
           _wY_=_wV_[1];
          if(typeof _wW_ !== "number" && 4 === _wW_[0])
           {var
             ...
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_wY_,_wX_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _wZ_=type_padprec(pad$4,prec$2,fmtty),
           _w0_=_wZ_[3],
           _w1_=_wZ_[2],
           _w2_=_wZ_[1];
          if(typeof _w0_ !== "number" && 5 === _w0_[0])
           {var
             fmtty_rest$6=_w0_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_w2_,_w1_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _w3_=type_padprec(pad$5,prec$3,fmtty),
           _w4_=_w3_[3],
           _w5_=_w3_[2],
           _w6_=_w3_[1];
          if(typeof _w4_ !== "number" && 6 === _w4_[0])
           {var
             fmtty_rest$7=_w4_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_w6_,_w5_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _w7_=type_padding(pad$6,fmtty),
           _w8_=_w7_[2],
           _w9_=_w7_[1];
          if(typeof _w8_ !== "number" && 7 === _w8_[0])
           {var
             fmtty_rest$8=_w8_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_w9_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _w__=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_w__))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _w$_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$27=_w$_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_w$_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _wF_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_wF_))
             throw Type_mismatch;
            var _wG_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_wG_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _wE_=2 === padty$0?48:32,res=make(width$0,_wE_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _wC_ >>> 0)
           {if(33 < (_wC_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _wC_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _wv_=caml_ml_bytes_length(s$0) - 1 | 0,
           _wu_=0;
          if(! (_wv_ < 0))
           {var i$0=_wu_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _wz_=match - 34 | 0,switch$2=0;
                if(58 < _wz_ >>> 0)
                 {if(93 <= _wz_)switch$2 = 1}
                else
                 if(56 < (_wz_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _wA_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _wA_=4;break;case 1:var _wA_=2;break}
              n[1] = n[1] + _wA_ | 0;
              var _wB_=i$0 + 1 | 0;
              if(_wv_ !== i$0){var i$0=_wB_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _wx_=caml_ml_bytes_length(s$0) - 1 | 0,_ww_=0;
            if(! (_wx_ < 0))
             {var i=_ww_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _wD_=s}
          var str$0=caml_string_of_bytes(_wD_)}
         ...
         {var i$0=_wo_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _wt_=i$0 + 1 | 0;
            if(_wp_ !== i$0){var i$0=_wt_;continue}
            break}}
        var
         digits=n[1],
         buf=
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _wn_=_aB_;break;
        case 2:var _wn_=_aC_;break;
        case 4:var _wn_=_aE_;break;
        case 5:var _wn_=_aF_;break;
        case 6:var _wn_=_aG_;break;
        case 7:var _wn_=_aH_;break;
        case 8:var _wn_=_aI_;break;
        case 9:var _wn_=_aJ_;break;
        case 10:var _wn_=_aK_;break;
        case 11:var _wn_=_aL_;break;
        case 0:
        case 13:var _wn_=_aA_;break;
        case 3:
        case 14:var _wn_=_aD_;break;
        default:var _wn_=_aM_}
      return transform_int_alt(iconv,caml_format_int(_wn_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _wm_=_a1_;break;
        case 2:var _wm_=_a2_;break;
        case 4:var _wm_=_a4_;break;
        case 5:var _wm_=_a5_;break;
        case 6:var _wm_=_a6_;break;
        case 7:var _wm_=_a7_;break;
        case 8:var _wm_=_a8_;break;
        case 9:var _wm_=_a9_;break;
        case 10:var _wm_=_a__;break;
        case 11:var _wm_=_a$_;break;
        case 0:
        case 13:var _wm_=_a0_;break;
        case 3:
        case 14:var _wm_=_a3_;break;
        default:var _wm_=_ba_}
      return transform_int_alt(iconv,caml_format_int(_wm_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _wl_=_bc_;break;
        case 2:var _wl_=_bd_;break;
        case 4:var _wl_=_bf_;break;
        case 5:var _wl_=_bg_;break;
        case 6:var _wl_=_bh_;break;
        case 7:var _wl_=_bi_;break;
        case 8:var _wl_=_bj_;break;
        case 9:var _wl_=_bk_;break;
        case 10:var _wl_=_bl_;break;
        case 11:var _wl_=_bm_;break;
        case 0:
        case 13:var _wl_=_bb_;break;
        case 3:
        case 14:var _wl_=_be_;break;
        default:var _wl_=_bn_}
      return transform_int_alt(iconv,caml_format_int(_wl_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _wk_=_aO_;break;
        case 2:var _wk_=_aP_;break;
        case 4:var _wk_=_aR_;break;
        case 5:var _wk_=_aS_;break;
        case 6:var _wk_=_aT_;break;
        case 7:var _wk_=_aU_;break;
        case 8:var _wk_=_aV_;break;
        case 9:var _wk_=_aW_;break;
        case 10:var _wk_=_aX_;break;
        case 11:var _wk_=_aY_;break;
        case 0:
        case 13:var _wk_=_aN_;break;
        case 3:
        case 14:var _wk_=_aQ_;break;
        default:var _wk_=_aZ_}
      return transform_int_alt(iconv,caml_int64_format(_wk_,n))}
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_we_=l - 1 | 0,_wd_=0;
            if(! (_we_ < 0))
             {var i=_wd_;
              for(;;)
               {caml_bytes_unsafe_set(r,i,f(caml_bytes_unsafe_get(s,i)));
                ...
                break}}
            var _wg_=r}
          return caml_string_of_bytes(_wg_)}
        return s$0}
      if(15 === fconv)
       var _wh_=_bo_;
      else
       {var prec=abs(prec$0);
        ...
        var _wh_=buffer_contents(buf)}
      var str=caml_format_float(_wh_,x);
      if(15 === fconv)
       {var len=caml_ml_string_length(str),match$0=caml_classify_float(x);
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var match=caml_string_get(str,i$0),_wi_=match - 46 | 0,switch$1=0;
            if(23 < _wi_ >>> 0)
             {if(55 === _wi_)switch$1 = 1}
            else
             if(21 < (_wi_ - 1 | 0) >>> 0)switch$1 = 1;
            if(! switch$1){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _wj_=1}
          return _wj_?str:symbol(str,_bs_)}}
      return str}
    function make_int_padding_precision(k,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _wa_=pad[2],_wb_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_wb_,_wa_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_wb_,_wa_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_wb_,_wa_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _wc_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_wc_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_wc_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_wc_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _v8_=pad$5[2],_v9_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_v9_,_v8_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_v9_,_v8_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_v9_,_v8_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _v__=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_v__,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_v__,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_v__,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _v$_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _v$_[2] === "number")
              {var fmt=_v$_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_v7_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_v7_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _v4_=[8,acc,_bz_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_v4_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_v4_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_v3_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_v3_,rest])}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bF_;
      var _vZ_=other_fields(x,i + 1 | 0),_v0_=field(x,i);
      return caml_call2(sprintf(_bG_),_v0_,_vZ_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _vW_=other_fields(x,2),_vX_=field(x,1);
        return caml_call2(sprintf(_bH_),_vX_,_vW_)}
      switch(match)
       {case 0:return _bI_;
        case 1:return _bJ_;
        default:var _vY_=field(x,1);return caml_call1(sprintf(_bK_),_vY_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _vU_=caml_call1(hd,x),_vT_=_vU_}catch(_vV_){var _vT_=0}
            if(_vT_){var s=_vT_[1];return s}
            var param$0=tl;
            continue}
    ...
    try
     {var _i8_=caml_sys_getenv(_i7_),params=_i8_}
    catch(_vR_)
     {_vR_ = caml_wrap_exception(_vR_);
      if(_vR_ !== Not_found)throw _vR_;
      try
       {var _i6_=caml_sys_getenv(_i5_),_bS_=_i6_}
      catch(_vS_)
       {_vS_ = caml_wrap_exception(_vS_);
        if(_vS_ !== Not_found)throw _vS_;
        var _bS_=_bR_}
      var params=_bS_}
    var
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _vP_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_vP_;continue}
           var accu=[0,_bQ_],_vL_=54 + max(55,l) | 0,_vK_=0;
           if(! (_vL_ < 0))
            {var i=_vK_;
             for(;;)
              {var
               ...
               var
                _vM_=accu[1],
                _vG_=caml_string_get(_vM_,3) << 24,
                _vH_=caml_string_get(_vM_,2) << 16,
                _vI_=caml_string_get(_vM_,1) << 8,
                _vJ_=
                 ((caml_string_get(_vM_,0) + _vI_ | 0) + _vH_ | 0)
                 +
                 _vG_
                 |
                 0,
    ...
    function find$0(h,key)
     {var _vF_=indexfun(h,key),match=caml_check_bound(h[2],_vF_)[1 + _vF_];
      if(match)
    ...
    function f$0(s)
     {var accu=[0,0],_vC_=caml_ml_string_length(s) - 1 | 0,_vB_=0;
      if(! (_vC_ < 0))
       {var i=_vB_;
        for(;;)
         {var _vD_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _vD_ | 0;
          var _vE_=i + 1 | 0;
          if(_vC_ !== i){var i=_vE_;continue}
          break}}
      ...
      if(! (_vx_ < 0))
       {var i=_vw_;
        for(;;)
         {var
           _vz_=(i * 2 | 0) + 3 | 0,
           _vy_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_vz_)[1 + _vz_] = _vy_;
          var _vA_=i + 1 | 0;
    ...
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_vs_=len < new_size?1:0;
      if(_vs_)
       {var a2=caml_make_vect(new_size,dummy_met),_vt_=array[2],switch$0=0;
        if
         (0
          <=
          len
          ...
          !
          ((a2.length - 1 - len | 0) < 0))
         {caml_array_blit(_vt_,0,a2,0,len);switch$0 = 1}
     ...
     {var x=16;
      for(;;)
       {if(! (17 <= x) && ! (max_array_length < (x * 2 | 0)))
        ...
        if(random)
         {var
           _uQ_=caml_obj_tag(prng),
           _uR_=250 === _uQ_?prng[1]:246 === _uQ_?force_lazy_block(prng):prng;
          _uR_[2] = (_uR_[2] + 1 | 0) % 55 | 0;
          var
           _uL_=_uR_[2],
           curval=caml_check_bound(_uR_[1],_uL_)[1 + _uL_],
           _uM_=(_uR_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_uR_[1],_uM_)[1 + _uM_]
            +
           ...
           _uN_=_uR_[2];
          caml_check_bound(_uR_[1],_uN_)[1 + _uN_] = newval30;
          var seed=newval30}
        else
         var seed=0;
         ...
         {if(param)
             ...
             {var
              ...
              if(nsize < max_array_length)
               {var
                 ...
                 _uO_=kwd_table.length - 1 < 4?1:0,
                 _uP_=_uO_ || (kwd_table[4] < 0?1:0),
                 inplace=1 - _uP_;
                kwd_table[2] = ndata;
                var _uT_=osize - 1 | 0,_uS_=0;
                if(! (_uT_ < 0))
                 {var i$0=_uS_;
                  a:
                  for(;;)
                    ...
                    for(;;)
                     {if(cell)
                       {var
                        ...
                        continue}
                      var _uX_=i$0 + 1 | 0;
                      if(_uT_ !== i$0){var i$0=_uX_;continue a}
                      break}
                    break}}
                if(inplace)
                 {var _uV_=nsize - 1 | 0,_uU_=0;
                  if(! (_uV_ < 0))
                   {var i=_uU_;
                    for(;;)
          ...
          var
           ident_or_keyword=
            function(id)
             {try
               {var _vm_=find$0(kwd_table,id);return _vm_}
              catch(_vn_)
               {_vn_ = caml_wrap_exception(_vn_);
                if(_vn_ === Not_found)return [1,id];
                throw _vn_}},
           keyword_or_error=
            function(c)
             {var s=make$0(1,c);
              try
               {var _vk_=find$0(kwd_table,s);return _vk_}
              catch(_vl_)
               {_vl_ = caml_wrap_exception(_vl_);
                if(_vl_ === Not_found)throw [0,Error,symbol(_bU_,s)];
                throw _vl_}},
           end_exponent_part=
            function(strm)
             {for(;;)
                ...
                if(58 <= _uZ_)
                 ...
                 if(48 <= _uZ_)
                  {junk(strm);
                   var match$0=peek(strm);
                   if(match$0)
                    {var _u0_=match$0[1],switcher$0=_u0_ - 48 | 0;
                     if(! (9 < switcher$0 >>> 0))
                      {junk(strm);
                       var match$1=peek(strm);
                       if(match$1)
                        {var _u1_=match$1[1],switcher$1=_u1_ - 48 | 0;
                         if(! (9 < switcher$1 >>> 0))
                          {junk(strm);
                           var
                            n=
                     ...
                     default:
                      ...
                      for(;;)
                       {var match$1=peek(strm);
                        if(match$1)
                         {var _uY_=match$1[1];
                          if(41 === _uY_){junk(strm);return 0}
                          if(42 === _uY_){junk(strm);continue}
                          junk(strm);
                          continue b}
                        throw Failure$0}}
                  junk(strm);
    ...
    function pp_expr(param)
     {switch(param[0])
       {case 0:var v=param[1];return pp_var(v);
        ...
        case 2:
         var e2=param[2],e1=param[1],_uI_=symbol(_cb_,pp_expr(e2));
         return parens(symbol(pp_expr(e1),_uI_));
        case 3:
         var e2$0=param[2],e1$0=param[1],_uJ_=symbol(_cc_,pp_expr(e2$0));
         return parens(symbol(pp_expr(e1$0),_uJ_));
        case 4:
        ...
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _uK_=symbol(_ce_,caml_string_of_jsbytes("" + e2$2));
         return parens(symbol(pp_expr(e1$2),_uK_));
    ...
    function pp_acall(param)
     {var el=param[2],f=param[1];
      ...
      var _uH_=symbol(_ci_,symbol(concat(_ch_,map(pp_expr,el)),_cg_));
      return symbol(pp_func(f),_uH_)}
    function pp_pred(param)
     {var e2=param[3],o=param[2],e1=param[1],_uE_=symbol(_cj_,pp_expr(e2));
      switch(o)
       {case 0:var _uF_=_b6_;break;
        case 1:var _uF_=_b7_;break;
        case 2:var _uF_=_b8_;break;
        case 3:var _uF_=_b9_;break;
        default:var _uF_=_b__}
      var _uG_=symbol(_ck_,symbol(_uF_,_uE_));
      return symbol(pp_expr(e1),_uG_)}
    function pp_eqn(param)
     {var
       ...
       _uz_=
        symbol(_cr_,symbol(_cq_,symbol(concat(_cp_,map(pp_acall,cl)),_uy_))),
       _uA_=pp_expr(e),
       _uB_=
        to_nat
         ?function(x){return symbol(_cs_,parens(x))}
         :function(x){return x},
       _uC_=symbol(_ct_,symbol(_uB_(_uA_),_uz_)),
       vl=call[2],
       f=call[1];
      if(0 === vl)
       var _uD_=pp_func(f);
       ...
       var
        _ux_=symbol(_b5_,symbol(concat(_b4_,map(pp_var,vl)),_b3_)),
        _uD_=symbol(pp_func(f),_ux_);
      return symbol(_cu_,symbol(_uD_,_uC_))}
    ...
    function expr_list_map(o,tl,match)
     {if(tl)
       {var
         ...
         tl$0=tl[2],
         t=tl[1],
         _uw_=expr_list_map(o,tl$0,el);
        return [0,caml_call3(caml_get_public_method(o,102,160),o,t,e),_uw_]}
      return 0}
    ...
    function pp_tag_list(param)
     {if(param)
       {var tl=param[2],x=param[1],_uv_=pp_tag_list(tl);
        return [0,pp_tag(x),_uv_]}
      return 0}
    function pp_decl(param)
     {var s=param[2],t=param[1],_uu_=symbol(_cH_,s);
      return symbol(pp_tag(t),_uu_)}
    function pp_var_list(param)
     {if(param)
       {var tl=param[2],v=param[1],_ut_=pp_var_list(tl);
        return [0,pp_decl(v),_ut_]}
      return 0}
        ...
        {case 0:var v=param[1];return v[2];
         ...
         case 2:
          var
           e2=param[2],
           e1=param[1],
           _uk_=symbol(_cP_,symbol(pp_expr$0(tag,e2),_cO_));
          return symbol(_cQ_,symbol(pp_expr$0(tag,e1),_uk_));
         case 3:
          var
           e2$0=param[2],
           e1$0=param[1],
           _ul_=symbol(_cS_,symbol(pp_expr$0(tag,e2$0),_cR_));
          return symbol(_cT_,symbol(pp_expr$0(tag,e1$0),_ul_));
         case 4:
          var
           e=param[2],
           c=param[1],
           _um_=symbol(_cV_,symbol(pp_expr$0(tag,e),_cU_));
          return symbol(_cW_,symbol(pp_expr$0(tag,c),_um_));
         case 5:
          var
           e$0=param[2],
           c$0=param[1],
           _un_=symbol(_cY_,symbol(pp_expr$0(tag,e$0),_cX_));
          return symbol(_cZ_,symbol(pp_expr$0(tag,c$0),_un_));
         case 6:var e$1=param[1];return symbol(_c0_,pp_expr$0(tag,e$1));
         case 7:
          var
           e2$1=param[2],
           e1$1=param[1],
           _uo_=symbol(_c2_,symbol(pp_expr$0(1,e2$1),_c1_));
          return symbol(_c3_,symbol(pp_expr$0(1,e1$1),_uo_));
         case 8:
          var
           e2$2=param[2],
           e1$2=param[1],
           _up_=symbol(_c5_,symbol(pp_expr$0(1,e2$2),_c4_));
          return symbol(_c6_,symbol(pp_expr$0(1,e1$2),_up_));
         case 9:
          var
           e2$3=param[3],
           e1$3=param[2],
           tag$0=param[1],
           _uq_=symbol(_c8_,symbol(pp_expr$0(tag$0,e2$3),_c7_));
          return symbol(_c9_,symbol(pp_expr$0(tag$0,e1$3),_uq_));
         case 10:
          var
           g2=param[2],
           g1=param[1],
           _ur_=symbol(_c$_,symbol(pp_expr$0(tag,g2),_c__));
          return symbol(_da_,symbol(pp_expr$0(tag,g1),_ur_));
         case 11:
          var
           g2$0=param[2],
           g1$0=param[1],
           _us_=symbol(_dc_,symbol(pp_expr$0(tag,g2$0),_db_));
          return symbol(_dd_,symbol(pp_expr$0(tag,g1$0),_us_));
    ...
    function pp_expr_list(tg,match)
     {if(tg)
       {var
         ...
         tagl=tg[2],
         tag=tg[1],
         _uj_=pp_expr_list(tagl,tl);
        return [0,pp_expr$0(tag,v),_uj_]}
      return 0}
    function pp_meth(opt,param)
     {var id=param[3],tags=param[2],rtag=param[1];
      if(opt)var sth=opt[1],verbose=sth;else var verbose=0;
      if(verbose)
       {var _ui_=symbol(_dh_,symbol(pp_tag(rtag),_dg_));
        return symbol
                (id,symbol(_dj_,symbol(concat(_di_,pp_tag_list(tags)),_ui_)))}
      return id}
    function pp_rhs(tag,param)
     {if(0 === param[0]){var e=param[1];return pp_expr$0(tag,e)}
      var
       ...
       meth=param[2],
       addr=param[1],
       _ue_=symbol(_dp_,symbol(concat(_do_,pp_expr_list(meth[2],exprl)),_dn_));
      if(value)
       var v=value[1],_uf_=symbol(_dr_,symbol(pp_expr$0(1,v),_dq_));
      else
       var _uf_=_dt_;
      var
       _ug_=symbol(_uf_,_ue_),
       _uh_=symbol(_ds_,symbol(pp_meth(0,meth),_ug_));
      return symbol(pp_expr$0(3,addr),_uh_)}
    function pp_stm(indent,opt,tag,stm)
     {if(opt)var sth=opt[1],breakline=sth;else var breakline=1;
      var switch$0=0;
      if(typeof stm === "number" && 0 === stm)var _t2_=_du_;else switch$0 = 1;
      if(switch$0)var _t2_=breakline?_dK_:_dL_;
      if(typeof stm === "number")
       switch(stm)
        {case 0:var _t3_=_dv_;break;
         case 1:var _t3_=_dx_;break;
         default:var _t3_=_dy_}
      else
       switch(stm[0])
        {case 0:
          var e=stm[1],_t3_=symbol(_dA_,symbol(pp_rhs(tag,e),_dz_));break;
         case 1:
          var
           stm$0=stm[3],
           rhs=stm[2],
           lhs=stm[1],
           switch$1=0,
           _t6_=pp_stm(indent,_dB_,tag,stm$0);
          if(typeof stm$0 === "number" && 0 === stm$0)
           {var _t7_=_dC_;switch$1 = 1}
          if(! switch$1)var _t7_=_dE_;
          var
           _t8_=symbol(_dD_,symbol(_t7_,_t6_)),
           _t9_=symbol(pp_rhs(tag_of_lhs(lhs),rhs),_t8_);
          if(typeof lhs === "number")
           var _t__=_dk_;
          else
           if(0 === lhs[0])
            var f=lhs[1],_t__=symbol(f[2],_dl_);
           else
            var v=lhs[1],_t__=symbol(v[2],_dm_);
          var _t3_=symbol(_t__,_t9_);
          break;
         default:
          var
           stm3=stm[4],
           ...
           stm1=stm[2],
           c=stm[1],
           _t$_=symbol(_dG_,pp_stm(indent,_dF_,tag,stm3)),
           _ua_=symbol(mk_indent(indent),_t$_),
           _ub_=symbol(_dH_,symbol(pp_stm(indent + 1 | 0,0,tag,stm2),_ua_)),
           _uc_=symbol(mk_indent(indent),_ub_),
           _ud_=symbol(_dI_,symbol(pp_stm(indent + 1 | 0,0,tag,stm1),_uc_)),
           _t3_=symbol(_dJ_,symbol(pp_expr$0(2,c),_ud_))}
      var switch$2=0,_t4_=symbol(_t3_,_t2_);
      if(typeof stm === "number" && 0 === stm){var _t5_=_dw_;switch$2 = 1}
      if(! switch$2)var _t5_=mk_indent(indent);
      return symbol(_t5_,_t4_)}
    function pp_block(indent,payable,tag,param)
     {var
       stm=param[3],
       lvl=param[2],
       vl=param[1],
       _tT_=symbol(mk_indent(indent),_dM_),
       _tU_=symbol(pp_stm(indent + 1 | 0,0,tag,stm),_tT_),
       _tV_=pp_var_list(lvl),
       _tW_=
        symbol
         (_dP_,
          symbol
           (concat
             (_dO_,
              map
               (function(s)
                 {var _t1_=symbol(s,_dN_);
                  return symbol(mk_indent(indent + 1 | 0),_t1_)},
                _tV_)),
            _tU_)),
       _tX_=payable?_dQ_:_dX_,
       _tY_=symbol(_tX_,_tW_),
       _tZ_=0 === tag?_dR_:symbol(_dW_,symbol(pp_tag(tag),_dV_)),
       _t0_=symbol(_dS_,symbol(_tZ_,_tY_));
      return symbol(_dU_,symbol(concat(_dT_,pp_var_list(vl)),_t0_))}
    function pp_a_contract(param)
     {var
      ...
      if(fallback)
       var
        b=fallback[1],
        _tM_=symbol(_d1_,pp_block(indent,1,0,b)),
        _tN_=symbol(mk_indent(indent),_tM_);
      else
       var _tN_=_d2_;
      var
       _tO_=symbol(_tN_,_d3_),
       indent$0=1,
       _tP_=
        symbol
         (_d4_,
              ...
              map
               (function(param)
                 {var
                   ...
                   b=param[2],
                   m=param[1],
                   _tR_=symbol(_dY_,pp_block(indent$0,payable,m[1],b)),
                   _tS_=symbol(_dZ_,symbol(pp_meth(0,m),_tR_));
                  return symbol(mk_indent(indent$0),_tS_)},
                methods)),
            _tO_)),
       indent$1=1;
      return symbol
                   ...
                   symbol
                    (concat
                      (_cK_,
                       map
                        (function(f$0)
                          {var f=f$0[1],_tQ_=symbol(pp_decl(f),_cJ_);
                           return symbol(mk_indent(indent$1),_tQ_)},
                         fields)),
                     _tP_))))}
    ...
    function best(err1,err2)
     {if(caml_string_equal(err1[1],_d$_))return err2;
      ...
      if(length(err1[2]) < _tI_)return err1;
      var _tJ_=length(err2[2]);
      if(length(err1[2]) === _tJ_)
       {var _tK_=err1[2],_tL_=symbol(_eb_,err2[1]);
        return [0,symbol(err1[1],_tL_),_tK_]}
      return err2}
    ...
    function kwd(str)
     {function _tA_(_tE_){return 0}
      var _tB_=[0,str];
      return function(_tC_,_tD_){return const$0(_tB_,_tA_,_tC_,_tD_)}}
    function option(p,s,tbl)
     {try
       {var
         ...
         res=match[2],
         next=match[1],
         _tz_=[0,next,[0,res],error$0,ntbl];
        return _tz_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
    ...
    function choice(p1,p2,s,tbl)
     {try
       {var _tx_=caml_call2(p1,s,tbl);return _tx_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         {var error1=exn[2];
          try
           {var _tw_=caml_call2(p2,s,tbl);return _tw_}
          catch(exn)
           {exn = caml_wrap_exception(exn);
            if(exn[1] === Fail)
    ...
    function choice_list(param)
     {if(param)
       {var _tr_=param[2],_ts_=param[1];
        if(_tr_)
         {var _tt_=choice_list(_tr_);
          return function(_tu_,_tv_){return choice(_ts_,_tt_,_tu_,_tv_)}}
        return _ts_}
       ...
       {var
        ...
        try
         ...
         {exn = caml_wrap_exception(exn);
          ...
          throw exn}
        var _tq_=[0,rest2,x,best(error1,error2$0),tbl2];
        return _tq_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         ...
         {var
          ...
          try
           ...
           {exn = caml_wrap_exception(exn);
            ...
            throw exn}
          var _tp_=aux(rest1,x,best(error1$0,error),ntbl);
          return _tp_}
        catch(exn)
         {exn = caml_wrap_exception(exn);
          if(exn[1] === Fail)
    ...
    function x_cont(x_expr,x_binop,s)
     {function _td_(f1,f2,x){return caml_call1(f2,caml_call1(f1,x))}
      function _te_(_to_){return x_cont(x_expr,x_binop,_to_)}
      function _tf_(f,x,y){return caml_call2(f,y,x)}
      function _tg_(_tm_,_tn_){return concat$0(x_binop,x_expr,_tf_,_tm_,_tn_)}
      function _th_(_tk_,_tl_){return concat$0(_tg_,_te_,_td_,_tk_,_tl_)}
      function _ti_(x){return x}
      return function(_tj_){return option2(_ti_,_th_,s,_tj_)}}
    function nelist(x_expr,x_binop)
     {function _s__(x,f){return caml_call1(f,x)}
      function _s$_(_tc_){return x_cont(x_expr,x_binop,_tc_)}
      return function(_ta_,_tb_){return concat$0(x_expr,_s$_,_s__,_ta_,_tb_)}}
    ...
    function check_type(tag,param)
     {var e=param[2],t=param[1],match=eq_tag(tag,t);
      if(match)return e;
      var _s9_=symbol(_es_,pp_tag(tag));
      throw [0,Reject,symbol(pp_expr$0(t,e),_s9_)]}
     ...
     {var tbl$0=tbl;
      for(;;)
       {if(tbl$0)
         {var _s8_=tbl$0[1];
          if(1 === _s8_[0])
           {var islocal=_s8_[2],match=_s8_[1],name=match[2],tag=match[1];
    ...
    function add_fun_to_table(tbl$1,param)
     {var match$0=param[1],funname=match$0[3],l=match$0[2],t=match$0[1];
      ...
      for(;;)
       {if(tbl)
         {var _s7_=tbl[1],switch$0=0;
          if(2 === _s7_[0])
           {var match=_s7_[1],name=match[3],tagl=match[2],rettag=match[1];
    ...
    function plus(e1,e2)
     {if(1 === e1[1] && 1 === e2[1])
      ...
      var _s5_=symbol(_eA_,pp_any_expr(e2));
    ...
    function eq(e1,e2)
     {var v2=e2[2],t2=e2[1],v1=e1[2],t1=e1[1],match=eq_tag(t1,t2);
      ...
      var _sZ_=symbol(_eH_,pp_any_expr(e2));
    ...
    function varname(s,t)
     {if(s)
       {var _sW_=s[1];
        if(1 === _sW_[0]){var tl=s[2],x=_sW_[1];return [0,tl,x,[0,_eM_,tl],t]}}
    ...
    function var_pars(tag,s,tbl)
     {try
       ...
       {_sV_ = caml_wrap_exception(_sV_);
        if(_sV_[1] === Failure)throw [0,Fail,[0,_eN_,s]];
        throw _sV_}
      return const$0
              (x,
               function(param)
                {if(s)
                  {var _sR_=s[1];
                   if(1 === _sR_[0])
                    {var var$0=_sR_[1],match=get_field(tbl,var$0);
                     if(match)
                      {var
                        _sS_=match[1],
                        islocal=_sS_[2],
                       ...
                       if(eq_tag(tagfield,tag))
                        {var
                         ...
                         return _sT_}
                       var _sU_=symbol(_eP_,pp_tag(tag));
                       throw [0,Reject,symbol(pp_tag(tagfield),_sU_)]}
    ...
    function value_pars(tag,s,tbl)
     {try
       ...
       {_sQ_ = caml_wrap_exception(_sQ_);
        if(_sQ_[1] === Failure)throw [0,Fail,[0,_eZ_,s]];
        throw _sQ_}
      return const$0
              (t,
               function(match$0)
                {switch(tag)
                  {case 1:
                   ...
                   case 2:
                    if(0 === match$0[0])
                     {var _sP_=match$0[1];
                      if(! caml_string_notequal(_sP_,_eT_))return _eW_;
                      if(! caml_string_notequal(_sP_,_eU_))return _eV_}
                    break;
                   case 3:
                    if(1 === match$0[0])
    ...
    function this_pars(_sN_,_sO_){return const$0(_e1_,_e0_,_sN_,_sO_)}
    function brackets_pars(pars)
     {var _sG_=kwd(_e2_),_sH_=kwd(_e3_);
      function _sI_(_sL_,_sM_){return concat$0(_sH_,pars,csnd,_sL_,_sM_)}
      return function(_sJ_,_sK_){return concat$0(_sI_,_sG_,cfst,_sJ_,_sK_)}}
    function _e4_(param){return 1}
    var _e6_=kwd(_e5_),_e8_=kwd(_e7_),_e__=kwd(_e9_);
    function _e$_(_sE_,_sF_){return concat$0(_e__,_e8_,csnd,_sE_,_sF_)}
    function _fa_(_sC_,_sD_){return concat$0(_e$_,_e6_,csnd,_sC_,_sD_)}
    function msg_sender_pars(_sA_,_sB_)
     {return comb_parser(_fa_,_e4_,_sA_,_sB_)}
    function _fb_(param){return _fc_}
    var _fe_=kwd(_fd_),_fg_=kwd(_ff_),_fi_=kwd(_fh_);
    function _fj_(_sy_,_sz_){return concat$0(_fi_,_fg_,csnd,_sy_,_sz_)}
    function _fk_(_sw_,_sx_){return concat$0(_fj_,_fe_,csnd,_sw_,_sx_)}
    function msg_value_pars(_su_,_sv_)
     {return comb_parser(_fk_,_fb_,_su_,_sv_)}
    function base(tag,s,tbl)
     {var
       _so_=0,
       _sp_=[0,function(_ss_,_st_){return value_pars(tag,_ss_,_st_)},_so_];
      return caml_call2
              (choice_list
                ([0,function(_sq_,_sr_){return var_pars(tag,_sq_,_sr_)},_sp_]),
               s,
               tbl)}
    function atomic_int_expr(s)
     {var _sb_=[0,brackets_pars(int_expr),0];
      function _sc_(param){return uminus}
      var
       _sd_=kwd(_fl_),
       _se_=
        [0,
         function(_sm_,_sn_)
          {return concat$0(_sd_,atomic_int_expr,_sc_,_sm_,_sn_)},
         _sb_];
      function _sf_(expr){return [0,1,expr]}
      var _sg_=1;
      function _sh_(_sk_,_sl_){return base(_sg_,_sk_,_sl_)}
      return caml_call1
              (choice_list
                ([0,
                  msg_value_pars,
                  [0,
                   balance_pars,
                   [0,
                    function(_si_,_sj_){return comb_parser(_sh_,_sf_,_si_,_sj_)},
                    _se_]]]),
               s)}
    ...
    function add_binop(s)
     {var _r5_=0;
      function _r6_(param){return minus}
      var
       _r7_=
        [0,function(_r$_,_sa_){return const$0(_fm_,_r6_,_r$_,_sa_)},_r5_];
      function _r8_(param){return plus}
      return caml_call1
              (choice_list
                ([0,
                  function(_r9_,_r__){return const$0(_fn_,_r8_,_r9_,_r__)},
                  _r7_]),
               s)}
    function mul_binop(s)
     {var _rX_=0;
      function _rY_(param){return div}
      var
       _rZ_=
        [0,function(_r3_,_r4_){return const$0(_fo_,_rY_,_r3_,_r4_)},_rX_];
      function _r0_(param){return mult}
      return caml_call1
              (choice_list
                ([0,
                  function(_r1_,_r2_){return const$0(_fp_,_r0_,_r1_,_r2_)},
                  _rZ_]),
               s)}
    function atomic_bool_expr(s)
     {var _ru_=0;
      function _rv_(x,f){return caml_call1(f,x)}
      function _rw_(f,y,x){return caml_call2(f,x,y)}
      function _rx_(_rV_,_rW_){return concat$0(cmpop,int_expr,_rw_,_rV_,_rW_)}
      var
       _ry_=
        [0,
         function(_rT_,_rU_){return concat$0(int_expr,_rx_,_rv_,_rT_,_rU_)},
         _ru_];
      function _rz_(param){return notb}
      var
       _rA_=kwd(_fq_),
       _rB_=
        [0,
         function(_rR_,_rS_)
          {return concat$0(_rA_,atomic_bool_expr,_rz_,_rR_,_rS_)},
         _ry_],
       _rC_=kwd(_fr_),
       _rD_=kwd(_fs_);
      function _rE_(_rP_,_rQ_){return concat$0(_rD_,bool_expr,csnd,_rP_,_rQ_)}
      var
       _rF_=
        [0,
         function(_rN_,_rO_){return concat$0(_rE_,_rC_,cfst,_rN_,_rO_)},
         _rB_];
      function _rG_(expr){return [0,2,expr]}
      var _rH_=2;
    ...
    function cmpop(s)
     {var _re_=0;
      function _rf_(param){return le}
      var
       _rg_=
        [0,function(_rs_,_rt_){return const$0(_ft_,_rf_,_rs_,_rt_)},_re_];
      function _rh_(param){return lt}
      var
       _ri_=
        [0,function(_rq_,_rr_){return const$0(_fu_,_rh_,_rq_,_rr_)},_rg_];
      function _rj_(param){return ge}
      var
       _rk_=
        [0,function(_ro_,_rp_){return const$0(_fv_,_rj_,_ro_,_rp_)},_ri_];
      function _rl_(param){return gt}
      return caml_call1
              (choice_list
                ([0,
                  function(_rm_,_rn_){return const$0(_fw_,_rl_,_rm_,_rn_)},
                  _rk_]),
               s)}
    function eqop(s)
     {var _q8_=0;
      function _q9_(param){return neq}
      var
       _q__=
        [0,function(_rc_,_rd_){return const$0(_fx_,_q9_,_rc_,_rd_)},_q8_];
      function _q$_(param){return eq}
      return caml_call1
              (choice_list
                ([0,
                  function(_ra_,_rb_){return const$0(_fy_,_q$_,_ra_,_rb_)},
                  _q__]),
               s)}
    ...
    function and_binop(s)
     {var _q4_=0;
      function _q5_(param){return andb}
      return caml_call1
              (choice_list
                ([0,
                  function(_q6_,_q7_){return const$0(_fz_,_q5_,_q6_,_q7_)},
                  _q4_]),
               s)}
    function or_binop(s)
     {var _q0_=0;
      function _q1_(param){return orb}
      return caml_call1
              (choice_list
                ([0,
                  function(_q2_,_q3_){return const$0(_fA_,_q1_,_q2_,_q3_)},
                  _q0_]),
               s)}
    function balance_pars(s)
     {function _qT_(a$0,param)
       {if(3 <= a$0[1]){var a=a$0[2];return [0,1,[14,a]]}
        throw [0,Reject,symbol(pp_any_expr(a$0),_ez_)]}
      var _qU_=kwd(_fB_),_qV_=kwd(_fC_);
      function _qW_(_qY_,_qZ_)
       {return concat$0(contract_expr,_qV_,cfst,_qY_,_qZ_)}
      return function(_qX_){return concat$0(_qW_,_qU_,_qT_,s,_qX_)}}
    function contract_expr(s)
     {function aux(s)
       {var _qP_=[0,this_pars,[0,brackets_pars(aux),0]],_qQ_=3;
        return caml_call1
                (choice_list
                  ([0,
                    msg_sender_pars,
                    [0,function(_qR_,_qS_){return base(_qQ_,_qR_,_qS_)},_qP_]]),
                 s)}
      function _qN_(expr){return [0,3,expr]}
      return function(_qO_){return comb_parser(aux,_qN_,s,_qO_)}}
    function expr_pars(s)
     {var
       _qG_=kwd(_fD_),
       _qF_=[0,int_expr,[0,bool_expr,[0,contract_expr,0]]],
       _qH_=kwd(_fE_);
      function _qI_(_qL_,_qM_){return concat$0(_qH_,expr_pars,csnd,_qL_,_qM_)}
      return caml_call1
              (choice_list
                ([0,
                  function(_qJ_,_qK_)
                   {return concat$0(_qI_,_qG_,cfst,_qJ_,_qK_)},
                  _qF_]),
               s)}
    function tag_pars(str,tag)
     {function _qB_(param){return [0,tag]}
      var _qC_=[0,str];
      return function(_qD_,_qE_){return const$0(_qC_,_qB_,_qD_,_qE_)}}
    var
    ...
    function field_pars(islocal,s,t)
     {var _qx_=kwd(_fK_);
      function _qy_(param,v){var t=param[1];return [0,[0,t,v]]}
      var
       match=
        concat$0
         (function(_qz_,_qA_)
           {return concat$0(type_pars,varname,_qy_,_qz_,_qA_)},
          _qx_,
          cfst,
          s,
          t),
    ...
    function _fM_(_qw_){return map(_fL_,_qw_)}
    var _fN_=0,_fO_=0;
    function _fP_(_qu_,_qv_){return field_pars(_fO_,_qu_,_qv_)}
    function _fQ_(_qs_,_qt_){return kleenestar(_fP_,_fN_,addel,_qs_,_qt_)}
    function fields_pars(_qq_,_qr_){return comb_parser(_fQ_,_fM_,_qq_,_qr_)}
    ...
    function _fV_(_qo_,_qp_){return concat$0(_fU_,expr_pars,csnd,_qo_,_qp_)}
    function _fW_(_qm_,_qn_){return kleenestar(_fV_,_fS_,addel,_qm_,_qn_)}
    function _fX_(_qk_,_ql_){return concat$0(expr_pars,_fW_,cons,_qk_,_ql_)}
    var
     _fY_=0,
     _fZ_=
      brackets_pars(function(_qi_,_qj_){return option2(_fY_,_fX_,_qi_,_qj_)});
    function parse_any_expr_list(_qg_,_qh_)
     {return comb_parser(_fZ_,expr_list_of_any_expr_list,_qg_,_qh_)}
    function ident_pars(s,t)
     {if(s)
       {var _qf_=s[1];
        if(1 === _qf_[0]){var tl=s[2],i=_qf_[1];return [0,tl,i,[0,_f1_,tl],t]}}
       ...
       {var t=1;
        if(x)
         {var v=x[1],e=v[2],texp=v[1],match=eq_tag(texp,t);
          return match?[0,e]:0}
        return 0}
      var _p6_=brackets_pars(int_expr),_p7_=kwd(_f2_),_p8_=kwd(_f3_);
      function _p9_(_qd_,_qe_){return concat$0(_p8_,_p7_,csnd,_qd_,_qe_)}
      function _p__(_qb_,_qc_){return concat$0(_p9_,_p6_,csnd,_qb_,_qc_)}
      return comb_parser
              (function(_p$_,_qa_){return option(_p__,_p$_,_qa_)},_p5_,s,t)}
    function rhs_pars(tag)
     {var _pN_=0;
      ...
      var _pH_=kwd(_f4_);
      function _pI_(_p2_,_p3_)
       {return concat$0(contract_expr,_pH_,cfst,_p2_,_p3_)}
      function _pJ_(_p0_,_p1_){return option2(_f5_,_pI_,_p0_,_p1_)}
      function _pK_(_pY_,_pZ_)
       {return concat$0(_pJ_,ident_pars,couple,_pY_,_pZ_)}
      function _pL_(_pW_,_pX_)
       {return concat$0(_pK_,dot_value_pars,couple,_pW_,_pX_)}
      function _pM_(_pU_,_pV_)
       {return concat$0(_pL_,parse_any_expr_list,couple,_pU_,_pV_)}
      var
       _pO_=
        [0,function(_pS_,_pT_){return comb_parser(_pM_,_pG_,_pS_,_pT_)},_pN_];
      function _pP_(expr){return [0,check_type(tag,expr)]}
      return choice_list
              ([0,
                function(_pQ_,_pR_)
                 {return comb_parser(expr_pars,_pP_,_pQ_,_pR_)},
                _pO_])}
     ...
     {var
       ...
       _on_=
        [0,
         ...
         _om_],
       _oo_=kwd(_ge_);
      function _op_(_pE_,_pF_){return stm_pars(tag,rettag,_pE_,_pF_)}
      function _oq_(_pC_,_pD_){return concat$0(_op_,_oo_,cfst,_pC_,_pD_)}
      var
       _or_=kwd(_gf_),
       _os_=
        [0,
         function(_pA_,_pB_){return concat$0(_or_,_oq_,csnd,_pA_,_pB_)},
         _on_];
      function _ot_(param)
       {var
         stm3=param[2],
      ...
      function _ou_(_px_,_py_){return stm_pars(tag,rettag,_px_,_py_)}
      var _ov_=0;
      function _ow_(_pv_,_pw_){return stm_pars(tag,_ov_,_pv_,_pw_)}
      var _ox_=kwd(_gg_);
      function _oy_(_pt_,_pu_){return concat$0(_ox_,_ow_,csnd,_pt_,_pu_)}
      function _oz_(_pr_,_ps_){return option(_oy_,_pr_,_ps_)}
      var _oA_=0;
      function _oB_(_pp_,_pq_){return stm_pars(tag,_oA_,_pp_,_pq_)}
      var _oC_=kwd(_gh_);
      function _oD_(_pn_,_po_){return concat$0(_oC_,bool_expr,csnd,_pn_,_po_)}
      function _oE_(_pl_,_pm_){return concat$0(_oD_,_oB_,couple,_pl_,_pm_)}
      function _oF_(_pj_,_pk_){return concat$0(_oE_,_oz_,couple,_pj_,_pk_)}
      function _oG_(_ph_,_pi_){return concat$0(_oF_,_ou_,couple,_ph_,_pi_)}
      var
       _oH_=
        [0,function(_pf_,_pg_){return comb_parser(_oG_,_ot_,_pf_,_pg_)},_os_],
       _oI_=
        [0,
         function(s,t)
          {var
            ...
            match=
             option
              (function(_pd_,_pe_)
                {return concat$0(varname,_o1_,cfst,_pd_,_pe_)},
               s,
               t),
            t1=match[4],
            error1=match[3],
           ...
           function aux(lhstag,lhs,s1,t1)
            {function _o7_(_pb_,_pc_){return stm_pars(tag,rettag,_pb_,_pc_)}
             var
              _o8_=kwd(_gj_),
              _o9_=rhs_pars(lhstag),
              _o__=
               concat$0
                (function(_o$_,_pa_)
                  {return concat$0(_o9_,_o8_,cfst,_o$_,_pa_)},
                 _o7_,
                 couple,
                 s1,
                 t1),
           ...
           if(match$0)
            {var _o2_=match$0[1];
             if(_o2_)
              {var _o3_=_o2_[1],_o4_=_o3_[1][1],_o5_=_o4_[2],_o6_=_o4_[1];
               return 0 === _o3_[2]
                       ?aux(_o6_,[0,[0,_o6_,_o5_]],s1,t1)
                       :aux(_o6_,[1,[0,_o6_,_o5_]],s1,t1)}
             throw [0,Fail,best([0,_gl_,s],error1)]}
           return aux(0,0,s1,t1)},
         _oH_];
      function _og_(rhs,param)
       {if(rhs){var rhs$0=rhs[1];return [0,rhs$0]}
        if(0 === tag)return 1;
        throw [0,Reject,symbol(_gb_,pp_tag(tag))]}
      var _oh_=kwd(_gc_),_oi_=rhs_pars(tag);
      function _oj_(_oZ_,_o0_){return option(_oi_,_oZ_,_o0_)}
      var _ok_=kwd(_gd_);
      function _ol_(_oX_,_oY_){return concat$0(_ok_,_oj_,csnd,_oX_,_oY_)}
      var
       _oJ_=
        [0,
         function(_oV_,_oW_){return concat$0(_ol_,_oh_,_og_,_oV_,_oW_)},
         _oI_];
      return caml_call2
              (choice_list
                ([0,
                  function(s,t)
                   {function _oK_(param,_oU_){return 2}
                    var
                     _oL_=kwd(_f6_),
                     _oM_=kwd(_f7_),
                     _oN_=kwd(_f8_),
                     _oO_=kwd(_f9_);
                    function _oP_(_oS_,_oT_)
                     {return concat$0(_oO_,_oN_,csnd,_oS_,_oT_)}
                    return concat$0
                            (function(_oQ_,_oR_)
                              {return concat$0(_oP_,_oM_,csnd,_oQ_,_oR_)},
                             _oL_,
                             _oK_,
                             s,
                             t)},
    ...
    function varlist_append(l1,l2)
     {var _oe_=l1[1];
      if(_oe_)
       {var tl=_oe_[2],hd=_oe_[1],match=varlist_append([0,tl],l2),l=match[1];
        return [0,[0,hd,l]]}
      return l2}
    ...
    function pars_varlist_singleton(_ob_,_oc_)
     {return concat$0(type_pars,varname,_gn_,_ob_,_oc_)}
    function parameter_pars(s,t)
     {var _n1_=kwd(_gp_);
      function _n2_(_n$_,_oa_)
       {return concat$0(_n1_,pars_varlist_singleton,csnd,_n$_,_oa_)}
      function _n3_(_n9_,_n__)
       {return kleenestar(_n2_,_go_,varlist_append,_n9_,_n__)}
      function _n4_(_n7_,_n8_)
       {return concat$0(pars_varlist_singleton,_n3_,varlist_append,_n7_,_n8_)}
      var
       match=
        caml_call2
         (brackets_pars
           (function(_n5_,_n6_){return option2(_gq_,_n4_,_n5_,_n6_)}),
          s,
          t),
       nt=match[4],
       error=match[3],
    ...
    function vars_pars(s,t)
     {var
       ...
       match=
        kleenestar
         (function(_nZ_,_n0_)
           {return concat$0(pars_varlist_singleton,_nY_,cfst,_nZ_,_n0_)},
          _gr_,
          varlist_append,
          s,
          t),
    ...
    function block_pars(opt,tag,vl,s,t)
     {if(opt)var sth=opt[1],check_payable=sth;else var check_payable=0;
      var _nz_=kwd(_gt_),_nA_=1;
      function _nB_(_nW_,_nX_){return stm_pars(tag,_nA_,_nW_,_nX_)}
      var _nC_=kwd(_gu_);
      function _nD_(param)
       {if(param)return 1;if(check_payable)throw [0,Reject,_gv_];return 0}
      var _nE_=kwd(_gw_);
      function _nF_(_nU_,_nV_){return option(_nE_,_nU_,_nV_)}
      function _nG_(_nS_,_nT_){return comb_parser(_nF_,_nD_,_nS_,_nT_)}
      function _nH_(_nQ_,_nR_){return concat$0(_nG_,_nC_,cfst,_nQ_,_nR_)}
      function _nI_(_nO_,_nP_)
       {return concat$0(_nH_,vars_pars,couple,_nO_,_nP_)}
      var
       _nJ_=
        concat$0
         (function(_nM_,_nN_){return concat$0(_nI_,_nB_,couple,_nM_,_nN_)},
          _nz_,
          cfst,
          s,
          t),
    ...
    function any_meth_pars(s,t)
     {var _nf_=brackets_pars(type_pars),_ng_=kwd(_gx_);
      function _nh_(_nx_,_ny_){return concat$0(_ng_,_nf_,csnd,_nx_,_ny_)}
      function _ni_(_nv_,_nw_){return option2(_gy_,_nh_,_nv_,_nw_)}
      var _nj_=kwd(_gz_);
      function _nk_(_nt_,_nu_){return concat$0(_nj_,varname,csnd,_nt_,_nu_)}
      var
       _nl_=
        concat$0
         (function(_nr_,_ns_)
           {return concat$0(_nk_,parameter_pars,couple,_nr_,_ns_)},
          _ni_,
          couple,
          s,
          t),
      ...
      try
       ...
       {exn = caml_wrap_exception(exn);
        ...
        throw exn}
      var
       _no_=block_pars(0,t1,vl,ns1,nt1$0),
       nt2=_no_[4],
       error2=_no_[3],
       match$0=_no_[2],
       payable=match$0[2],
       block=match$0[1],
       ns2=_no_[1],
       _np_=remove_local_vars(nt2),
       _nq_=best(error1,error2);
      return [0,ns2,[0,[0,t1,get_taglist(vl),name],block,payable],_nq_,_np_]}
    function methods_pars(s)
     {var _nd_=0;
      return function(_ne_)
       {return kleenestar(any_meth_pars,_nd_,addel,s,_ne_)}}
    function _gA_(param)
     {var _nc_=param[1];
      if(0 === param[2])throw [0,Assert_failure,_gB_];
      return _nc_}
    var _gC_=0,_gD_=0;
    function _gF_(_na_,_nb_){return block_pars(_gE_,_gD_,_gC_,_na_,_nb_)}
    var _gH_=kwd(_gG_),_gJ_=kwd(_gI_),_gL_=kwd(_gK_);
    function _gM_(_m__,_m$_){return concat$0(_gL_,_gJ_,cfst,_m__,_m$_)}
    function _gN_(_m8_,_m9_){return concat$0(_gM_,_gH_,cfst,_m8_,_m9_)}
    function _gO_(_m6_,_m7_){return concat$0(_gN_,_gF_,csnd,_m6_,_m7_)}
    function fallback_pars(_m4_,_m5_){return comb_parser(_gO_,_gA_,_m4_,_m5_)}
    function actor_pars(s,t)
     {function _mF_(param)
      ...
      var _mG_=kwd(_gP_);
      function _mH_(_m1_,_m2_){return option(fallback_pars,_m1_,_m2_)}
      var _mI_=kwd(_gQ_),_mJ_=kwd(_gR_);
      function _mK_(_mZ_,_m0_){return concat$0(_mJ_,varname,csnd,_mZ_,_m0_)}
      function _mL_(_mX_,_mY_){return concat$0(_mK_,_mI_,cfst,_mX_,_mY_)}
      function _mM_(_mV_,_mW_)
       {return concat$0(_mL_,fields_pars,couple,_mV_,_mW_)}
      function _mN_(_mT_,_mU_)
       {return concat$0(_mM_,methods_pars,couple,_mT_,_mU_)}
      function _mO_(_mR_,_mS_){return concat$0(_mN_,_mH_,couple,_mR_,_mS_)}
      var
       match=
        comb_parser
         (function(_mP_,_mQ_){return concat$0(_mO_,_mG_,cfst,_mP_,_mQ_)},
          _mF_,
          s,
          t),
       tbl=match[4],
    ...
    var _gS_=0;
    function _gT_(_mD_,_mE_)
     {return kleenestar(actor_pars,_gS_,addel,_mD_,_mE_)}
    function configuration_pars(_mB_,_mC_)
     {return concat$0(_gT_,eof,cfst,_mB_,_mC_)}
        ...
        for(;;)
         {if(param$0)
           {var _mz_=param$0[1];
            if(0 === _mz_[0])
             {var _mA_=_mz_[1];
              if(! caml_string_notequal(_mA_,_gV_))
               {var
                 param$2=param$0[2],
                 n$2=n$0 + 1 | 0,
                 n$0=n$2,
                 param$0=param$2;
                continue}
              if(! caml_string_notequal(_mA_,_gW_))
               {var tl=param$0[2];
                if(0 === n$0)return tl;
      ...
      function aux(acc,l)
       {var acc$0=acc,l$0=l;
        for(;;)
         {if(l$0)
           {var _mt_=l$0[1];
            if(0 === _mt_[0] && ! caml_string_notequal(_mt_[1],_gY_))
             {var _mu_=l$0[2];
              if(_mu_)
               {var _mv_=_mu_[1];
                if(1 === _mv_[0])
                 {var _mw_=_mu_[2];
                  if(_mw_)
                   {var _mx_=_mw_[1];
                    if(0 === _mx_[0])
                     {var _my_=_mv_[1];
                      if(! caml_string_notequal(_mx_[1],_g0_))
                       {var tl=_mw_[2];
                        try
                         {var acc$1=add_contract_to_table(acc$0,_my_)}
                        catch(exn$0)
       ...
       {case 0:var n=param[1];return caml_string_of_jsbytes("" + n);
        ...
        case 2:
         var
          e2=param[2],
          e1=param[1],
          _mo_=symbol(_g6_,symbol(pp_expr$1(e2),_g5_));
         return symbol(_g7_,symbol(pp_expr$1(e1),_mo_));
        case 3:
         var
          e2$0=param[2],
          e1$0=param[1],
          _mp_=symbol(_g9_,symbol(pp_expr$1(e2$0),_g8_));
         return symbol(_g__,symbol(pp_expr$1(e1$0),_mp_));
        case 4:
         var
          e2$1=param[2],
          e1$1=param[1],
          _mq_=symbol(_ha_,symbol(pp_expr$1(e2$1),_g$_));
         return symbol(_hb_,symbol(pp_expr$1(e1$1),_mq_));
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _mr_=symbol(_hd_,symbol(pp_expr$1(e2$2),_hc_));
         return symbol(_he_,symbol(pp_expr$1(e1$2),_mr_));
       ...
       {case 0:var b=param[1];return string_of_bool(b);
        case 1:
         var
          e2=param[2],
          e1=param[1],
          _mj_=symbol(_hh_,symbol(pp_expr$1(e2),_hg_));
         return symbol(_hi_,symbol(pp_expr$1(e1),_mj_));
        case 2:
         var
          e2$0=param[2],
          e1$0=param[1],
          _mk_=symbol(_hk_,symbol(pp_expr$1(e2$0),_hj_));
         return symbol(_hl_,symbol(pp_expr$1(e1$0),_mk_));
        case 3:
         var
          e2$1=param[2],
          e1$1=param[1],
          _ml_=symbol(_hn_,symbol(pp_expr$1(e2$1),_hm_));
         return symbol(_ho_,symbol(pp_expr$1(e1$1),_ml_));
        case 4:
         var
          e2$2=param[2],
          e1$2=param[1],
          _mm_=symbol(_hq_,symbol(pp_pred$0(e2$2),_hp_));
         return symbol(_hr_,symbol(pp_pred$0(e1$2),_mm_));
        case 5:
         var
          e2$3=param[2],
          e1$3=param[1],
          _mn_=symbol(_ht_,symbol(pp_pred$0(e2$3),_hs_));
         return symbol(_hu_,symbol(pp_pred$0(e1$3),_mn_));
    ...
    function pp_typ(indent,s)
     {switch(s[0])
       {case 0:var l=s[1],_md_=concat(_hw_,map(pp_expr$1,l));break;
        case 1:
         var
          l$0=s[2],
          f=s[1],
        ...
        default:
         var _me_=s[1];
         if(! _me_)throw [0,Assert_failure,_hG_];
         var
          tl=_me_[2],
          match=_me_[1],
          s$0=match[2],
             ...
             map
              (function(param)
                {var
                  s=param[2],
                  p=param[1],
                  _mh_=symbol(_hA_,pp_typ(indent + 2 | 0,s)),
                  _mi_=symbol(_hB_,symbol(pp_pred$0(p),_mh_));
                 return symbol(_hC_,symbol(mk_indent$0(indent),_mi_))},
               tl)),
          _mg_=symbol(_hE_,symbol(pp_typ(indent + 2 | 0,s$0),_mf_)),
          _md_=symbol(_hF_,symbol(pp_pred$0(p),_mg_))}
      return symbol(mk_indent$0(indent),_md_)}
    function pp_function(param)
     {var
       stm=param[3],
       params=param[2],
       f=param[1],
       _mc_=symbol(_hH_,pp_typ(1,stm));
      return symbol(f,symbol(_hJ_,symbol(concat(_hI_,params),_mc_)))}
    ...
    function string_of_meth(addr,m)
     {var _mb_=concat(_hM_,pp_tag_list(m[2]));
      return symbol$0(addr,symbol$0(m[3],_mb_))}
    ...
    function assign(k,v,init)
     {var
       ...
       _l__=init[5],
       _l$_=init[4],
       _ma_=assign_gamma(k,v,init[3]);
      return [0,init[1],init[2],_ma_,_l$_,_l__,_l9_,_l8_]}
    function lookup_gamma(k,gamma)
     {try
       {var _l6_=assoc(k,gamma);return _l6_}
      catch(_l7_)
       {_l7_ = caml_wrap_exception(_l7_);
        if(_l7_ === Not_found){error(k);throw [0,Assert_failure,_hQ_]}
        throw _l7_}}
    ...
    function address_of(status,v)
     {var a=lookup(status,v);
      try
       ...
       {_l4_ = caml_wrap_exception(_l4_);
        if(_l4_ === Not_found)
         {error(symbol(_hT_,v));
          error(symbol(_hU_,pp_expr$1(a)));
          var _l1_=status[7];
          error
           (symbol(_hW_,concat(_hV_,map(function(_l5_){return _l5_[1]},_l1_))));
     ...
     {if(typeof expr !== "number")
       switch(expr[0])
        {case 0:var v=expr[1];return lookup(status,v[2]);
         ...
         case 2:
          var e2=expr[2],e1=expr[1],_lX_=type_of_iexpr(status,e2);
          return [2,type_of_iexpr(status,e1),_lX_];
         case 3:
          var e2$0=expr[2],e1$0=expr[1],_lY_=type_of_iexpr(status,e2$0);
          return [3,type_of_iexpr(status,e1$0),_lY_];
         case 4:
          var e2$1=expr[2],e1$1=expr[1],_lZ_=type_of_iexpr(status,e2$1);
          return [4,type_of_iexpr(status,e1$1),_lZ_];
         case 5:
          var e2$2=expr[2],e1$2=expr[1],_l0_=type_of_iexpr(status,e2$2);
          return [5,type_of_iexpr(status,e1$2),_l0_];
    ...
    function type_of_pred(status,expr)
     {if(typeof expr !== "number")
       switch(expr[0])
        {case 1:
          var v$0=expr[1],_lR_=int_of_bool(1);
          return [3,lookup(status,symbol$0(status[6],v$0[2])),_lR_];
         case 7:
          var e2=expr[2],e1=expr[1],_lS_=type_of_iexpr(status,e2);
          return [1,type_of_iexpr(status,e1),_lS_];
         case 8:
          var e2$0=expr[2],e1$0=expr[1],_lT_=type_of_iexpr(status,e2$0);
          return [2,type_of_iexpr(status,e1$0),_lT_];
         case 9:
          switch(expr[1])
           {case 0:return _hY_;
            case 1:
             var e2$1=expr[3],e1$1=expr[2],_lU_=type_of_iexpr(status,e2$1);
             return [3,type_of_iexpr(status,e1$1),_lU_];
            case 2:
             var
              e2$2=expr[3],
              e1$2=expr[2],
            ...
            default:
             ...
             return [3,a1$0,a2$0]}
         case 10:
          var e2$4=expr[2],e1$4=expr[1],_lV_=type_of_pred(status,e2$4);
          return [4,type_of_pred(status,e1$4),_lV_];
         case 11:
          var e2$5=expr[2],e1$5=expr[1],_lW_=type_of_pred(status,e2$5);
          return [5,type_of_pred(status,e1$5),_lW_];
         case 12:var p=expr[1];return [6,type_of_pred(status,p)];
         case 13:var b=expr[1];return [0,b]
         }
      var v=expr[1],_lQ_=int_of_bool(1);
      return [3,lookup(status,v[2]),_lQ_]}
    ...
    function revert(status)
     {var _lP_=op(status[1],status[1]);
      return [0,map(function(v){return [1,v]},_lP_)]}
    function commit(status)
     {var
       _lL_=status[2],
       _lM_=map(function(_lO_){return lookup(status,_lO_)},_lL_),
       _lN_=status[1];
      return [0,op(map(function(v){return [1,v]},_lN_),_lM_)]}
      ...
      for(;;)
       {if(param)
         {var _lI_=param[1];
          ...
          continue}
        if(acc$0)
         {var _lJ_=acc$0[1],_lK_=_lJ_[1];
          if(0 === _lK_[0] && 0 !== _lK_[1] && ! acc$0[2])
           {var l$0=_lJ_[2];return caml_call1(f,l$0)}}
        var
         aux=
          function(param)
           {if(param)
       ...
       {if(public_methods === 0)
         ...
         {var l=public_methods.length - 1;
          ...
          var
           ...
           _ly_=public_methods.length - 1 - 1 | 0,
           _lx_=0;
          if(! (_ly_ < 0))
           {var i$0=_lx_;
            for(;;)
             {var met=public_methods[1 + i$0],lab=(i$0 * 2 | 0) + 2 | 0;
              ...
              var _lz_=i$0 + 1 | 0;
              if(_ly_ !== i$0){var i$0=_lz_;continue}
              break}}
          var _lA_=table}
        var
         _lB_=new_variable(_lA_,_h1_),
         label=get_method_label(_lA_,_h2_),
         element=
          function(self_1)
           {var env=self_1[1 + _lB_],_lF_=env[1];
            return function(_lG_,_lH_){return type_of_expr(_lF_,_lG_,_lH_)}};
        method_count[1]++;
        if(caml_call2(Labs[27],label,_lA_[4]))
         {resize$0(_lA_,label + 1 | 0);
          caml_check_bound(_lA_[2],label)[1 + label] = element}
        else
         _lA_[6] = [0,[0,label,element],_lA_[6]];
        var
         _lC_=
          function(_lE_)
           {var obj=caml_obj_block(248,_lA_[1]);
            obj[1] = _lA_[2];
            var _lD_=caml_set_oo_id(obj);
            _lD_[1 + _lB_] = _lE_;
            return _lD_};
        inst_var_count[1] = (inst_var_count[1] + _lA_[1] | 0) - 1 | 0;
        _lA_[8] = rev(_lA_[8]);
        resize$0
         (_lA_,3 + ((caml_check_bound(_lA_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
        _h0_[1] = _lC_}
      return caml_call1(_h0_[1],[0,status])}
    function type_of_call0(status,addr,meth,value,sender,params)
     {var _ln_=tag_list_length(meth[2]);
      if(length(params) === _ln_)
       {var
          ...
          function(i)
           {if(status[4] < i)return 0;
            ...
            return [0,
                    ...
                    _lt_]},
         stack$0=aux(1),
         _lo_=op([0,sender,[0,value,params]],stack$0),
         _lp_=status[2],
         _lq_=op(map(function(_ls_){return lookup(status,_ls_)},_lp_),_lo_),
         _lr_=status[1],
         args=op(map(function(v){return [1,v]},_lr_),_lq_);
        return [1,name,args]}
    ...
    function match_method(status,addr,meth,params)
     {try
       ...
       {_lm_ = caml_wrap_exception(_lm_);
        if(_lm_ === Not_found)throw [0,Assert_failure,_h4_];
        throw _lm_}
       ...
       {var meths$0=meths;
        for(;;)
         {if(meths$0)
          ...
          throw Not_found}}
      try
       {var _li_=[0,aux(meth,params,meths)];return _li_}
      catch(_lj_)
       {_lj_ = caml_wrap_exception(_lj_);
        if(_lj_ === Not_found)
         try
          {var _lh_=[0,aux(fallback,0,meths)];return _lh_}
         catch(_lk_)
          {_lk_ = caml_wrap_exception(_lk_);
           if(_lk_ === Not_found)return 0;
           throw _lk_}
        throw _lj_}}
    function transfer(status$1,to,amount,k)
     {var
       ...
       _lg_=revert(status$1),
       _le_=[3,lookup(status$1,symbol$0(from,balance)),amount],
       status=assign(symbol$0(from,balance),_le_,status$1),
       _lf_=[2,lookup(status,symbol$0(to,balance)),amount],
       status$0=assign(symbol$0(to,balance),_lf_,status);
      return if_then_else
     ...
     {var
      ...
      if(match)
       {var
         ...
         payable=match$0[2],
         meth$0=match$0[1],
         _la_=0 !== eq_tag(tag,0)?1:0,
         output_type_ok=_la_ || (0 !== eq_tag(tag,meth$0[1])?1:0),
         payable_ok=payable || (0 === value?1:0);
        if(output_type_ok && payable_ok)
         {var
           amount=
            fold(_hZ_,function(_ld_){return type_of_iexpr(status,_ld_)},value),
           _lb_=meth$0[2],
           params$1=expr_list_map(type_of_expr_poly(status),_lb_,params$0);
                               ...
                               (status,
                                ...
                                function(_lc_)
                                 {return type_of_call0
                                          (_lc_,addr$0,meth$0,amount,sender,params)})})}
        return revert(status)}
      return revert(status)}
     ...
     {function aux(guard,param)
       {if(param)
         {var
           ...
           typ=match[2],
           g=match[1],
           _k$_=caml_equal(guard,_h6_)?g:[5,guard,g];
          return [0,[0,g,typ],aux(_k$_,tl)]}
        return 0}
       ...
       {if(typeof stm$0 === "number")
         ...
         switch(stm$0[0])
          {case 0:
            var _kH_=stm$0[1];
            if(0 === _kH_[0])
             {var e=_kH_[1],e$0=type_of_expr(status$0,tag,e);
              if(345791162 <= e$0[1])
               {var
                 p=e$0[2],
             ...
             {var _kK_=_kI_[2];
              if
               (_kK_
                ...
                &&
                !
                caml_string_notequal(_kI_[3],_h9_))
               {var args1$0=_kH_[4],val1$0=_kH_[3];
                return msg_transfer
                        (status$0,
                         _kJ_,
                         val1$0,
                         args1$0,
                         function(_k9_){return type_of_cont(_k9_,int_of_unit)})}}
            var args1=_kH_[4],val1=_kH_[3],sender=int_of_address(status$0[6]);
            return type_of_call(status$0,tag,_kJ_,_kI_,val1,sender,args1);
           case 1:
            var _kL_=stm$0[1],_kM_=stm$0[2];
            if(0 === _kM_[0])
             {var stm$1=stm$0[3],e$2=_kM_[1],lhs_tag=tag_of_lhs(_kL_);
              if(typeof _kL_ === "number")
               var lhs=0;
              else
               if(0 === _kL_[0])
                var f=_kL_[1],lhs=[0,symbol$0(status$0[6],f[2])];
               else
                var v=_kL_[1],lhs=[0,v[2]];
              if(lhs)
              ...
              continue}
            if(typeof _kL_ === "number")
             {var _kN_=stm$0[2],_kO_=_kN_[2];
              if(0 === _kO_[1])
               {var _kP_=_kO_[2];
                if(_kP_ && 1 === _kP_[1] && ! _kP_[2])
                 {var _kY_=_kN_[1];
                  if(! caml_string_notequal(_kO_[3],_h__))
                   {var stm$2=stm$0[3],args1$1=_kN_[4],val1$1=_kN_[3];
                    return msg_transfer
                            (status$0,
                             _kY_,
                             val1$1,
                             args1$1,
                             function(_k8_){return type_of_stm(_k8_,tag,stm$2)})}}}}
            var _kQ_=stm$0[3],switch$0=0;
             ...
             {var
              ...
              if(0 !== _kR_[0] && ! _kR_[3])
               {var
                 ...
                 a2=_kR_[1],
                 _kX_=m2[2],
                 args2$0=expr_list_map(type_of_expr_poly(status$0),_kX_,args2),
                        ...
                        (status$0,
                         ...
                         function(args2)
                          {var
                            ...
                            _k0_=length(l),
                            l$0=op(l,mk_list(bottom,status$0[5] - _k0_ | 0)),
                            gamma=[0,status$0[3]],
                            _k1_=status$0[4],
                            _k2_=status$0[5] + 1 | 0;
                           if(! (_k1_ < _k2_))
                            {var i=_k1_;
                             for(;;)
                              {var
                               ...
                               =
                               assign_gamma
                                (symbol$0(stack,caml_string_of_jsbytes("" + i)),_k6_,_k4_);
                               var _k7_=i - 1 | 0;
                               if(_k2_ !== i){var i=_k7_;continue}
                               break}}
                           var n=1,param=l$0;
                           for(;;)
                            {if(param)
                              {var tl=param[2],hd=param[1],_k3_=gamma[1];
                               gamma[1]
                               =
                               assign_gamma
                                (symbol$0(stack,caml_string_of_jsbytes("" + n)),hd,_k3_);
                             ...
                             var
                              status=
                               [0,
                                ...
                                status$0[7]];
                             return type_of_call
                                     (status,tag_of_lhs(_kL_),_kW_,_kV_,_kU_,sender$0,_kT_)}})}}
            break;
           default:
            var _kZ_=stm$0[4];
            if(typeof _kZ_ === "number" && 2 <= _kZ_)
             {var
               stm2=stm$0[3],
               stm1=stm$0[2],
               guard=stm$0[1],
    ...
    function args_of_var_list(param)
     {if(param)
       {var tl=param[2],n=param[1],_kF_=args_of_var_list(tl),_kG_=n[2];
        return [0,[0,0 !== eq_tag(3,n[1])?1:0,_kG_],_kF_]}
      return 0}
    function type_of_a_method0
     (k$1,frame_size,fields,contracts,this$0,name,args,locals,typ_of)
     {var
       fields$0=map(function(_kE_){return _kE_[2]},fields),
       args$0=map(function(_kD_){return _kD_[2]},args),
       locals$0=map(function(_kC_){return _kC_[2]},locals),
       ...
       {if(opt)var sth=opt[1],acc=sth;else var acc=0;
        if(0 === k)
         {var
           ...
           _kA_=map(function(v){return [0,v,bottom]},locals$0),
           gamma=op(map(function(v){return [0,v,[1,v]]},other_params),_kA_),
           status=
            [0,saved_gamma,fields$0,gamma,k$1,frame_size,this$0,contracts],
           typ=caml_call1(typ_of,status),
           _kB_=op(saved_gamma,other_params);
          return [0,string_of_meth(this$0,name),_kB_,typ]}
        var
         k$0=k - 1 | 0,
         ...
         (fold_left
           (function(acc,contr)
             {var
               ...
               accu=0,
               param=fields,
               _kx_=[0,[0,0,symbol$0(a$0,balance)],0];
              for(;;)
               {if(param)
                 {var
                   l=param[2],
                   a=param[1],
                   f=a[1],
                   _ky_=symbol$0(a$0,f[2]),
                   accu$0=[0,[0,0 !== eq_tag(f[1],3)?1:0,_ky_],accu],
                   accu=accu$0,
                   param=l;
                  continue}
                return op(op(accu,_kx_),acc)}},
            _j8_,
            cfg)),
       _j9_=0,
       program_rev=
        fold_left
         (function(acc,contr)
           {var fb=contr[3],meths=contr[2],a=contr[1];
            error(symbol(a,symbol(_h$_,pp_expr$1(int_of_address(a)))));
            if(fb)
             var
              fb$0=fb[1],
              _ks_=op(meths,[0,any_method_decl_of_fallback(fb$0),0]);
            else
             var _ks_=meths;
            var _kt_=0;
            return op
                                         ...
                                         (status,
                                          ...
                                          function(a,param)
                                           {var
                                             ...
                                             _kw_=aux(assign(v,a$0,status),tl);
                                            return [0,[3,lookup(status,v),a$0],_kw_]})}
                               var stm=block[3];
                           ...
                           return [0,
                                   type_of_a_method0
                                    (k$0,
                                     ...
                                     args$0,
                                     locals$0,
                                     function(_kv_){return aux(_kv_,to_sum_on)}),
                                   acc]}},
                       _kt_,
                       _ks_),
                     acc)},
                ...
                {var i$0=_ke_;
                 for(;;)
                  {var
                   ...
                   =
                   assign_gamma
                    (symbol$0(stack,caml_string_of_jsbytes("" + i$0)),_km_,_kk_);
                   var _kn_=i$0 + 1 | 0;
                   if(_kf_ !== i$0){var i$0=_kn_;continue}
                   break}}
               var
                _kg_=(status$0[4] - status$0[5] | 0) + 1 | 0,
                _kh_=status$0[4];
               if(! (_kh_ < _kg_))
                {var i=_kg_;
                 for(;;)
                  {var _ki_=gamma[1];
                   ...
                   =
                   assign_gamma
                    (symbol$0(stack,caml_string_of_jsbytes("" + i)),bottom,_ki_);
                   var _kj_=i + 1 | 0;
                   if(_kh_ !== i){var i=_kj_;continue}
                   break}}
               var
                read=
                 function(i)
                  {if(status$0[5] < i)return 0;
                   var _kq_=read(i + 1 | 0),_kr_=status$0[3];
                   return [0,
                           lookup_gamma
                            (symbol$0(stack,caml_string_of_jsbytes("" + i)),_kr_),
                           _kq_]},
                status=
                 [0,
                  status$0[1],
                                  ...
                                  function(addr$0,meths)
                                   {function f(param)
                                     {var
                                      ...
                                      return [0,[3,meth,int_of_meth(meth$0)],_kp_]}
                                    var _ko_=tchoice(status,map(f,meths));
                                    return [0,[3,addr,int_of_address(addr$0)],_ko_]})}}}}
                 throw [0,Assert_failure,_hR_]}
               throw [0,Assert_failure,_hS_]}
             return commit(status$0)}),
         _j__],
       types=op(rev(program_rev),_j$_);
      return [0,types,fieldsno,balances]}
    var NotLinear=[248,_ia_,caml_fresh_oo_id(0)];
    function compute_expr(param)
     {switch(param[0])
       {case 0:var n=param[1];return [1,n];
        case 1:var v=param[1];return [0,v];
        case 2:
         var e2=param[2],e1=param[1],_j3_=compute_expr(e2);
         return [2,compute_expr(e1),_j3_];
        case 3:
         var e2$0=param[2],e1$0=param[1],_j4_=compute_expr(e2$0);
         return [3,compute_expr(e1$0),_j4_];
        case 4:
         var _j5_=param[1];
         if(0 === _j5_[0])
          {var e2$1=param[2],n$0=_j5_[1];return [4,n$0,compute_expr(e2$1)]}
         throw NotLinear;
        case 5:
         var _j6_=param[2],_j7_=param[1];
         if(0 === _j6_[0]){var n$1=_j6_[1];return [5,compute_expr(_j7_),n$1]}
         throw NotLinear;
    ...
    function atomic_neg(param)
     {var e2=param[3],p=param[2],e1=param[1];
      switch(p)
       {case 0:var _j2_=_ib_;break;
        case 1:var _j2_=_ic_;break;
        case 2:var _j2_=_id_;break;
        case 3:var _j2_=_ie_;break;
        default:var _j2_=_if_}
      return map(function(op){return [0,e1,op,e2]},_j2_)}
         ...
         var
          ...
          conjl_disj_conj=
           map
            (function(conjl)
              {var
                _j1_=flatten(map(atomic_neg,conjl)),
                disj=map(function(x){return [0,x,0]},_j1_);
               return disj},
             disjl);
     ...
     {switch(param[0])
       {case 0:
        ...
        case 1:
         ...
         return [0,[0,fcall,0,_ig_,[0,[0,f,el$1],0],0],0];
        default:
         var l$2=param[1];
         return flatten
                 (map
        ...
        {case 0:return stm1;
         ...
         default:
          var
           ...
           _j0_=retype_stm(stm_concat(stmb,cont$1));
          return [2,g,retype_stm(stm_concat(stma,cont$1)),_j0_,2]}}
            ...
            function(param)
             {var
              ...
              if(typeof _jP_ === "number")
               ...
               if(0 === _jP_[0])
                var v=_jP_[1],_jY_=[0,[0,_jP_],[0,v[1],[1,v]]];
               else
                var v$0=_jP_[1],_jY_=[0,[0,_jP_],[0,v$0[1],[0,v$0]]];
              var
               match$0=_jY_[2],
               ret_param=match$0[2],
               lhs_tag=match$0[1],
              ...
              return [0,
                      ...
                      [1,_jP_,rhs,[0,[1,0,name,0,aparams]]]]};
          if(typeof _jP_ === "number")
           {if(typeof cont$0 === "number" && 1 === cont$0)
             return [0,meths,[0,rhs]]}
          else
           if(1 === _jP_[0] && typeof cont$0 !== "number" && 0 === cont$0[0])
            {var _jR_=cont$0[1],_jS_=_jP_[1];
             if(0 === _jR_[0])
              {var _jT_=_jR_[1];
    ...
    function normalize(_jO_){return map(norm_a_contract,_jO_)}
    var Cycle=[248,_iq_,caml_fresh_oo_id(0)];
     ...
     {var
      ...
      for(;;)
       {if(param$0)
        ...
        var _jN_=match$0[2];
        if(0 === _jN_[1]){var cycle=_jN_[2];throw [0,Cycle,cycle]}
        return [0,tbl,0]}}
           ...
           (function(param)
             {var fb=param[3],ms=param[2],a$0=param[1],switch$0=0;
              if(typeof aexpr === "number")
               if(0 === aexpr)
                var _jF_=caml_string_equal(a$0,this$0);
               else
                switch$0 = 1;
              else
               if(13 === aexpr[0])
                var a=aexpr[1],_jF_=caml_string_equal(a$0,a);
               else
                switch$0 = 1;
              if(switch$0)var _jF_=1;
              if(_jF_)
               {var
                 _jG_=
                  caml_call1
                   (find_all
                     (function(param)
                       {var
                         m=param[1],
                         _jL_=caml_string_equal(meth[3],m[3]),
                         _jM_=_jL_?0 !== eq_tag_list(meth[2],m[2])?1:0:_jL_;
                        return _jM_}),
                    ms);
                if(_jG_)
                 {if(_jG_[2])throw [0,Assert_failure,_d8_];
                  var m=_jG_[1],matched=[0,[0,a$0,m],0]}
                else
                 if(fb)
                  var
                   fb$0=fb[1],
                        ...
                        (find_all
                          (function(param)
                            {var
                             ...
                             if(_jI_)
                              var
                               _jJ_=0 !== eq_tag(meth[1],0)?1:0,
                               _jK_=_jJ_ || (0 !== eq_tag(meth[1],m[1])?1:0);
                             else
                              var _jK_=_jI_;
                             return _jK_}),
                         matched)}
               ...
               {var _jB_=_jA_[2];
                if
                 (_jB_
                  ...
                  &&
                  !
                  caml_string_notequal(_jA_[3],_is_))
            ...
            (function(tbl,param)
              {var fallback=param[3],methods=param[2],addr=param[1];
               if(fallback)
                var
                 fb=fallback[1],
                 _jy_=[0,any_method_decl_of_fallback(fb),methods];
               else
                var _jy_=methods;
               return fold_left
                       (function(tbl,m)
    ...
    var _iJ_=0;
    function _iK_(m,param){var b=param[2];return max(m,maxargs_block(b))}
    var _iL_=0;
    function _iM_(m,param)
     {var
       fallback=param[3],
       methods=param[2],
       _jv_=fold(0,maxargs_block,fallback);
      return max(m,max(fold_left(_iK_,_iJ_,methods),_jv_))}
     ...
     {var match$0=get_bounds(cfg);
      if(0 === match$0[0])
       {var
         ...
         max_stack=
          fold_left
           (function(m,param){var n=param[2];return max(m,n)},_jr_,l$0);
        return caml_call3(f,l$0,fold_left(_iM_,_iL_,cfg),max_stack)}
      var l$1=match$0[1];
      if(l$1)
       {var
         l=l$1[2],
         ...
         m=match[1],
         a=_jo_[1],
         _jp_=symbol(_iv_,symbol(a,symbol(_iu_,symbol(pp_meth(0,m),_it_)))),
         _jq_=rev(l);
        return symbol
                (_iD_,
                 symbol
                  (fold_left
                    (function(acc,param)
                      {var
                        ...
                        m=match[1],
                        a=_js_[1],
                        _jt_=is_tail?_iy_:_iC_,
                        _ju_=symbol(_iz_,symbol(_jt_,_ix_));
                       return symbol
                               (acc,
                                symbol
                                 (_iB_,symbol(a,symbol(_iA_,symbol(pp_meth(0,m),_ju_)))))},
                     _iw_,
                     _jq_),
                   _jp_))}
    ...
    set_error
     (function(msg)
       {var errors=document.getElementById("errors");
        if(errors == no_handler)throw [0,Assert_failure,_iN_];
        appendChild
    ...
    function transform(f,param)
     {var
      ...
      doc_out.setValue(y);
      return 0}
    function _iO_(_jn_){return test_string(pp_configuration,_jn_)}
    function parse(_jm_){return transform(_iO_,_jm_)}
    function _iP_(c){return pp_configuration(normalize(c))}
    function _iQ_(_jl_){return test_string(_iP_,_jl_)}
    function normalize$0(_jk_){return transform(_iQ_,_jk_)}
    function _iR_(c)
     {var c$0=normalize(c);
                      ...
                      (_iU_,
                       symbol
                        (caml_string_of_jsbytes("" + m),
                         symbol(_iT_,symbol(_iS_,caml_string_of_jsbytes("" + n))))));
                 return symbol
                         (fold_left
                           (function(acc,param)
                             {var
                               ...
                               m=match[1],
                               a=_ji_[1],
                               _jj_=symbol(_iG_,caml_string_of_jsbytes("" + b));
                              return symbol
                                      (acc,
                                       symbol
                                        (_iI_,symbol(a,symbol(_iH_,symbol(pp_meth(0,m),_jj_)))))},
                            _iF_,
                            bounds),
                          _jh_)},
               c$0)}
    function _iW_(_jg_){return test_string(_iR_,_jg_)}
    function get_bounds$0(_jf_){return transform(_iW_,_jf_)}
    function _iX_(c)
     {var c$0=normalize(c);
      return with_maxargs_and_stack_bound
              (function(param,max_args,max_stack)
               ...
               c$0)}
    function _iY_(_je_){return test_string(_iX_,_je_)}
    function type_of$0(_jd_){return transform(_iY_,_jd_)}
    function cost(b)
     {var _i9_=0;
      function _i__(c)
       {var c$0=normalize(c);
        return with_maxargs_and_stack_bound
                (function(param$0,max_args,max_stack)
                  {var
                    ...
                    _ja_=map(function(v){return [0,[0,v],0,_ii_]},balances),
                    _jb_=0,
                    l$0=
                     [0,
                      [0,
                       ...
                       0,
                       _ij_,
                       [0,[0,name,map(function(x){return [0,x]},args)],_jb_],
                       _ja_],
                      _jc_];
                   return concat(_cv_,map(pp_eqn,l$0))},
                 c$0)}
      return transform(function(_i$_){return test_string(_i__,_i$_)},_i9_)}
    function copy_output_to_input(param)
     {var doc_in=window.doc_out,x=doc_in.getValue(),doc_out=window.doc_in;
      doc_out.setValue(x);
      return 0}
    export$0(_iZ_,caml_js_wrap_callback(parse));
    export$0(_i0_,caml_js_wrap_callback(normalize$0));
    export$0(_i1_,caml_js_wrap_callback(get_bounds$0));
    export$0(_i2_,caml_js_wrap_callback(type_of$0));
    export$0(_i3_,caml_js_wrap_callback(cost));
    export$0(_i4_,caml_js_wrap_callback(copy_output_to_input));
    do_at_exit(0);
    return}
