...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _i5_=caml_new_string("OCAMLRUNPARAM"),
     _i3_=caml_new_string("CAMLRUNPARAM"),
     ...
     _iu_=[0,1],
     _iH_=caml_new_string("transfer"),
     _iE_=caml_new_string("# "),
     _iF_=caml_new_string(" : "),
     _iG_=caml_new_string("# "),
     _iI_=caml_new_string("transfer"),
     _iD_=[0,caml_new_string("typeInference.ml"),433,9],
     _iB_=[0,0],
     _iC_=[0,0],
     ...
     _iO_=caml_new_string("Maximum stack length: "),
     _iP_=caml_new_string("\n"),
     _iQ_=caml_new_string("Maximum number of locals: "),
     _iR_=caml_new_string("\n\n"),
     _iJ_=[0,caml_new_string("analyzer.ml"),7,85],
     _iX_=caml_new_string("ms_parse"),
     _iY_=caml_new_string("ms_normalize"),
     _iZ_=caml_new_string("ms_get_bounds"),
     _i0_=caml_new_string("ms_type_of"),
     _i1_=caml_new_string("ms_cost"),
     _i2_=caml_new_string("ms_copy_output_to_input");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_yM_ = caml_wrap_exception(_yM_);
              if(_yM_[1] !== Sys_error)throw _yM_;
              var _yL_=_yM_}
            var param$0=l;
            continue}
          return 0}}
       ...
       if(0 <= len)
        if((caml_ml_bytes_length(b) - len | 0) < ofs)
         ...
         {var r=caml_create_bytes(len);
          ...
          var _yK_=r,switch$0=1}
       else
        var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _yK_=invalid_arg(_n_);
      return caml_string_of_bytes(_yK_)}
    ...
    function concat(sep,l)
     {if(l)
       {var seplen=caml_ml_string_length(sep),acc=0,param=l,pos$1=0;
        for(;;)
         {if(param)
           {var _yF_=param[2],_yG_=param[1];
            if(_yF_)
             {var
               x=(caml_ml_string_length(_yG_) + seplen | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_q_),
               acc=acc$0,
               param=_yF_;
              continue}
            var _yJ_=caml_ml_string_length(_yG_) + acc | 0}
          else
           var _yJ_=acc;
          var dst=caml_create_bytes(_yJ_),pos=pos$1,param$0=l;
          for(;;)
           {if(param$0)
             {var _yH_=param$0[2],_yI_=param$0[1];
              if(_yH_)
               {caml_blit_string(_yI_,0,dst,pos,caml_ml_string_length(_yI_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_yI_) | 0,seplen);
                var
                 pos$0=(pos + caml_ml_string_length(_yI_) | 0) + seplen | 0,
                 pos=pos$0,
                 param$0=_yH_;
                continue}
              caml_blit_string(_yI_,0,dst,pos,caml_ml_string_length(_yI_))}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(! (l < i))
        try
         {index_rec(s,l,i,c);var _yD_=1;return _yD_}
        catch(_yE_)
    ...
    function _C_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_yC_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_yx_=height(lr);
            if(_yx_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _yy_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_yy_)}
            return invalid_arg(_u_)}
          return invalid_arg(_v_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_yz_=height(rl);
            if(_yz_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _yA_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_yA_)}
            return invalid_arg(_w_)}
          return invalid_arg(_x_)}
        var _yB_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_yB_]}
      var empty=0;
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _yu_=param$0[1];
            if(_yu_){var param$0=_yu_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _yr_=param$0[4],_ys_=param$0[3],_yt_=param$0[2];
            if(_yr_){var param$0=_yr_;continue}
            return [0,_yt_,_ys_]}
          throw Not_found}}
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _yo_=param$0[4],_yp_=param$0[3],_yq_=param$0[2];
            if(_yo_){var param$0=_yo_;continue}
            return [0,[0,_yq_,_yp_]]}
          return 0}}
         ...
         {var _yn_=param[1];
          if(_yn_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_yn_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_y_)}
      function _x2_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _yk_=caml_call2(p,v,d);
            if(_yk_)
             {var _yl_=for_all(p,l);
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _yh_=caml_call2(p,v,d);
            if(_yh_)
             var _yi_=_yh_;
            else
             {var _yj_=exists(p,l);
              if(! _yj_){var param$0=r;continue}
              var _yi_=_yj_}
            return _yi_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _yd_=merge(f,r1,r2),
             _ye_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_ye_,_yd_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _yf_=merge(f,r1$0,r2$0),
           _yg_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_yg_,_yf_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _yb_=concat(lf,rf);return [0,join(lt,v,d,rt),_yb_]}
          var _yc_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_yc_]}
        return _B_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _x__=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_x__)
               {var _x$_=caml_call2(cmp,d1,d2);
                if(_x$_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_x9_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _x9_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_x7_=cons_enum(t,rest);
          return [0,[0,k,v],function(_x8_){return seq_of_enum(_x7_,_x8_)}]}
        return 0}
      function to_seq(m)
       {var _x5_=cons_enum(m,0);
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _x3_=c;
          return function(_x4_){return seq_of_enum(_x3_,_x4_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function fill_buff(b)
     {var len=caml_ml_bytes_length(b[2]),_xZ_=b[2],_x0_=b[1];
      if(0 <= len)
       if((caml_ml_bytes_length(_xZ_) - len | 0) < 0)
        var switch$0=0;
       else
        var _x1_=caml_ml_input(_x0_,_xZ_,0,len),switch$0=1;
      else
       var switch$0=0;
      if(! switch$0)var _x1_=invalid_arg(_e_);
      b[3] = _x1_;
      b[4] = 0;
      return 0}
          ...
          {case 1:
           ...
           case 2:
            var
             f=d$0[1],
             _xV_=caml_obj_tag(f),
             d$1=250 === _xV_?f[1]:246 === _xV_?force_lazy_block(f):f,
             d$0=d$1;
            continue;
           case 3:
            var _xW_=d$0[1],_xX_=_xW_[1];
            if(_xX_)
             {var _xY_=_xX_[1];
              if(_xY_){var a$0=_xY_[1];_xW_[1] = 0;return [0,a$0,d$0]}
              return 0}
            var match$0=caml_call1(_xW_[2],count);
     ...
     {for(;;)
       {var _xQ_=s[2];
        if(typeof _xQ_ === "number")
         ...
         switch(_xQ_[0])
          {case 0:var a=_xQ_[1];return [0,a];
           case 1:
           ...
           case 2:
            var
             f=_xQ_[1],
             _xR_=caml_obj_tag(f),
             _xS_=250 === _xR_?f[1]:246 === _xR_?force_lazy_block(f):f;
            s[2] = _xS_;
            continue;
           case 3:
            var _xT_=_xQ_[1],_xU_=_xT_[1];
            if(_xU_){var a$1=_xU_[1];return a$1}
            var x=caml_call1(_xT_[2],s[1]);
            _xT_[1] = [0,x];
            return x;
           default:
            var b=_xQ_[1];
        ...
        for(;;)
         {var _xO_=data[2];
          if(typeof _xO_ !== "number")
           switch(_xO_[0])
            {case 0:
              var d=_xO_[2];data[1] = data[1] + 1 | 0;data[2] = d;return 0;
             case 3:
              var _xP_=_xO_[1];
              if(_xP_[1]){data[1] = data[1] + 1 | 0;_xP_[1] = 0;return 0}
              break;
             case 4:
              var b=_xO_[1];
              if(b[3] <= b[4])fill_buff(b);
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _xo_=function(param){return 0},
         _xp_=function(param){return 0},
         _xq_=function(param){return 0};
        return [0,function(param){return 0},_xq_,_xp_,_xo_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _xr_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_xr_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _xs_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _xt_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _xu_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _xv_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _xw_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _xx_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _xy_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _xz_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _xA_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _xB_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _xC_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _xD_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _xE_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _xF_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _xG_=function(param){caml_call1(de$12,0);return 0},
           _xH_=function(param){caml_call1(ed$12,0);return 0},
           _xI_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _xJ_=function(param){caml_call1(de$13,0);return 0},
           _xK_=function(param){caml_call1(ed$13,0);return 0},
           _xL_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_w7_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_w8_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_w9_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_w__,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_w$_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_xa_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_xb_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_xc_,rest2$6)];
          ...
          break;
         case 8:
          var _xd_=ty1[2],_xe_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_xf_=trans(_xd_,rest2$7);
              return [8,trans(_xe_,ty2),_xf_];
          ...
          break;
         case 9:
          var _xg_=ty1[3],_xh_=ty1[2],_xi_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_xh_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_xi_,ty22,trans(_xg_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_xj_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_xk_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_xl_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_xm_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_xn_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _w6_=match[2];
        if(typeof _w6_ !== "number" && 2 === _w6_[0])
         {var rest$0=_w6_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
         ...
         case 2:
          ...
          if(typeof _wC_ !== "number" && 1 === _wC_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_wD_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _wE_=type_padding(pad$0,fmtty),
           _wF_=_wE_[2],
           _wG_=_wE_[1];
          if(typeof _wF_ !== "number" && 1 === _wF_[0])
           {var
             fmtty_rest$2=_wF_[1],
             match$2=type_format_gen(fmt_rest$2,fmtty_rest$2),
             fmtty$3=match$2[2],
             fmt$3=match$2[1];
            return [0,[3,_wG_,fmt$3],fmtty$3]}
          throw Type_mismatch;
         case 4:
          var
           fmt_rest$3=fmt[4],
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _wH_=type_padprec(pad$1,prec,fmtty),
           _wI_=_wH_[3],
           _wJ_=_wH_[2],
           _wK_=_wH_[1];
          if(typeof _wI_ !== "number" && 2 === _wI_[0])
           {var
             ...
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_wK_,_wJ_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _wL_=type_padprec(pad$2,prec$0,fmtty),
           _wM_=_wL_[3],
           _wN_=_wL_[2],
           _wO_=_wL_[1];
          if(typeof _wM_ !== "number" && 3 === _wM_[0])
           {var
             fmtty_rest$4=_wM_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_wO_,_wN_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _wP_=type_padprec(pad$3,prec$1,fmtty),
           _wQ_=_wP_[3],
           _wR_=_wP_[2],
           _wS_=_wP_[1];
          if(typeof _wQ_ !== "number" && 4 === _wQ_[0])
           {var
             fmtty_rest$5=_wQ_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_wS_,_wR_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _wT_=type_padprec(pad$4,prec$2,fmtty),
           _wU_=_wT_[3],
           _wV_=_wT_[2],
           _wW_=_wT_[1];
          if(typeof _wU_ !== "number" && 5 === _wU_[0])
           {var
             fmtty_rest$6=_wU_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_wW_,_wV_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _wX_=type_padprec(pad$5,prec$3,fmtty),
           _wY_=_wX_[3],
           _wZ_=_wX_[2],
           _w0_=_wX_[1];
          if(typeof _wY_ !== "number" && 6 === _wY_[0])
           {var
             fmtty_rest$7=_wY_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_w0_,_wZ_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _w1_=type_padding(pad$6,fmtty),
           _w2_=_w1_[2],
           _w3_=_w1_[1];
          if(typeof _w2_ !== "number" && 7 === _w2_[0])
           {var
             fmtty_rest$8=_w2_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_w3_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _w4_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_w4_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _w5_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_w5_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_w5_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _wz_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_wz_))
             throw Type_mismatch;
            var _wA_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_wA_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _wy_=2 === padty$0?48:32,res=make(width$0,_wy_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _ww_=match$0 - 32 | 0,
           switch$0=
            59 < _ww_ >>> 0?33 < (_ww_ - 61 | 0) >>> 0?1:0:2 === _ww_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _wp_=caml_ml_bytes_length(s$0) - 1 | 0,
           _wo_=0;
          if(! (_wp_ < 0))
           {var i$0=_wo_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _wt_=match - 34 | 0;
                if(58 < _wt_ >>> 0)
                 if(93 <= _wt_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_wt_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _wu_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _wu_=4;break;case 1:var _wu_=2;break}
              n[1] = n[1] + _wu_ | 0;
              var _wv_=i$0 + 1 | 0;
          ...
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _wr_=caml_ml_bytes_length(s$0) - 1 | 0,_wq_=0;
            if(! (_wr_ < 0))
             {var i=_wq_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _wx_=s}
          var str$0=caml_string_of_bytes(_wx_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_wj_=caml_ml_string_length(s) - 1 | 0,_wi_=0;
        if(! (_wj_ < 0))
         {var i$0=_wi_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _wn_=i$0 + 1 | 0;
            if(_wj_ !== i$0){var i$0=_wn_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _wl_=caml_ml_string_length(s) - 1 | 0,
         _wk_=0;
        if(! (_wl_ < 0))
         {var i=_wk_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _wh_=_az_;break;
        case 2:var _wh_=_aA_;break;
        case 4:var _wh_=_aC_;break;
        case 5:var _wh_=_aD_;break;
        case 6:var _wh_=_aE_;break;
        case 7:var _wh_=_aF_;break;
        case 8:var _wh_=_aG_;break;
        case 9:var _wh_=_aH_;break;
        case 10:var _wh_=_aI_;break;
        case 11:var _wh_=_aJ_;break;
        case 0:
        case 13:var _wh_=_ay_;break;
        case 3:
        case 14:var _wh_=_aB_;break;
        default:var _wh_=_aK_}
      return transform_int_alt(iconv,caml_format_int(_wh_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _wg_=_aZ_;break;
        case 2:var _wg_=_a0_;break;
        case 4:var _wg_=_a2_;break;
        case 5:var _wg_=_a3_;break;
        case 6:var _wg_=_a4_;break;
        case 7:var _wg_=_a5_;break;
        case 8:var _wg_=_a6_;break;
        case 9:var _wg_=_a7_;break;
        case 10:var _wg_=_a8_;break;
        case 11:var _wg_=_a9_;break;
        case 0:
        case 13:var _wg_=_aY_;break;
        case 3:
        case 14:var _wg_=_a1_;break;
        default:var _wg_=_a__}
      return transform_int_alt(iconv,caml_format_int(_wg_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _wf_=_ba_;break;
        case 2:var _wf_=_bb_;break;
        case 4:var _wf_=_bd_;break;
        case 5:var _wf_=_be_;break;
        case 6:var _wf_=_bf_;break;
        case 7:var _wf_=_bg_;break;
        case 8:var _wf_=_bh_;break;
        case 9:var _wf_=_bi_;break;
        case 10:var _wf_=_bj_;break;
        case 11:var _wf_=_bk_;break;
        case 0:
        case 13:var _wf_=_a$_;break;
        case 3:
        case 14:var _wf_=_bc_;break;
        default:var _wf_=_bl_}
      return transform_int_alt(iconv,caml_format_int(_wf_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _we_=_aM_;break;
        case 2:var _we_=_aN_;break;
        case 4:var _we_=_aP_;break;
        case 5:var _we_=_aQ_;break;
        case 6:var _we_=_aR_;break;
        case 7:var _we_=_aS_;break;
        case 8:var _we_=_aT_;break;
        case 9:var _we_=_aU_;break;
        case 10:var _we_=_aV_;break;
        case 11:var _we_=_aW_;break;
        case 0:
        case 13:var _we_=_aL_;break;
        case 3:
        case 14:var _we_=_aO_;break;
        default:var _we_=_aX_}
      return transform_int_alt(iconv,caml_int64_format(_we_,n))}
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_v__=l - 1 | 0,_v9_=0;
            if(! (_v__ < 0))
             {var i=_v9_;
              for(;;)
               {caml_bytes_unsafe_set(r,i,f(caml_bytes_unsafe_get(s,i)));
                ...
                break}}
            var _wa_=r}
          return caml_string_of_bytes(_wa_)}
        return s$0}
      if(15 === fconv)
       var _wb_=_bm_;
      else
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
            ...
            var _wd_=1}
          return _wd_?str:symbol(str,_bq_)}}
      return str}
    function make_int_padding_precision(k,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _v6_=pad[2],_v7_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_v7_,_v6_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_v7_,_v6_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_v7_,_v6_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _v8_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_v8_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_v8_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_v8_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _v2_=pad$5[2],_v3_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_v3_,_v2_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_v3_,_v2_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_v3_,_v2_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _v4_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_v4_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_v4_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_v4_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _v5_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _v5_[2] === "number")
              {var fmt=_v5_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_v1_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_v1_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _vY_=[8,acc,_bx_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_vY_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_vY_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_vX_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_vX_,rest])}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bD_;
      var _vT_=other_fields(x,i + 1 | 0),_vU_=field(x,i);
      return caml_call2(sprintf(_bE_),_vU_,_vT_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _vQ_=other_fields(x,2),_vR_=field(x,1);
        return caml_call2(sprintf(_bF_),_vR_,_vQ_)}
      switch(match)
       {case 0:return _bG_;
        case 1:return _bH_;
        default:var _vS_=field(x,1);return caml_call1(sprintf(_bI_),_vS_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _vO_=caml_call1(hd,x),_vN_=_vO_}catch(_vP_){var _vN_=0}
            if(_vN_){var s=_vN_[1];return s}
            var param$0=tl;
            continue}
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _vJ_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_vJ_;continue}
           var accu=[0,_bO_],_vF_=54 + max(55,l) | 0,_vE_=0;
           if(! (_vF_ < 0))
            {var i=_vE_;
             for(;;)
              {var
               ...
               var
                _vG_=accu[1],
                _vA_=caml_string_get(_vG_,3) << 24,
                _vB_=caml_string_get(_vG_,2) << 16,
                _vC_=caml_string_get(_vG_,1) << 8,
                _vD_=
                 ((caml_string_get(_vG_,0) + _vC_ | 0) + _vB_ | 0)
                 +
                 _vA_
                 |
                 0,
                _vH_=
                 (caml_check_bound(result[1],j)[1 + j] ^ _vD_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[1 + j] = _vH_;
               var _vI_=i + 1 | 0;
               if(_vF_ !== i){var i=_vI_;continue}
               break}}
           result[2] = 0;
           return result}}];
    ...
    function find$0(h,key)
     {var _vz_=indexfun(h,key),match=caml_check_bound(h[2],_vz_)[1 + _vz_];
      if(match)
    ...
    function f$0(s)
     {var accu=[0,0],_vw_=caml_ml_string_length(s) - 1 | 0,_vv_=0;
      if(! (_vw_ < 0))
       {var i=_vv_;
        for(;;)
         {var _vx_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _vx_ | 0;
          var _vy_=i + 1 | 0;
          if(_vw_ !== i){var i=_vy_;continue}
          break}}
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _vp_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _vp_;
      var _vr_=len - 1 | 0,_vq_=0;
      if(! (_vr_ < 0))
       {var i=_vq_;
        for(;;)
         {var
           _vt_=(i * 2 | 0) + 3 | 0,
           _vs_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_vt_)[1 + _vt_] = _vs_;
          var _vu_=i + 1 | 0;
          if(_vr_ !== i){var i=_vu_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_vm_=len < new_size?1:0;
      if(_vm_)
       {var
         ...
         switch$0=
          0 <= len
           ?(_vn_.length - 1 - len | 0) < 0
             ?0
             :(a2.length - 1 - len | 0) < 0
               ?0
               :(caml_array_blit(_vn_,0,a2,0,len),1)
           :0;
    ...
    function get_method_label(table,name)
     {try
       {var _vk_=caml_call2(Meths[27],name,table[3]);return _vk_}
      catch(_vl_)
       {_vl_ = caml_wrap_exception(_vl_);
        if(_vl_ === Not_found)
    ...
    function new_variable(table,name)
     {try
       {var _vi_=caml_call2(Vars[27],name,table[7]);return _vi_}
      catch(_vj_)
     ...
     {var x=16;
      for(;;)
       {if(! (17 <= x))
        ...
        if(random)
         {var
           _uK_=caml_obj_tag(prng),
           _uL_=250 === _uK_?prng[1]:246 === _uK_?force_lazy_block(prng):prng;
          _uL_[2] = (_uL_[2] + 1 | 0) % 55 | 0;
          var
           _uF_=_uL_[2],
           curval=caml_check_bound(_uL_[1],_uF_)[1 + _uF_],
           _uG_=(_uL_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_uL_[1],_uG_)[1 + _uG_]
            +
           ...
           _uH_=_uL_[2];
          caml_check_bound(_uL_[1],_uH_)[1 + _uH_] = newval30;
          var seed=newval30}
        else
         var seed=0;
         ...
         {if(param)
             ...
             {var
              ...
              if(nsize < max_array_length)
               {var
                 ...
                 _uI_=kwd_table.length - 1 < 4?1:0,
                 _uJ_=_uI_ || (kwd_table[4] < 0?1:0),
                 inplace=1 - _uJ_;
                kwd_table[2] = ndata;
                var _uN_=osize - 1 | 0,_uM_=0;
                if(! (_uN_ < 0))
                 {var i$0=_uM_;
                  a:
                  for(;;)
                    ...
                    for(;;)
                     {if(cell)
                       {var
                        ...
                        continue}
                      var _uR_=i$0 + 1 | 0;
                      if(_uN_ !== i$0){var i$0=_uR_;continue a}
                      break}
                    break}}
                if(inplace)
                 {var _uP_=nsize - 1 | 0,_uO_=0;
                  if(! (_uP_ < 0))
                   {var i=_uO_;
                    for(;;)
          ...
          var
           ident_or_keyword=
            function(id)
             {try
               {var _vg_=find$0(kwd_table,id);return _vg_}
              catch(_vh_)
               {_vh_ = caml_wrap_exception(_vh_);
                if(_vh_ === Not_found)return [1,id];
                throw _vh_}},
           keyword_or_error=
            function(c)
             {var s=make$0(1,c);
              try
               {var _ve_=find$0(kwd_table,s);return _ve_}
              catch(_vf_)
               {_vf_ = caml_wrap_exception(_vf_);
                if(_vf_ === Not_found)throw [0,Error,symbol(_bS_,s)];
                throw _vf_}},
           end_exponent_part=
            function(strm)
             {for(;;)
               {var match=peek(strm);
                if(match)
                 {var _vd_=match[1],switcher=_vd_ - 48 | 0;
                  if(! (9 < switcher >>> 0)){junk(strm);store(_vd_);continue}}
                return [0,[3,caml_float_of_string(get_string(0))]]}},
           exponent_part=
            function(strm)
             {var match=peek(strm);
              if(match)
               {var _vc_=match[1],switch$0=43 === _vc_?0:45 === _vc_?0:1;
                if(! switch$0)
                 {junk(strm);store(_vc_);return end_exponent_part(strm)}}
             ...
             {for(;;)
               {var match=peek(s);
                if(match)
                 {var _u$_=match[1];
                  if(58 <= _u$_)
                   {var switch$0=69 === _u$_?0:101 === _u$_?0:1;
                   ...
                   {if(46 === _u$_)
                     {junk(s);
                      ...
                      for(;;)
                       {var match$0=peek(s);
                        if(match$0)
                         {var _va_=match$0[1],_vb_=_va_ - 69 | 0;
                          if(32 < _vb_ >>> 0)
                           {var switcher=_vb_ + 21 | 0;
                            if(! (9 < switcher >>> 0)){junk(s);store(_va_);continue}}
                          else
                           {var switcher$0=_vb_ - 1 | 0;
                            if(30 < switcher$0 >>> 0)
                             {junk(s);store(69);return exponent_part(s)}}}
                        return [0,[3,caml_float_of_string(get_string(0))]]}}
                    if(48 <= _u$_){junk(s);store(_u$_);continue}}}
                ...
                if(match)
                 {var _u9_=match[1];
                  if(94 <= _u9_)
                   var
                    _u__=_u9_ - 95 | 0,
                    switch$0=30 < _u__ >>> 0?32 <= _u__?1:0:29 === _u__?0:1;
                  else
                   if(65 <= _u9_)
                    var switch$0=92 === _u9_?0:1;
                   else
                    if(33 <= _u9_)
                     switch(_u9_ - 33 | 0)
                      {case 0:
                     ...
                     var switch$0=1;
                  if(! switch$0){junk(strm);store(_u9_);continue}}
                return [0,ident_or_keyword(get_string(0))]}},
           neg_number=
            function(s)
             {var match=peek(s);
              if(match)
               {var _u8_=match[1],switcher=_u8_ - 48 | 0;
                if(! (9 < switcher >>> 0))
                 {junk(s);
                  reset_buffer(0);
                  store(45);
                ...
                if(match)
                 {var _u6_=match[1];
                  if(91 <= _u6_)
                   var
                    _u7_=_u6_ - 95 | 0,
                    switch$0=27 < _u7_ >>> 0?97 <= _u7_?0:1:1 === _u7_?1:0;
                  else
                   var
                    switch$0=
                     48 <= _u6_?6 < (_u6_ - 58 | 0) >>> 0?0:1:39 === _u6_?0:1;
                  if(! switch$0){junk(strm);store(_u6_);continue}}
                return [0,ident_or_keyword(get_string(0))]}},
           next_token$0=
             ...
             {for(;;)
               {var match=peek(strm);
                if(match)
                 {var _uW_=match[1];
                  if(124 <= _uW_)
                   var switch$0=127 <= _uW_?192 <= _uW_?1:0:125 === _uW_?0:2;
                  else
                   {var _uX_=_uW_ - 65 | 0;
                    if(57 < _uX_ >>> 0)
                     if(58 <= _uX_)
                        ...
                        {case 34:
                          ...
                          for(;;)
                           {var match$1=peek(strm);
                            if(match$1)
                             {var _uZ_=match$1[1];
                              if(34 === _uZ_){junk(strm);return [0,[4,get_string(0)]]}
                              if(92 === _uZ_)
                               {junk(strm);
                                try
                                 {var c$0=escape(strm)}
                                 ...
                                 {_u5_ = caml_wrap_exception(_u5_);
                                  if(_u5_ === Failure$0)throw [0,Error,_bV_];
                                  throw _u5_;
                                  var _u2_=_u5_}
                                store(c$0);
                                continue}
                          ...
                          try
                           {var match$2=peek(strm);
                            ...
                            if(92 === _u0_)
                             {junk(strm);
                              try
                               {var _u1_=escape(strm)}
                              catch(_u4_)
                               {_u4_ = caml_wrap_exception(_u4_);
                                if(_u4_ === Failure$0)throw [0,Error,_bW_];
                                throw _u4_}
                              var c=_u1_}
                            else
                             {junk(strm);var c=_u0_}}
                          catch(_u3_)
                           {_u3_ = caml_wrap_exception(_u3_);
                            if(_u3_ === Failure$0)throw [0,Error,_bT_];
                            throw _u3_}
                         ...
                         case 56:
                         case 57:
                          junk(strm);reset_buffer(0);store(_uW_);return number(strm);
                         case 33:
                         case 35:
                         case 36:
                         case 37:
                      ...
                      if(5 < _uY_ >>> 0)
                       ...
                       switch(_uY_)
                        {case 4:var switch$0=1;break;
                         ...
                         default:var switch$0=0}}}
                  switch(switch$0)
                   {case 0:junk(strm);return [0,keyword_or_error(_uW_)];
                    case 1:
                     junk(strm);reset_buffer(0);store(_uW_);return ident(strm);
                    default:
                     junk(strm);reset_buffer(0);store(_uW_);return ident2(strm)}}
                return 0}},
           maybe_comment=
            function(counter,strm)
             {var match=peek(strm);
                ...
                if(58 <= _uT_)
                 ...
                 if(48 <= _uT_)
                  {junk(strm);
                   var match$0=peek(strm);
                   if(match$0)
                    {var _uU_=match$0[1],switcher$0=_uU_ - 48 | 0;
                     if(! (9 < switcher$0 >>> 0))
                      {junk(strm);
                       var match$1=peek(strm);
                       if(match$1)
                        {var _uV_=match$1[1],switcher$1=_uV_ - 48 | 0;
                         if(! (9 < switcher$1 >>> 0))
                          {junk(strm);
                           var
                            n=
                     ...
                     default:
                      ...
                      for(;;)
                       {var match$1=peek(strm);
                        if(match$1)
                         {var _uS_=match$1[1];
                          if(41 === _uS_){junk(strm);return 0}
                          if(42 === _uS_){junk(strm);continue}
                          junk(strm);
                          continue b}
                        throw Failure$0}}
                  junk(strm);
    ...
    function pp_expr(param)
     {switch(param[0])
       {case 0:var v=param[1];return pp_var(v);
        ...
        case 2:
         var e2=param[2],e1=param[1],_uC_=symbol(_b$_,pp_expr(e2));
         return parens(symbol(pp_expr(e1),_uC_));
        case 3:
         var e2$0=param[2],e1$0=param[1],_uD_=symbol(_ca_,pp_expr(e2$0));
         return parens(symbol(pp_expr(e1$0),_uD_));
        case 4:
        ...
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _uE_=symbol(_cc_,caml_new_string("" + e2$2));
         return parens(symbol(pp_expr(e1$2),_uE_));
    ...
    function pp_acall(param)
     {var el=param[2],f=param[1];
      ...
      var _uB_=symbol(_cg_,symbol(concat(_cf_,map(pp_expr,el)),_ce_));
      return symbol(pp_func(f),_uB_)}
    function pp_pred(param)
     {var e2=param[3],o=param[2],e1=param[1],_uy_=symbol(_ch_,pp_expr(e2));
      switch(o)
       {case 0:var _uz_=_b4_;break;
        case 1:var _uz_=_b5_;break;
        case 2:var _uz_=_b6_;break;
        case 3:var _uz_=_b7_;break;
        default:var _uz_=_b8_}
      var _uA_=symbol(_ci_,symbol(_uz_,_uy_));
      return symbol(pp_expr(e1),_uA_)}
    function pp_eqn(param)
     {var
       ...
       _ut_=
        symbol(_cp_,symbol(_co_,symbol(concat(_cn_,map(pp_acall,cl)),_us_))),
       _uu_=pp_expr(e),
       _uv_=
        to_nat
         ?function(x){return symbol(_cq_,parens(x))}
         :function(x){return x},
       _uw_=symbol(_cr_,symbol(_uv_(_uu_),_ut_)),
       vl=call[2],
       f=call[1];
      if(0 === vl)
       var _ux_=pp_func(f);
       ...
       var
        _ur_=symbol(_b3_,symbol(concat(_b2_,map(pp_var,vl)),_b1_)),
        _ux_=symbol(pp_func(f),_ur_);
      return symbol(_cs_,symbol(_ux_,_uw_))}
       ...
       {case 0:var n=param[1];return caml_new_string("" + n);
        ...
        case 2:
         var
          e2=param[2],
          e1=param[1],
          _un_=symbol(_cv_,symbol(pp_expr$0(e2),_cu_));
         return symbol(_cw_,symbol(pp_expr$0(e1),_un_));
        case 3:
         var
          e2$0=param[2],
          e1$0=param[1],
          _uo_=symbol(_cy_,symbol(pp_expr$0(e2$0),_cx_));
         return symbol(_cz_,symbol(pp_expr$0(e1$0),_uo_));
        case 4:
         var
          e2$1=param[2],
          e1$1=param[1],
          _up_=symbol(_cB_,symbol(pp_expr$0(e2$1),_cA_));
         return symbol(_cC_,symbol(pp_expr$0(e1$1),_up_));
        case 5:
         var
          e2$2=param[2],
          e1$2=param[1],
          _uq_=symbol(_cE_,symbol(pp_expr$0(e2$2),_cD_));
         return symbol(_cF_,symbol(pp_expr$0(e1$2),_uq_));
       ...
       {case 0:var b=param[1];return string_of_bool(b);
        case 1:
         var
          e2=param[2],
          e1=param[1],
          _ui_=symbol(_cI_,symbol(pp_expr$0(e2),_cH_));
         return symbol(_cJ_,symbol(pp_expr$0(e1),_ui_));
        case 2:
         var
          e2$0=param[2],
          e1$0=param[1],
          _uj_=symbol(_cL_,symbol(pp_expr$0(e2$0),_cK_));
         return symbol(_cM_,symbol(pp_expr$0(e1$0),_uj_));
        case 3:
         var
          e2$1=param[2],
          e1$1=param[1],
          _uk_=symbol(_cO_,symbol(pp_expr$0(e2$1),_cN_));
         return symbol(_cP_,symbol(pp_expr$0(e1$1),_uk_));
        case 4:
         var
          e2$2=param[2],
          e1$2=param[1],
          _ul_=symbol(_cR_,symbol(pp_pred$0(e2$2),_cQ_));
         return symbol(_cS_,symbol(pp_pred$0(e1$2),_ul_));
        case 5:
         var
          e2$3=param[2],
          e1$3=param[1],
          _um_=symbol(_cU_,symbol(pp_pred$0(e2$3),_cT_));
         return symbol(_cV_,symbol(pp_pred$0(e1$3),_um_));
        default:var p=param[1];return symbol(_cW_,pp_pred$0(p))}}
    function mk_indent(n){return make$0(3 * n | 0,32)}
    function pp_typ(indent,s)
     {switch(s[0])
       {case 0:var l=s[1],_uc_=concat(_cX_,map(pp_expr$0,l));break;
        case 1:
         var
          l$0=s[2],
          f=s[1],
        ...
        default:
         var _ud_=s[1];
         if(! _ud_)throw [0,Assert_failure,_c7_];
         var
          tl=_ud_[2],
          match=_ud_[1],
          s$0=match[2],
             ...
             map
              (function(param)
                {var
                  s=param[2],
                  p=param[1],
                  _ug_=symbol(_c1_,pp_typ(indent + 2 | 0,s)),
                  _uh_=symbol(_c2_,symbol(pp_pred$0(p),_ug_));
                 return symbol(_c3_,symbol(mk_indent(indent),_uh_))},
               tl)),
          _uf_=symbol(_c5_,symbol(pp_typ(indent + 2 | 0,s$0),_ue_)),
          _uc_=symbol(_c6_,symbol(pp_pred$0(p),_uf_))}
      return symbol(mk_indent(indent),_uc_)}
    function pp_function(param)
     {var
       stm=param[3],
       params=param[2],
       f=param[1],
       _ub_=symbol(_c8_,pp_typ(1,stm));
      return symbol(f,symbol(_c__,symbol(concat(_c9_,params),_ub_)))}
    ...
    function compute_expr(param)
     {switch(param[0])
       {case 0:var n=param[1];return [1,n];
        ...
        case 2:
         var e2=param[2],e1=param[1],_t8_=compute_expr(e2);
         return [2,compute_expr(e1),_t8_];
        case 3:
         var e2$0=param[2],e1$0=param[1],_t9_=compute_expr(e2$0);
         return [3,compute_expr(e1$0),_t9_];
        case 4:
         var _t__=param[1];
         if(0 === _t__[0])
          {var e2$1=param[2],n$0=_t__[1];return [4,n$0,compute_expr(e2$1)]}
         throw NotLinear;
        case 5:
         var _t$_=param[2],_ua_=param[1];
         if(0 === _t$_[0]){var n$1=_t$_[1];return [5,compute_expr(_ua_),n$1]}
         throw NotLinear;
    ...
    function atomic_neg(param)
     {var e2=param[3],p=param[2],e1=param[1];
      switch(p)
       {case 0:var _t7_=_db_;break;
        case 1:var _t7_=_dc_;break;
        case 2:var _t7_=_dd_;break;
        case 3:var _t7_=_de_;break;
        default:var _t7_=_df_}
      return map(function(op){return [0,e1,op,e2]},_t7_)}
         ...
         var
          ...
          conjl_disj_conj=
           map
            (function(conjl)
              {var
                _t6_=flatten(map(atomic_neg,conjl)),
                disj=map(function(x){return [0,x,0]},_t6_);
               return disj},
             disjl);
    ...
    function expr_list_map(o,tl,match)
     {if(tl)
       {var
         ...
         tl$0=tl[2],
         t=tl[1],
         _t5_=expr_list_map(o,tl$0,el);
        return [0,caml_call3(caml_get_public_method(o,102,160),o,t,e),_t5_]}
      return 0}
    ...
    function pp_tag_list(param)
     {if(param)
       {var tl=param[2],x=param[1],_t4_=pp_tag_list(tl);
        return [0,pp_tag(x),_t4_]}
      return 0}
    function pp_decl(param)
     {var s=param[2],t=param[1],_t3_=symbol(_dt_,s);
      return symbol(pp_tag(t),_t3_)}
    function pp_var_list(param)
     {if(param)
       {var tl=param[2],v=param[1],_t2_=pp_var_list(tl);
        return [0,pp_decl(v),_t2_]}
      return 0}
        ...
        {case 0:var v=param[1];return v[2];
         ...
         case 2:
          var
           e2=param[2],
           e1=param[1],
           _tT_=symbol(_dB_,symbol(pp_expr$1(tag,e2),_dA_));
          return symbol(_dC_,symbol(pp_expr$1(tag,e1),_tT_));
         case 3:
          var
           e2$0=param[2],
           e1$0=param[1],
           _tU_=symbol(_dE_,symbol(pp_expr$1(tag,e2$0),_dD_));
          return symbol(_dF_,symbol(pp_expr$1(tag,e1$0),_tU_));
         case 4:
          var
           e=param[2],
           c=param[1],
           _tV_=symbol(_dH_,symbol(pp_expr$1(tag,e),_dG_));
          return symbol(_dI_,symbol(pp_expr$1(tag,c),_tV_));
         case 5:
          var
           e$0=param[2],
           c$0=param[1],
           _tW_=symbol(_dK_,symbol(pp_expr$1(tag,e$0),_dJ_));
          return symbol(_dL_,symbol(pp_expr$1(tag,c$0),_tW_));
         case 6:var e$1=param[1];return symbol(_dM_,pp_expr$1(tag,e$1));
         case 7:
          var
           e2$1=param[2],
           e1$1=param[1],
           _tX_=symbol(_dO_,symbol(pp_expr$1(1,e2$1),_dN_));
          return symbol(_dP_,symbol(pp_expr$1(1,e1$1),_tX_));
         case 8:
          var
           e2$2=param[2],
           e1$2=param[1],
           _tY_=symbol(_dR_,symbol(pp_expr$1(1,e2$2),_dQ_));
          return symbol(_dS_,symbol(pp_expr$1(1,e1$2),_tY_));
         case 9:
          var
           e2$3=param[3],
           e1$3=param[2],
           tag$0=param[1],
           _tZ_=symbol(_dU_,symbol(pp_expr$1(tag$0,e2$3),_dT_));
          return symbol(_dV_,symbol(pp_expr$1(tag$0,e1$3),_tZ_));
         case 10:
          var
           g2=param[2],
           g1=param[1],
           _t0_=symbol(_dX_,symbol(pp_expr$1(tag,g2),_dW_));
          return symbol(_dY_,symbol(pp_expr$1(tag,g1),_t0_));
         case 11:
          var
           g2$0=param[2],
           g1$0=param[1],
           _t1_=symbol(_d0_,symbol(pp_expr$1(tag,g2$0),_dZ_));
          return symbol(_d1_,symbol(pp_expr$1(tag,g1$0),_t1_));
    ...
    function pp_expr_list(tg,match)
     {if(tg)
       {var
         ...
         tagl=tg[2],
         tag=tg[1],
         _tS_=pp_expr_list(tagl,tl);
        return [0,pp_expr$1(tag,v),_tS_]}
      return 0}
    function pp_meth(opt,param)
     {var id=param[3],tags=param[2],rtag=param[1];
      if(opt)var sth=opt[1],verbose=sth;else var verbose=0;
      if(verbose)
       {var _tR_=symbol(_d5_,symbol(pp_tag(rtag),_d4_));
        return symbol
                (id,symbol(_d7_,symbol(concat(_d6_,pp_tag_list(tags)),_tR_)))}
      return id}
    function pp_rhs(tag,param)
     {if(0 === param[0]){var e=param[1];return pp_expr$1(tag,e)}
      var
       ...
       meth=param[2],
       addr=param[1],
       _tN_=symbol(_eb_,symbol(concat(_ea_,pp_expr_list(meth[2],exprl)),_d$_));
      if(value)
       var v=value[1],_tO_=symbol(_ed_,symbol(pp_expr$1(1,v),_ec_));
      else
       var _tO_=_ef_;
      var
       _tP_=symbol(_tO_,_tN_),
       _tQ_=symbol(_ee_,symbol(pp_meth(0,meth),_tP_));
      return symbol(pp_expr$1(3,addr),_tQ_)}
    function pp_stm(indent,opt,tag,stm)
     {if(opt)var sth=opt[1],breakline=sth;else var breakline=1;
      if(typeof stm === "number")
       if(0 === stm)var _tz_=_eg_,switch$0=1;else var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _tz_=breakline?_ew_:_ex_;
      if(typeof stm === "number")
       switch(stm)
        {case 0:var _tA_=_eh_;break;
         case 1:var _tA_=_ej_;break;
         default:var _tA_=_ek_}
      else
       switch(stm[0])
        {case 0:
          var e=stm[1],_tA_=symbol(_em_,symbol(pp_rhs(tag,e),_el_));break;
         case 1:
          var
           stm$0=stm[3],
           rhs=stm[2],
           lhs=stm[1],
           _tD_=pp_stm(indent,_en_,tag,stm$0);
          if(typeof stm$0 === "number")
           if(0 === stm$0)var _tE_=_eo_,switch$1=1;else var switch$1=0;
          else
           var switch$1=0;
          if(! switch$1)var _tE_=_eq_;
          var
           _tF_=symbol(_ep_,symbol(_tE_,_tD_)),
           _tG_=symbol(pp_rhs(tag_of_lhs(lhs),rhs),_tF_);
          if(typeof lhs === "number")
           var _tH_=_d8_;
          else
           if(0 === lhs[0])
            var f=lhs[1],_tH_=symbol(f[2],_d9_);
           else
            var v=lhs[1],_tH_=symbol(v[2],_d__);
          var _tA_=symbol(_tH_,_tG_);
          break;
         default:
          var
           stm3=stm[4],
           ...
           stm1=stm[2],
           c=stm[1],
           _tI_=symbol(_es_,pp_stm(indent,_er_,tag,stm3)),
           _tJ_=symbol(mk_indent$0(indent),_tI_),
           _tK_=symbol(_et_,symbol(pp_stm(indent + 1 | 0,0,tag,stm2),_tJ_)),
           _tL_=symbol(mk_indent$0(indent),_tK_),
           _tM_=symbol(_eu_,symbol(pp_stm(indent + 1 | 0,0,tag,stm1),_tL_)),
           _tA_=symbol(_ev_,symbol(pp_expr$1(2,c),_tM_))}
      var _tB_=symbol(_tA_,_tz_);
      if(typeof stm === "number")
       if(0 === stm)var _tC_=_ei_,switch$2=1;else var switch$2=0;
      else
       var switch$2=0;
      if(! switch$2)var _tC_=mk_indent$0(indent);
      return symbol(_tC_,_tB_)}
    function pp_block(indent,payable,tag,param)
     {var
       stm=param[3],
       lvl=param[2],
       vl=param[1],
       _tq_=symbol(mk_indent$0(indent),_ey_),
       _tr_=symbol(pp_stm(indent + 1 | 0,0,tag,stm),_tq_),
       _ts_=pp_var_list(lvl),
       _tt_=
        symbol
         (_eB_,
          symbol
           (concat
             (_eA_,
              map
               (function(s)
                 {var _ty_=symbol(s,_ez_);
                  return symbol(mk_indent$0(indent + 1 | 0),_ty_)},
                _ts_)),
            _tr_)),
       _tu_=payable?_eC_:_eJ_,
       _tv_=symbol(_tu_,_tt_),
       _tw_=0 === tag?_eD_:symbol(_eI_,symbol(pp_tag(tag),_eH_)),
       _tx_=symbol(_eE_,symbol(_tw_,_tv_));
      return symbol(_eG_,symbol(concat(_eF_,pp_var_list(vl)),_tx_))}
    function pp_a_contract(param)
     {var
      ...
      if(fallback)
       var
        b=fallback[1],
        _tj_=symbol(_eN_,pp_block(indent,1,0,b)),
        _tk_=symbol(mk_indent$0(indent),_tj_);
      else
       var _tk_=_eO_;
      var
       _tl_=symbol(_tk_,_eP_),
       indent$0=1,
       _tm_=
        symbol
         (_eQ_,
              ...
              map
               (function(param)
                 {var
                   ...
                   b=param[2],
                   m=param[1],
                   _to_=symbol(_eK_,pp_block(indent$0,payable,m[1],b)),
                   _tp_=symbol(_eL_,symbol(pp_meth(0,m),_to_));
                  return symbol(mk_indent$0(indent$0),_tp_)},
                methods)),
            _tl_)),
       indent$1=1;
      return symbol
                   ...
                   symbol
                    (concat
                      (_dw_,
                       map
                        (function(f$0)
                          {var f=f$0[1],_tn_=symbol(pp_decl(f),_dv_);
                           return symbol(mk_indent$0(indent$1),_tn_)},
                         fields)),
                     _tm_))))}
    ...
    function best(err1,err2)
     {if(caml_string_equal(err1[1],_eX_))return err2;
      ...
      var _tf_=length(err2[2]);
      if(length(err1[2]) < _tf_)return err1;
      var _tg_=length(err2[2]);
      if(length(err1[2]) === _tg_)
       {var _th_=err1[2],_ti_=symbol(_eZ_,err2[1]);
        return [0,symbol(err1[1],_ti_),_th_]}
      return err2}
    ...
    function kwd(str)
     {function _s9_(_tb_){return 0}
      var _s__=[0,str];
      return function(_s$_,_ta_){return const$0(_s__,_s9_,_s$_,_ta_)}}
    function option(p,s,tbl)
     {try
       {var
         ...
         res=match[2],
         next=match[1],
         _s8_=[0,next,[0,res],error$0,ntbl];
        return _s8_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
    ...
    function choice(p1,p2,s,tbl)
     {try
       {var _s6_=caml_call2(p1,s,tbl);return _s6_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         {var error1=exn[2];
          try
           {var _s5_=caml_call2(p2,s,tbl);return _s5_}
          catch(exn)
           {exn = caml_wrap_exception(exn);
            if(exn[1] === Fail)
    ...
    function choice_list(param)
     {if(param)
       {var _s0_=param[2],_s1_=param[1];
        if(_s0_)
         {var _s2_=choice_list(_s0_);
          return function(_s3_,_s4_){return choice(_s1_,_s2_,_s3_,_s4_)}}
        return _s1_}
       ...
       {var
        ...
        try
         ...
         {exn = caml_wrap_exception(exn);
          ...
          throw exn}
        var _sZ_=[0,rest2,x,best(error1,error2$0),tbl2];
        return _sZ_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        if(exn[1] === Fail)
         ...
         {var
          ...
          try
           ...
           {exn = caml_wrap_exception(exn);
            ...
            throw exn}
          var _sY_=aux(rest1,x,best(error1$0,error),ntbl);
          return _sY_}
        catch(exn)
         {exn = caml_wrap_exception(exn);
          if(exn[1] === Fail)
    ...
    function x_cont(x_expr,x_binop,s)
     {function _sM_(f1,f2,x){return caml_call1(f2,caml_call1(f1,x))}
      function _sN_(_sX_){return x_cont(x_expr,x_binop,_sX_)}
      function _sO_(f,x,y){return caml_call2(f,y,x)}
      function _sP_(_sV_,_sW_){return concat$0(x_binop,x_expr,_sO_,_sV_,_sW_)}
      function _sQ_(_sT_,_sU_){return concat$0(_sP_,_sN_,_sM_,_sT_,_sU_)}
      function _sR_(x){return x}
      return function(_sS_){return option2(_sR_,_sQ_,s,_sS_)}}
    function nelist(x_expr,x_binop)
     {function _sH_(x,f){return caml_call1(f,x)}
      function _sI_(_sL_){return x_cont(x_expr,x_binop,_sL_)}
      return function(_sJ_,_sK_){return concat$0(x_expr,_sI_,_sH_,_sJ_,_sK_)}}
    ...
    function check_type(tag,param)
     {var e=param[2],t=param[1],match=eq_tag(tag,t);
      if(match)return e;
      var _sG_=symbol(_fe_,pp_tag(tag));
      throw [0,Reject,symbol(pp_expr$1(t,e),_sG_)]}
     ...
     {var tbl$0=tbl;
      for(;;)
       {if(tbl$0)
         {var _sF_=tbl$0[1];
          if(1 === _sF_[0])
           {var islocal=_sF_[2],match=_sF_[1],name=match[2],tag=match[1];
     ...
     {var match$0=param[1],funname=match$0[3],l=match$0[2],t=match$0[1];
      ...
      for(;;)
       {if(tbl)
         {var _sE_=tbl[1];
          if(2 === _sE_[0])
           {var match=_sE_[1],name=match[3],tagl=match[2],rettag=match[1];
    ...
    function plus(e1,e2)
     {if(1 === e1[1])
      ...
      var _sC_=symbol(_fm_,pp_any_expr(e2));
    ...
    function orb(e1,e2)
     {if(2 === e1[1])
      ...
      var _su_=symbol(_fv_,pp_any_expr(e2));
    ...
    function varname(s,t)
     {if(s)
       {var _st_=s[1];
        if(1 === _st_[0]){var tl=s[2],x=_st_[1];return [0,tl,x,[0,_fy_,tl],t]}}
    ...
    function var_pars(tag,s,tbl)
     {try
       ...
       {_ss_ = caml_wrap_exception(_ss_);
        if(_ss_[1] === Failure)throw [0,Fail,[0,_fz_,s]];
        throw _ss_}
      return const$0
              (x,
               function(param)
                {if(s)
                  {var _so_=s[1];
                   if(1 === _so_[0])
                    {var var$0=_so_[1],match=get_field(tbl,var$0);
                     if(match)
                      {var
                        _sp_=match[1],
                        islocal=_sp_[2],
                       ...
                       if(eq_tag(tagfield,tag))
                        {var
                         ...
                         return _sq_}
                       var _sr_=symbol(_fB_,pp_tag(tag));
                       throw [0,Reject,symbol(pp_tag(tagfield),_sr_)]}
    ...
    function value_pars(tag,s,tbl)
     {try
       ...
       {_sn_ = caml_wrap_exception(_sn_);
        if(_sn_[1] === Failure)throw [0,Fail,[0,_fL_,s]];
        throw _sn_}
      return const$0
              (t,
               function(match$0)
                {switch(tag)
                  {case 1:
                   ...
                   case 2:
                    if(0 === match$0[0])
                     {var _sm_=match$0[1];
                      if(! caml_string_notequal(_sm_,_fF_))return _fI_;
                      if(! caml_string_notequal(_sm_,_fG_))return _fH_}
                    break;
                   case 3:
                    if(1 === match$0[0])
    ...
    function this_pars(_sk_,_sl_){return const$0(_fN_,_fM_,_sk_,_sl_)}
    function brackets_pars(pars)
     {var _sd_=kwd(_fO_),_se_=kwd(_fP_);
      function _sf_(_si_,_sj_){return concat$0(_se_,pars,csnd,_si_,_sj_)}
      return function(_sg_,_sh_){return concat$0(_sf_,_sd_,cfst,_sg_,_sh_)}}
    function _fQ_(param){return 1}
    var _fS_=kwd(_fR_),_fU_=kwd(_fT_),_fW_=kwd(_fV_);
    function _fX_(_sb_,_sc_){return concat$0(_fW_,_fU_,csnd,_sb_,_sc_)}
    function _fY_(_r$_,_sa_){return concat$0(_fX_,_fS_,csnd,_r$_,_sa_)}
    function msg_sender_pars(_r9_,_r__)
     {return comb_parser(_fY_,_fQ_,_r9_,_r__)}
    function _fZ_(param){return _f0_}
    var _f2_=kwd(_f1_),_f4_=kwd(_f3_),_f6_=kwd(_f5_);
    function _f7_(_r7_,_r8_){return concat$0(_f6_,_f4_,csnd,_r7_,_r8_)}
    function _f8_(_r5_,_r6_){return concat$0(_f7_,_f2_,csnd,_r5_,_r6_)}
    function msg_value_pars(_r3_,_r4_)
     {return comb_parser(_f8_,_fZ_,_r3_,_r4_)}
    function base(tag,s,tbl)
     {var
       _rX_=0,
       _rY_=[0,function(_r1_,_r2_){return value_pars(tag,_r1_,_r2_)},_rX_];
      return caml_call2
              (choice_list
                ([0,function(_rZ_,_r0_){return var_pars(tag,_rZ_,_r0_)},_rY_]),
               s,
               tbl)}
    function atomic_int_expr(s)
     {var _rK_=[0,brackets_pars(int_expr),0];
      function _rL_(param){return uminus}
      var
       _rM_=kwd(_f9_),
       _rN_=
        [0,
         function(_rV_,_rW_)
          {return concat$0(_rM_,atomic_int_expr,_rL_,_rV_,_rW_)},
         _rK_];
      function _rO_(expr){return [0,1,expr]}
      var _rP_=1;
      function _rQ_(_rT_,_rU_){return base(_rP_,_rT_,_rU_)}
      return caml_call1
              (choice_list
                ([0,
                  msg_value_pars,
                  [0,
                   balance_pars,
                   [0,
                    function(_rR_,_rS_){return comb_parser(_rQ_,_rO_,_rR_,_rS_)},
                    _rN_]]]),
               s)}
    ...
    function add_binop(s)
     {var _rC_=0;
      function _rD_(param){return minus}
      var
       _rE_=
        [0,function(_rI_,_rJ_){return const$0(_f__,_rD_,_rI_,_rJ_)},_rC_];
      function _rF_(param){return plus}
      return caml_call1
              (choice_list
                ([0,
                  function(_rG_,_rH_){return const$0(_f$_,_rF_,_rG_,_rH_)},
                  _rE_]),
               s)}
    function mul_binop(s)
     {var _ru_=0;
      function _rv_(param){return div}
      var
       _rw_=
        [0,function(_rA_,_rB_){return const$0(_ga_,_rv_,_rA_,_rB_)},_ru_];
      function _rx_(param){return mult}
      return caml_call1
              (choice_list
                ([0,
                  function(_ry_,_rz_){return const$0(_gb_,_rx_,_ry_,_rz_)},
                  _rw_]),
               s)}
    function atomic_bool_expr(s)
     {var _q3_=0;
      function _q4_(x,f){return caml_call1(f,x)}
      function _q5_(f,y,x){return caml_call2(f,x,y)}
      function _q6_(_rs_,_rt_){return concat$0(cmpop,int_expr,_q5_,_rs_,_rt_)}
      var
       _q7_=
        [0,
         function(_rq_,_rr_){return concat$0(int_expr,_q6_,_q4_,_rq_,_rr_)},
         _q3_];
      function _q8_(param){return notb}
      var
       _q9_=kwd(_gc_),
       _q__=
        [0,
         function(_ro_,_rp_)
          {return concat$0(_q9_,atomic_bool_expr,_q8_,_ro_,_rp_)},
         _q7_],
       _q$_=kwd(_gd_),
       _ra_=kwd(_ge_);
      function _rb_(_rm_,_rn_){return concat$0(_ra_,bool_expr,csnd,_rm_,_rn_)}
      var
       _rc_=
        [0,
         function(_rk_,_rl_){return concat$0(_rb_,_q$_,cfst,_rk_,_rl_)},
         _q__];
      function _rd_(expr){return [0,2,expr]}
      var _re_=2;
      function _rf_(_ri_,_rj_){return base(_re_,_ri_,_rj_)}
      return caml_call1
              (choice_list
                ([0,
                  function(_rg_,_rh_){return comb_parser(_rf_,_rd_,_rg_,_rh_)},
                  _rc_]),
               s)}
    function cmpop(s)
     {var _qN_=0;
      function _qO_(param){return le}
      var
       _qP_=
        [0,function(_q1_,_q2_){return const$0(_gf_,_qO_,_q1_,_q2_)},_qN_];
      function _qQ_(param){return lt}
      var
       _qR_=
        [0,function(_qZ_,_q0_){return const$0(_gg_,_qQ_,_qZ_,_q0_)},_qP_];
      function _qS_(param){return ge}
      var
       _qT_=
        [0,function(_qX_,_qY_){return const$0(_gh_,_qS_,_qX_,_qY_)},_qR_];
      function _qU_(param){return gt}
      return caml_call1
              (choice_list
                ([0,
                  function(_qV_,_qW_){return const$0(_gi_,_qU_,_qV_,_qW_)},
                  _qT_]),
               s)}
    function eqop(s)
     {var _qF_=0;
      function _qG_(param){return neq}
      var
       _qH_=
        [0,function(_qL_,_qM_){return const$0(_gj_,_qG_,_qL_,_qM_)},_qF_];
      function _qI_(param){return eq}
      return caml_call1
              (choice_list
                ([0,
                  function(_qJ_,_qK_){return const$0(_gk_,_qI_,_qJ_,_qK_)},
                  _qH_]),
               s)}
    ...
    function and_binop(s)
     {var _qB_=0;
      function _qC_(param){return andb}
      return caml_call1
              (choice_list
                ([0,
                  function(_qD_,_qE_){return const$0(_gl_,_qC_,_qD_,_qE_)},
                  _qB_]),
               s)}
    function or_binop(s)
     {var _qx_=0;
      function _qy_(param){return orb}
      return caml_call1
              (choice_list
                ([0,
                  function(_qz_,_qA_){return const$0(_gm_,_qy_,_qz_,_qA_)},
                  _qx_]),
               s)}
    function balance_pars(s)
     {function _qq_(a$0,param)
       {if(3 <= a$0[1]){var a=a$0[2];return [0,1,[14,a]]}
        throw [0,Reject,symbol(pp_any_expr(a$0),_fl_)]}
      var _qr_=kwd(_gn_),_qs_=kwd(_go_);
      function _qt_(_qv_,_qw_)
       {return concat$0(contract_expr,_qs_,cfst,_qv_,_qw_)}
      return function(_qu_){return concat$0(_qt_,_qr_,_qq_,s,_qu_)}}
    function contract_expr(s)
     {function aux(s)
       {var _qm_=[0,this_pars,[0,brackets_pars(aux),0]],_qn_=3;
        return caml_call1
                (choice_list
                  ([0,
                    msg_sender_pars,
                    [0,function(_qo_,_qp_){return base(_qn_,_qo_,_qp_)},_qm_]]),
                 s)}
      function _qk_(expr){return [0,3,expr]}
      return function(_ql_){return comb_parser(aux,_qk_,s,_ql_)}}
    function expr_pars(s)
     {var
       _qd_=kwd(_gp_),
       _qc_=[0,int_expr,[0,bool_expr,[0,contract_expr,0]]],
       _qe_=kwd(_gq_);
      function _qf_(_qi_,_qj_){return concat$0(_qe_,expr_pars,csnd,_qi_,_qj_)}
      return caml_call1
              (choice_list
                ([0,
                  function(_qg_,_qh_)
                   {return concat$0(_qf_,_qd_,cfst,_qg_,_qh_)},
                  _qc_]),
               s)}
    function tag_pars(str,tag)
     {function _p__(param){return [0,tag]}
      var _p$_=[0,str];
      return function(_qa_,_qb_){return const$0(_p$_,_p__,_qa_,_qb_)}}
    var
    ...
    function field_pars(islocal,s,t)
     {var _p6_=kwd(_gw_);
      function _p7_(param,v){var t=param[1];return [0,[0,t,v]]}
      var
       match=
        concat$0
         (function(_p8_,_p9_)
           {return concat$0(type_pars,varname,_p7_,_p8_,_p9_)},
          _p6_,
          cfst,
          s,
          t),
    ...
    function _gy_(_p5_){return map(_gx_,_p5_)}
    var _gz_=0,_gA_=0;
    function _gB_(_p3_,_p4_){return field_pars(_gA_,_p3_,_p4_)}
    function _gC_(_p1_,_p2_){return kleenestar(_gB_,_gz_,addel,_p1_,_p2_)}
    function fields_pars(_pZ_,_p0_){return comb_parser(_gC_,_gy_,_pZ_,_p0_)}
    ...
    function _gH_(_pX_,_pY_){return concat$0(_gG_,expr_pars,csnd,_pX_,_pY_)}
    function _gI_(_pV_,_pW_){return kleenestar(_gH_,_gE_,addel,_pV_,_pW_)}
    function _gJ_(_pT_,_pU_){return concat$0(expr_pars,_gI_,cons,_pT_,_pU_)}
    var
     _gK_=0,
     _gL_=
      brackets_pars(function(_pR_,_pS_){return option2(_gK_,_gJ_,_pR_,_pS_)});
    function parse_any_expr_list(_pP_,_pQ_)
     {return comb_parser(_gL_,expr_list_of_any_expr_list,_pP_,_pQ_)}
    function ident_pars(s,t)
     {if(s)
       {var _pO_=s[1];
        if(1 === _pO_[0]){var tl=s[2],i=_pO_[1];return [0,tl,i,[0,_gN_,tl],t]}}
       ...
       {var t=1;
        if(x)
         {var v=x[1],e=v[2],texp=v[1],match=eq_tag(texp,t);
          return match?[0,e]:0}
        return 0}
      var _pD_=brackets_pars(int_expr),_pE_=kwd(_gO_),_pF_=kwd(_gP_);
      function _pG_(_pM_,_pN_){return concat$0(_pF_,_pE_,csnd,_pM_,_pN_)}
      function _pH_(_pK_,_pL_){return concat$0(_pG_,_pD_,csnd,_pK_,_pL_)}
      return comb_parser
              (function(_pI_,_pJ_){return option(_pH_,_pI_,_pJ_)},_pC_,s,t)}
    function rhs_pars(tag)
     {var _pk_=0;
      ...
      var _pe_=kwd(_gQ_);
      function _pf_(_pz_,_pA_)
       {return concat$0(contract_expr,_pe_,cfst,_pz_,_pA_)}
      function _pg_(_px_,_py_){return option2(_gR_,_pf_,_px_,_py_)}
      function _ph_(_pv_,_pw_)
       {return concat$0(_pg_,ident_pars,couple,_pv_,_pw_)}
      function _pi_(_pt_,_pu_)
       {return concat$0(_ph_,dot_value_pars,couple,_pt_,_pu_)}
      function _pj_(_pr_,_ps_)
       {return concat$0(_pi_,parse_any_expr_list,couple,_pr_,_ps_)}
      var
       _pl_=
        [0,function(_pp_,_pq_){return comb_parser(_pj_,_pd_,_pp_,_pq_)},_pk_];
      function _pm_(expr){return [0,check_type(tag,expr)]}
      return choice_list
              ([0,
                function(_pn_,_po_)
                 {return comb_parser(expr_pars,_pm_,_pn_,_po_)},
                _pl_])}
     ...
     {var
       ...
       _nW_=
        [0,
         ...
         _nV_],
       _nX_=kwd(_g2_);
      function _nY_(_pb_,_pc_){return stm_pars(tag,rettag,_pb_,_pc_)}
      function _nZ_(_o$_,_pa_){return concat$0(_nY_,_nX_,cfst,_o$_,_pa_)}
      var
       _n0_=kwd(_g3_),
       _n1_=
        [0,
         function(_o9_,_o__){return concat$0(_n0_,_nZ_,csnd,_o9_,_o__)},
         _nW_];
      function _n2_(param)
       {var
         stm3=param[2],
      ...
      function _n3_(_o6_,_o7_){return stm_pars(tag,rettag,_o6_,_o7_)}
      var _n4_=0;
      function _n5_(_o4_,_o5_){return stm_pars(tag,_n4_,_o4_,_o5_)}
      var _n6_=kwd(_g4_);
      function _n7_(_o2_,_o3_){return concat$0(_n6_,_n5_,csnd,_o2_,_o3_)}
      function _n8_(_o0_,_o1_){return option(_n7_,_o0_,_o1_)}
      var _n9_=0;
      function _n__(_oY_,_oZ_){return stm_pars(tag,_n9_,_oY_,_oZ_)}
      var _n$_=kwd(_g5_);
      function _oa_(_oW_,_oX_){return concat$0(_n$_,bool_expr,csnd,_oW_,_oX_)}
      function _ob_(_oU_,_oV_){return concat$0(_oa_,_n__,couple,_oU_,_oV_)}
      function _oc_(_oS_,_oT_){return concat$0(_ob_,_n8_,couple,_oS_,_oT_)}
      function _od_(_oQ_,_oR_){return concat$0(_oc_,_n3_,couple,_oQ_,_oR_)}
      var
       _oe_=
        [0,function(_oO_,_oP_){return comb_parser(_od_,_n2_,_oO_,_oP_)},_n1_],
       _of_=
        [0,
         function(s,t)
          {var
            ...
            match=
             option
              (function(_oM_,_oN_)
                {return concat$0(varname,_oy_,cfst,_oM_,_oN_)},
               s,
               t),
            t1=match[4],
            error1=match[3],
           ...
           function aux(lhstag,lhs,s1,t1)
            {function _oE_(_oK_,_oL_){return stm_pars(tag,rettag,_oK_,_oL_)}
             var
              _oF_=kwd(_g7_),
              _oG_=rhs_pars(lhstag),
              _oH_=
               concat$0
                (function(_oI_,_oJ_)
                  {return concat$0(_oG_,_oF_,cfst,_oI_,_oJ_)},
                 _oE_,
                 couple,
                 s1,
                 t1),
           ...
           if(match$0)
            {var _oz_=match$0[1];
             if(_oz_)
              {var _oA_=_oz_[1],_oB_=_oA_[1][1],_oC_=_oB_[2],_oD_=_oB_[1];
               return 0 === _oA_[2]
                       ?aux(_oD_,[0,[0,_oD_,_oC_]],s1,t1)
                       :aux(_oD_,[1,[0,_oD_,_oC_]],s1,t1)}
             throw [0,Fail,best([0,_g9_,s],error1)]}
           return aux(0,0,s1,t1)},
         _oe_];
      function _nP_(rhs,param)
       {if(rhs){var rhs$0=rhs[1];return [0,rhs$0]}
        if(0 === tag)return 1;
        throw [0,Reject,symbol(_gZ_,pp_tag(tag))]}
      var _nQ_=kwd(_g0_),_nR_=rhs_pars(tag);
      function _nS_(_ow_,_ox_){return option(_nR_,_ow_,_ox_)}
      var _nT_=kwd(_g1_);
      function _nU_(_ou_,_ov_){return concat$0(_nT_,_nS_,csnd,_ou_,_ov_)}
      var
       _og_=
        [0,
         function(_os_,_ot_){return concat$0(_nU_,_nQ_,_nP_,_os_,_ot_)},
         _of_];
      return caml_call2
              (choice_list
                ([0,
                  function(s,t)
                   {function _oh_(param,_or_){return 2}
                    var
                     _oi_=kwd(_gS_),
                     _oj_=kwd(_gT_),
                     _ok_=kwd(_gU_),
                     _ol_=kwd(_gV_);
                    function _om_(_op_,_oq_)
                     {return concat$0(_ol_,_ok_,csnd,_op_,_oq_)}
                    return concat$0
                            (function(_on_,_oo_)
                              {return concat$0(_om_,_oj_,csnd,_on_,_oo_)},
                             _oi_,
                             _oh_,
                             s,
                             t)},
    ...
    function varlist_append(l1,l2)
     {var _nN_=l1[1];
      if(_nN_)
       {var tl=_nN_[2],hd=_nN_[1],match=varlist_append([0,tl],l2),l=match[1];
        return [0,[0,hd,l]]}
      return l2}
    ...
    function pars_varlist_singleton(_nK_,_nL_)
     {return concat$0(type_pars,varname,_g$_,_nK_,_nL_)}
    function parameter_pars(s,t)
     {var _ny_=kwd(_hb_);
      function _nz_(_nI_,_nJ_)
       {return concat$0(_ny_,pars_varlist_singleton,csnd,_nI_,_nJ_)}
      function _nA_(_nG_,_nH_)
       {return kleenestar(_nz_,_ha_,varlist_append,_nG_,_nH_)}
      function _nB_(_nE_,_nF_)
       {return concat$0(pars_varlist_singleton,_nA_,varlist_append,_nE_,_nF_)}
      var
       match=
        caml_call2
         (brackets_pars
           (function(_nC_,_nD_){return option2(_hc_,_nB_,_nC_,_nD_)}),
          s,
          t),
       nt=match[4],
       error=match[3],
    ...
    function vars_pars(s,t)
     {var
       ...
       match=
        kleenestar
         (function(_nw_,_nx_)
           {return concat$0(pars_varlist_singleton,_nv_,cfst,_nw_,_nx_)},
          _hd_,
          varlist_append,
          s,
          t),
    ...
    function block_pars(opt,tag,vl,s,t)
     {if(opt)var sth=opt[1],check_payable=sth;else var check_payable=0;
      var _m8_=kwd(_hf_),_m9_=1;
      function _m__(_nt_,_nu_){return stm_pars(tag,_m9_,_nt_,_nu_)}
      var _m$_=kwd(_hg_);
      function _na_(param)
       {if(param)return 1;if(check_payable)throw [0,Reject,_hh_];return 0}
      var _nb_=kwd(_hi_);
      function _nc_(_nr_,_ns_){return option(_nb_,_nr_,_ns_)}
      function _nd_(_np_,_nq_){return comb_parser(_nc_,_na_,_np_,_nq_)}
      function _ne_(_nn_,_no_){return concat$0(_nd_,_m$_,cfst,_nn_,_no_)}
      function _nf_(_nl_,_nm_)
       {return concat$0(_ne_,vars_pars,couple,_nl_,_nm_)}
      var
       _ng_=
        concat$0
         (function(_nj_,_nk_){return concat$0(_nf_,_m__,couple,_nj_,_nk_)},
          _m8_,
          cfst,
          s,
          t),
    ...
    function any_meth_pars(s,t)
     {var _mO_=brackets_pars(type_pars),_mP_=kwd(_hj_);
      function _mQ_(_m6_,_m7_){return concat$0(_mP_,_mO_,csnd,_m6_,_m7_)}
      function _mR_(_m4_,_m5_){return option2(_hk_,_mQ_,_m4_,_m5_)}
      var _mS_=kwd(_hl_);
      function _mT_(_m2_,_m3_){return concat$0(_mS_,varname,csnd,_m2_,_m3_)}
      var
       _mU_=
        concat$0
         (function(_m0_,_m1_)
           {return concat$0(_mT_,parameter_pars,couple,_m0_,_m1_)},
          _mR_,
          couple,
          s,
          t),
      ...
      try
       ...
       {exn = caml_wrap_exception(exn);
        ...
        throw exn}
      var
       _mX_=block_pars(0,t1,vl,ns1,nt1$0),
       nt2=_mX_[4],
       error2=_mX_[3],
       match$0=_mX_[2],
       payable=match$0[2],
       block=match$0[1],
       ns2=_mX_[1],
       _mY_=remove_local_vars(nt2),
       _mZ_=best(error1,error2);
      return [0,ns2,[0,[0,t1,get_taglist(vl),name],block,payable],_mZ_,_mY_]}
    function methods_pars(s)
     {var _mM_=0;
      return function(_mN_)
       {return kleenestar(any_meth_pars,_mM_,addel,s,_mN_)}}
    function _hm_(param)
     {var _mL_=param[1];
      if(0 === param[2])throw [0,Assert_failure,_hn_];
      return _mL_}
    var _ho_=0,_hp_=0;
    function _hr_(_mJ_,_mK_){return block_pars(_hq_,_hp_,_ho_,_mJ_,_mK_)}
    var _ht_=kwd(_hs_),_hv_=kwd(_hu_),_hx_=kwd(_hw_);
    function _hy_(_mH_,_mI_){return concat$0(_hx_,_hv_,cfst,_mH_,_mI_)}
    function _hz_(_mF_,_mG_){return concat$0(_hy_,_ht_,cfst,_mF_,_mG_)}
    function _hA_(_mD_,_mE_){return concat$0(_hz_,_hr_,csnd,_mD_,_mE_)}
    function fallback_pars(_mB_,_mC_){return comb_parser(_hA_,_hm_,_mB_,_mC_)}
    function actor_pars(s,t)
     {function _mc_(param)
      ...
      var _md_=kwd(_hB_);
      function _me_(_my_,_mz_){return option(fallback_pars,_my_,_mz_)}
      var _mf_=kwd(_hC_),_mg_=kwd(_hD_);
      function _mh_(_mw_,_mx_){return concat$0(_mg_,varname,csnd,_mw_,_mx_)}
      function _mi_(_mu_,_mv_){return concat$0(_mh_,_mf_,cfst,_mu_,_mv_)}
      function _mj_(_ms_,_mt_)
       {return concat$0(_mi_,fields_pars,couple,_ms_,_mt_)}
      function _mk_(_mq_,_mr_)
       {return concat$0(_mj_,methods_pars,couple,_mq_,_mr_)}
      function _ml_(_mo_,_mp_){return concat$0(_mk_,_me_,couple,_mo_,_mp_)}
      var
       match=
        comb_parser
         (function(_mm_,_mn_){return concat$0(_ml_,_md_,cfst,_mm_,_mn_)},
          _mc_,
          s,
          t),
       tbl=match[4],
    ...
    var _hE_=0;
    function _hF_(_ma_,_mb_)
     {return kleenestar(actor_pars,_hE_,addel,_ma_,_mb_)}
    function configuration_pars(_l__,_l$_)
     {return concat$0(_hF_,eof,cfst,_l__,_l$_)}
        ...
        for(;;)
         {if(param$0)
           {var _l8_=param$0[1];
            if(0 === _l8_[0])
             {var _l9_=_l8_[1];
              if(! caml_string_notequal(_l9_,_hH_))
               {var
                 param$2=param$0[2],
                 n$2=n$0 + 1 | 0,
                 n$0=n$2,
                 param$0=param$2;
                continue}
              if(! caml_string_notequal(_l9_,_hI_))
               {var tl=param$0[2];
                if(0 === n$0)return tl;
       ...
       {var acc$0=acc,l$0=l;
        for(;;)
         {if(l$0)
           {var _l2_=l$0[1];
            if(0 === _l2_[0])
             if(! caml_string_notequal(_l2_[1],_hK_))
              {var _l3_=l$0[2];
               if(_l3_)
                {var _l4_=_l3_[1];
                 if(1 === _l4_[0])
                  {var _l5_=_l3_[2];
                   if(_l5_)
                    {var _l6_=_l5_[1];
                     if(0 === _l6_[0])
                      {var _l7_=_l4_[1];
                       if(! caml_string_notequal(_l6_[1],_hM_))
                        {var tl=_l5_[2];
                         try
                          {var acc$1=add_contract_to_table(acc$0,_l7_)}
                         catch(exn$0)
        ...
        {case 0:return stm1;
         ...
         default:
          var
           ...
           _l0_=retype_stm(stm_concat(stmb,cont$1));
          return [2,g,retype_stm(stm_concat(stma,cont$1)),_l0_,2]}}
              ...
              if(0 === _lU_[1])
               {var _lV_=_lU_[2];
                if(_lV_)
                 if(1 === _lV_[1])
                  if(! _lV_[2])
                   if(! caml_string_notequal(_lU_[3],_hU_))
                    {var
                      stm$0=stm[3],
                      match$1=norm_stm(addr,params,locals,payable,stm$0),
                      stm$1=match$1[2],
                      meths$0=match$1[1];
                     return [0,meths$0,[1,0,_lQ_,stm$1]]}}}}
          var
           cont=stm[3],
           rhs=stm[2],
            ...
            function(param)
             {var
              ...
              if(typeof _lP_ === "number")
               ...
               if(0 === _lP_[0])
                var v=_lP_[1],_lY_=[0,[0,_lP_],[0,v[1],[0,v]]];
               else
                var v$0=_lP_[1],_lY_=[0,[0,_lP_],[0,v$0[1],[0,v$0]]];
              var
               match$0=_lY_[2],
               ret_param=match$0[2],
               lhs_tag=match$0[1],
              ...
              return [0,
                      ...
                      [1,_lP_,rhs,[0,[1,0,name,0,aparams]]]]};
          if(typeof _lP_ === "number")
           ...
           if(1 === _lP_[0])
            if(typeof cont$0 !== "number" && 0 === cont$0[0])
             {var _lR_=cont$0[1],_lS_=_lP_[1];
              if(0 === _lR_[0])
               {var _lT_=_lR_[1];
                if(typeof _lT_ !== "number" && 0 === _lT_[0])
                 {var v=_lT_[1],match$0=eq_tag(_lS_[1],v[1]);
                  if(match$0)
                   if(caml_string_equal(_lS_[2],v[2]))return [0,meths,[0,rhs]];
                  return make_cont(0)}}}
          return make_cont(0);
         case 2:
          var
           ...
           stm2$0=match$3[2],
           meths2=match$3[1],
           _lW_=retype_stm(stm2$0),
           _lX_=[2,g,retype_stm(stm1$0),_lW_,2];
          return [0,op(meths1,meths2),_lX_]
         }
      return [0,0,stm]}
                 ...
                 _lG_=
                  caml_call1
                   (find_all
                    ...
                    ms);
                if(_lG_)
                 {if(_lG_[2])throw [0,Assert_failure,_eU_];
              ...
              if(0 === _lA_[1])
               {var _lB_=_lA_[2];
                if(_lB_)
                 if(1 === _lB_[1])
                  if(! _lB_[2])
                   if(! caml_string_notequal(_lA_[3],_hY_))
            ...
            (function(tbl,param)
              {var fallback=param[3],methods=param[2],addr=param[1];
               if(fallback)
                var
                 fb=fallback[1],
                 _ly_=[0,any_method_decl_of_fallback(fb),methods];
               else
                var _ly_=methods;
               return fold_left
                       (function(tbl,m)
    ...
    function _ig_(m,param)
     {var
       fallback=param[3],
       methods=param[2],
       _lv_=fold(0,maxargs_block,fallback);
      return max(m,max(fold_left(_ie_,_id_,methods),_lv_))}
     ...
     {var match$0=get_bounds(cfg);
      if(0 === match$0[0])
       {var
         ...
         max_stack=
          fold_left
           (function(m,param){var n=param[2];return max(m,n)},_lr_,l$0);
      ...
      if(l$1)
       {var
         ...
         m=match[1],
         a=_lo_[1],
         _lp_=symbol(_h1_,symbol(a,symbol(_h0_,symbol(pp_meth(0,m),_hZ_)))),
         _lq_=rev(l);
        return symbol
                (_h9_,
                 symbol
                  (fold_left
                    (function(acc,param)
                      {var
                        ...
                        m=match[1],
                        a=_ls_[1],
                        _lt_=is_tail?_h4_:_h8_,
                        _lu_=symbol(_h5_,symbol(_lt_,_h3_));
                       return symbol
                               (acc,
                                symbol
                                 (_h7_,symbol(a,symbol(_h6_,symbol(pp_meth(0,m),_lu_)))))},
                     _h2_,
                     _lq_),
                   _lp_))}
    ...
    function string_of_meth(addr,m)
     {var _ln_=concat(_ii_,pp_tag_list(m[2]));
      return symbol$0(addr,symbol$0(m[3],_ln_))}
    ...
    function assign(k,v,init)
     {var
       ...
       _lk_=init[5],
       _ll_=init[4],
       _lm_=assign_gamma(k,v,init[3]);
      return [0,init[1],init[2],_lm_,_ll_,_lk_,_lj_,_li_]}
    function lookup_gamma(k,gamma)
     {try
       {var _lg_=assoc(k,gamma);return _lg_}
      catch(_lh_)
       {_lh_ = caml_wrap_exception(_lh_);
        if(_lh_ === Not_found){error(k);throw [0,Assert_failure,_im_]}
        throw _lh_}}
       ...
       {_le_ = caml_wrap_exception(_le_);
        if(_le_ === Not_found)
         {error(symbol(_ip_,v));
          ...
          var _lb_=status[7];
          error
           (symbol(_is_,concat(_ir_,map(function(_lf_){return _lf_[1]},_lb_))));
     ...
     {if(typeof expr !== "number")
       switch(expr[0])
        {case 0:var v=expr[1];return lookup(status,v[2]);
         ...
         case 2:
          var e2=expr[2],e1=expr[1],_k9_=type_of_iexpr(status,e2);
          return [2,type_of_iexpr(status,e1),_k9_];
         case 3:
          var e2$0=expr[2],e1$0=expr[1],_k__=type_of_iexpr(status,e2$0);
          return [3,type_of_iexpr(status,e1$0),_k__];
         case 4:
          var e2$1=expr[2],e1$1=expr[1],_k$_=type_of_iexpr(status,e2$1);
          return [4,type_of_iexpr(status,e1$1),_k$_];
         case 5:
          var e2$2=expr[2],e1$2=expr[1],_la_=type_of_iexpr(status,e2$2);
          return [5,type_of_iexpr(status,e1$2),_la_];
    ...
    function type_of_pred(status,expr)
     {if(typeof expr !== "number")
       switch(expr[0])
        {case 1:
          var v$0=expr[1],_k3_=int_of_bool(1);
          return [3,lookup(status,symbol$0(status[6],v$0[2])),_k3_];
         case 7:
          var e2=expr[2],e1=expr[1],_k4_=type_of_iexpr(status,e2);
          return [1,type_of_iexpr(status,e1),_k4_];
         case 8:
          var e2$0=expr[2],e1$0=expr[1],_k5_=type_of_iexpr(status,e2$0);
          return [2,type_of_iexpr(status,e1$0),_k5_];
         case 9:
          switch(expr[1])
           {case 0:return _iu_;
            case 1:
             var e2$1=expr[3],e1$1=expr[2],_k6_=type_of_iexpr(status,e2$1);
             return [3,type_of_iexpr(status,e1$1),_k6_];
            case 2:
             var
              e2$2=expr[3],
              e1$2=expr[2],
            ...
            default:
             ...
             return [3,a1$0,a2$0]}
         case 10:
          var e2$4=expr[2],e1$4=expr[1],_k7_=type_of_pred(status,e2$4);
          return [4,type_of_pred(status,e1$4),_k7_];
         case 11:
          var e2$5=expr[2],e1$5=expr[1],_k8_=type_of_pred(status,e2$5);
          return [5,type_of_pred(status,e1$5),_k8_];
         case 12:var p=expr[1];return [6,type_of_pred(status,p)];
         case 13:var b=expr[1];return [0,b]
         }
      var v=expr[1],_k2_=int_of_bool(1);
      return [3,lookup(status,v[2]),_k2_]}
    ...
    function revert(status)
     {var _k1_=status[1];return [0,map(function(v){return [1,v]},_k1_)]}
      ...
      for(;;)
       {if(param)
         {var _kY_=param[1];
          ...
          continue}
        if(acc$0)
         {var _kZ_=acc$0[1],_k0_=_kZ_[1];
          if(0 === _k0_[0])
           if(0 !== _k0_[1])
            if(! acc$0[2]){var l$0=_kZ_[2];return caml_call1(f,l$0)}}
        var
         aux=
          function(param)
           {if(param)
       ...
       {if(public_methods === 0)
         ...
         {var l=public_methods.length - 1;
          ...
          var
           ...
           _kO_=public_methods.length - 1 - 1 | 0,
           _kN_=0;
          if(! (_kO_ < 0))
           {var i$0=_kN_;
            for(;;)
             {var met=public_methods[1 + i$0],lab=(i$0 * 2 | 0) + 2 | 0;
              ...
              var _kP_=i$0 + 1 | 0;
              if(_kO_ !== i$0){var i$0=_kP_;continue}
              break}}
          var _kQ_=table}
        var
         _kR_=new_variable(_kQ_,_ix_),
         label=get_method_label(_kQ_,_iy_),
         element=
          function(self_1)
           {var env=self_1[1 + _kR_],_kV_=env[1];
            return function(_kW_,_kX_){return type_of_expr(_kV_,_kW_,_kX_)}};
        method_count[1]++;
        if(caml_call2(Labs[27],label,_kQ_[4]))
         {resize$0(_kQ_,label + 1 | 0);
          caml_check_bound(_kQ_[2],label)[1 + label] = element}
        else
         _kQ_[6] = [0,[0,label,element],_kQ_[6]];
        var
         _kS_=
          function(_kU_)
           {var obj=caml_obj_block(248,_kQ_[1]);
            obj[1] = _kQ_[2];
            var _kT_=caml_set_oo_id(obj);
            _kT_[1 + _kR_] = _kU_;
            return _kT_};
        inst_var_count[1] = (inst_var_count[1] + _kQ_[1] | 0) - 1 | 0;
        _kQ_[8] = rev(_kQ_[8]);
        resize$0
         (_kQ_,3 + ((caml_check_bound(_kQ_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
        _iw_[1] = _kS_}
      return caml_call1(_iw_[1],[0,status])}
    function type_of_call0(status,addr,meth,value,sender,params)
     {var _kD_=tag_list_length(meth[2]);
      if(length(params) === _kD_)
       {var
          ...
          function(i)
           {if(status[4] < i)return 0;
            ...
            return [0,
                    ...
                    _kJ_]},
         stack$0=aux(1),
         _kE_=op([0,sender,[0,value,params]],stack$0),
         _kF_=status[2],
         _kG_=op(map(function(_kI_){return lookup(status,_kI_)},_kF_),_kE_),
         _kH_=status[1],
         args=op(map(function(v){return [1,v]},_kH_),_kG_);
        return [1,name,args]}
    ...
    function match_method(status,addr,meth,params)
     {try
       ...
       {_kC_ = caml_wrap_exception(_kC_);
        if(_kC_ === Not_found)throw [0,Assert_failure,_iA_];
        throw _kC_}
       ...
       {var meths$0=meths;
        for(;;)
         {if(meths$0)
          ...
          throw Not_found}}
      try
       {var _ky_=[0,aux(meth,params,meths)];return _ky_}
      catch(_kz_)
       {_kz_ = caml_wrap_exception(_kz_);
        if(_kz_ === Not_found)
         try
          {var _kx_=[0,aux(fallback,0,meths)];return _kx_}
         catch(_kA_)
    ...
    function transfer(status$1,to,amount,k)
     {var
       ...
       _kw_=revert(status$1),
       _ku_=[3,lookup(status$1,symbol$0(from,balance)),amount],
       status=assign(symbol$0(from,balance),_ku_,status$1),
       _kv_=[2,lookup(status,symbol$0(to,balance)),amount],
       status$0=assign(symbol$0(to,balance),_kv_,status);
      return if_then_else([1,from_balance,amount],caml_call1(k,status$0),_kw_)}
     ...
     {var
      ...
      if(match)
       {var
         ...
         payable=match$0[2],
         meth$0=match$0[1],
         _kq_=0 !== eq_tag(tag,0)?1:0,
         output_type_ok=_kq_ || (0 !== eq_tag(tag,meth$0[1])?1:0),
        ...
        if(output_type_ok)
         if(payable_ok)
          {var
            amount=
             fold
              (_iv_,function(_kt_){return type_of_iexpr(status,_kt_)},value),
            _kr_=meth$0[2],
            params$1=expr_list_map(type_of_expr_poly(status),_kr_,params$0);
                                ...
                                (status,
                                 ...
                                 function(_ks_)
                                  {return type_of_call0
                                           (_ks_,addr$0,meth$0,amount,sender,params)})})}
        return revert(status)}
      return revert(status)}
     ...
     {function aux(guard,param)
       {if(param)
         {var
           ...
           typ=match[2],
           g=match[1],
           _kp_=caml_equal(guard,_iB_)?g:[5,guard,g];
          return [0,[0,g,typ],aux(_kp_,tl)]}
       ...
       {if(typeof stm$0 === "number")
         ...
         switch(stm$0[0])
          {case 0:
            var _jW_=stm$0[1];
            if(0 === _jW_[0])
             {var e=_jW_[1],e$0=type_of_expr(status$0,tag,e);
              if(345791162 <= e$0[1])
               {var
                 p=e$0[2],
            ...
            var _jX_=_jW_[2],_jY_=_jW_[1];
            if(0 === _jX_[1])
             {var _jZ_=_jX_[2];
              if(_jZ_)
               if(1 === _jZ_[1])
                if(! _jZ_[2])
                 if(! caml_string_notequal(_jX_[3],_iH_))
                  {var args1$0=_jW_[4],val1$0=_jW_[3];
                   return msg_transfer
                           (status$0,
                            _jY_,
                            val1$0,
                            args1$0,
                            function(_kn_){return type_of_cont(_kn_,int_of_unit)})}}
            var args1=_jW_[4],val1=_jW_[3];
            error(symbol(_iE_,pp_stm(0,0,tag,stm$0)));
            var
             sender=int_of_address(status$0[6]),
             res=type_of_call(status$0,tag,_jY_,_jX_,val1,sender,args1),
             _j0_=symbol(_iF_,pp_typ(0,res));
            error(symbol(_iG_,symbol(pp_stm(0,0,tag,stm$0),_j0_)));
            return res;
           case 1:
            var _j1_=stm$0[1],_j2_=stm$0[2];
            if(0 === _j2_[0])
             {var stm$1=stm$0[3],e$2=_j2_[1],lhs_tag=tag_of_lhs(_j1_);
              if(typeof _j1_ === "number")
               var lhs=0;
              else
               if(0 === _j1_[0])
                var f=_j1_[1],lhs=[0,symbol$0(status$0[6],f[2])];
               else
                var v=_j1_[1],lhs=[0,v[2]];
              if(lhs)
               ...
               {var _j5_=_j4_[2];
                if(_j5_)
                 if(1 === _j5_[1])
                  if(! _j5_[2])
                   {var _kc_=_j3_[1];
                    if(! caml_string_notequal(_j4_[3],_iI_))
                     {var stm$2=stm$0[3],args1$1=_j3_[4],val1$1=_j3_[3];
                      return msg_transfer
                              (status$0,
                               _kc_,
                               val1$1,
                               args1$1,
                               function(_km_){return type_of_stm(_km_,tag,stm$2)})}}}}
            var _j6_=stm$0[3];
               ...
               if(0 === _j7_[0])
                ...
                {if(! _j7_[3])
                  {var
                    ...
                    _kb_=m2[2],
                    args2$0=
                     expr_list_map(type_of_expr_poly(status$0),_kb_,args2),
                           ...
                           (status$0,
                            ...
                            function(args2)
                             {var
                               ...
                               _ke_=length(l),
                               l$0=op(l,mk_list(bottom,status$0[5] - _ke_ | 0)),
                               gamma=[0,status$0[3]],
                               _kf_=status$0[4],
                               _kg_=status$0[5] + 1 | 0;
                              if(! (_kf_ < _kg_))
                               {var i=_kf_;
                                for(;;)
                                 {var
                                  ...
                                  =
                                  assign_gamma
                                   (symbol$0(stack,caml_new_string("" + i)),_kk_,_ki_);
                                  var _kl_=i - 1 | 0;
                                  if(_kg_ !== i){var i=_kl_;continue}
                                  break}}
                              var n=1,param=l$0;
                              for(;;)
                               {if(param)
                                 {var tl=param[2],hd=param[1],_kh_=gamma[1];
                                  gamma[1]
                                  =
                                  assign_gamma
                                   (symbol$0(stack,caml_new_string("" + n)),hd,_kh_);
                                ...
                                var
                                 status=
                                  [0,
                                   ...
                                   status$0[7]];
                                return type_of_call
                                        (status,tag_of_lhs(_j1_),_ka_,_j$_,_j__,sender$0,_j9_)}})}
                 var switch$0=1}}
             else
              var switch$0=0;
            break;
    ...
    function args_of_var_list(param)
     {if(param)
       {var tl=param[2],n=param[1],_jU_=args_of_var_list(tl),_jV_=n[2];
        return [0,[0,0 !== eq_tag(3,n[1])?1:0,_jV_],_jU_]}
      return 0}
    function type_of_a_method0
     (k$1,frame_size,fields,contracts,this$0,name,args,locals,typ_of)
     {var
       fields$0=map(function(_jT_){return _jT_[2]},fields),
       args$0=map(function(_jS_){return _jS_[2]},args),
       locals$0=map(function(_jR_){return _jR_[2]},locals),
       ...
       {if(opt)var sth=opt[1],acc=sth;else var acc=0;
        if(0 === k)
         {var
           ...
           _jP_=map(function(v){return [0,v,bottom]},locals$0),
           gamma=op(map(function(v){return [0,v,[1,v]]},other_params),_jP_),
           status=
            [0,saved_gamma,fields$0,gamma,k$1,frame_size,this$0,contracts],
           typ=caml_call1(typ_of,status),
           _jQ_=op(saved_gamma,other_params);
          return [0,string_of_meth(this$0,name),_jQ_,typ]}
        var
         k$0=k - 1 | 0,
         ...
         (fold_left
           (function(acc,contr)
             {var
               ...
               accu=0,
               param=fields,
               _jM_=[0,[0,0,symbol$0(a$0,balance)],0];
              for(;;)
               {if(param)
                 {var
                   l=param[2],
                   a=param[1],
                   f=a[1],
                   _jN_=symbol$0(a$0,f[2]),
                   accu$0=[0,[0,0 !== eq_tag(f[1],3)?1:0,_jN_],accu],
                   accu=accu$0,
                   param=l;
                  continue}
                return op(op(accu,_jM_),acc)}},
            _ji_,
            cfg)),
       _jj_=0,
       program_rev=
         ...
         (function(acc,contr)
           {var fb=contr[3],meths=contr[2],a=contr[1];
            if(fb)
             var
              fb$0=fb[1],
              _jH_=op(meths,[0,any_method_decl_of_fallback(fb$0),0]);
            else
             var _jH_=meths;
            var _jI_=0;
            return op
                                         ...
                                         (status,
                                          ...
                                          function(a,param)
                                           {var
                                             ...
                                             _jL_=aux(assign(v,a$0,status),tl);
                                            return [0,[3,lookup(status,v),a$0],_jL_]})}
                               var stm=block[3];
                           ...
                           return [0,
                                   type_of_a_method0
                                    (k,
                                     ...
                                     args$0,
                                     locals$0,
                                     function(_jK_){return aux(_jK_,to_sum_on)}),
                                   acc]}},
                       _jI_,
                       _jH_),
                     acc)},
            ...
            {var
              ...
              otherwise=
               [0,
                [0,
                 is_empty,
                 [0,map(function(_jG_){return lookup(status$0,_jG_)},_jB_)]],
                _jA_],
              gamma=[0,status$0[3]],
              ...
              {var i$0=_jq_;
               for(;;)
                {var
                 ...
                 =
                 assign_gamma
                  (symbol$0(stack,caml_new_string("" + i$0)),_jy_,_jw_);
                 var _jz_=i$0 + 1 | 0;
              ...
              {var i=_js_;
               for(;;)
                {var _ju_=gamma[1];
                 ...
                 =
                 assign_gamma
                  (symbol$0(stack,caml_new_string("" + i)),bottom,_ju_);
                 var _jv_=i + 1 | 0;
                 if(_jt_ !== i){var i=_jv_;continue}
                 break}}
             function read(i)
              {if(status$0[5] < i)return 0;
               var _jE_=read(i + 1 | 0),_jF_=status$0[3];
               return [0,
                       lookup_gamma(symbol$0(stack,caml_new_string("" + i)),_jF_),
                       _jE_]}
             var
              status=
               [0,
                                ...
                                function(addr$0,meths)
                                 {function f(param)
                                   {var
                                    ...
                                    return [0,[3,meth,int_of_meth(meth$0)],_jD_]}
                                  var _jC_=tchoice(status,map(f,meths));
                                  return [0,[3,addr,int_of_address(addr$0)],_jC_]})}}}}
                    ...
                    (_iR_,
                     symbol
                      (_iQ_,
                       symbol
                        (caml_new_string("" + m),
                         symbol(_iP_,symbol(_iO_,caml_new_string("" + n))))));
                 return symbol
                         (fold_left
                           (function(acc,param)
                             {var
                               ...
                               m=match[1],
                               a=_jc_[1],
                               _jd_=symbol(_ia_,caml_new_string("" + b));
                              return symbol
                                      (acc,
                                       symbol
